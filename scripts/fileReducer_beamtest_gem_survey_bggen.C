...
int fileReducer_beamtest_gem_survey_bggen(string inputfile_name,int numberOfFile=1, double event_actual=1, int evgen=1){
...
//	TFile* outFile = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pim_7degsurvey_Cfoil/reduce_tree_rate_Nphe_Certest.root", "RECREATE");
