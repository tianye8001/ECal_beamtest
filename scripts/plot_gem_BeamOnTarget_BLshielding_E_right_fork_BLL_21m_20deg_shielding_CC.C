...
void plot_gem_BeamOnTarget_BLshielding_E_right_fork_debug(){
	gStyle->SetOptStat(0);
	gStyle->SetPalette(1);
	TFile *f7 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_20deg_LD2_r20m_shielding/HallC_beamtest_BeamOnTarget_1.9918e9_60uA_4SCs_20deg_r20m_LD2_shielding_output_CC_gammaE_pzcut_debug.root");
	TFile *f4 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_20deg_LD2_r20m_shielding_30x30cm2_1inch/HallC_beamtest_BeamOnTarget_1.9885e9_60uA_4SCs_20deg_r20m_LD2_shielding_30x30x2.54cm3_output_CC_gammaE_pzcut_debug.root");
	TFile *f14 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_20deg_LD2_r20m_shielding_30x30cm2_1inch/HallC_beamtest_BeamOnTarget_1.9885e9_60uA_4SCs_20deg_r20m_LD2_shielding_30x30x2.54cm3_output_CC_electronE_pzcut_debug.root");
	TFile *f17 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_20deg_LD2_r20m_shielding/HallC_beamtest_BeamOnTarget_1.9918e9_60uA_4SCs_20deg_r20m_LD2_shielding_output_CC_electronE_pzcut_debug.root");
	TH1F *hprocid_gem1;       
	TH1F *hpf_gem1;
	TH1F *hE_gem1;
	TH1F *hpf_gem1_1cmAl;
...
/*        hhit_theta_noTB->GetYaxis()->SetTitle("rate (MHz/cm2)");	
        ...
        hhit_theta_noTB->Scale(3.394e-9);
       ...
       // hhit_theta_noTB->Scale(3.394e-9);
        ...
        hhit_theta_45cm->SetTitle("#gamma in front of CC");	
        hhit_theta_45cm->GetXaxis()->SetRangeUser(0,95);	
        hhit_theta_45cm->Scale(3.394e-9);
        hhit_theta_45cm->GetYaxis()->SetRangeUser(1e-3,1e2);	
        hhit_theta_45cm->Draw("same HISt");	
        hhit_theta_25cm->SetLineColor(2);	
        hhit_theta_25cm->Scale(3.394e-9);
        hhit_theta_25cm->Draw("same HISt");	
	TLegend *leg1 = new TLegend(0.45,0.7,0.8,0.9);
	leg1->AddEntry(hhit_theta_45cm,"40uA LD2 target","l");
	leg1->AddEntry(hhit_theta_25cm,"40uA LD2 target 30x30x2.54cm3 poly shielding","l");
	...
	gPad->SetGridx();
      //  hhit_theta_gem2->SetLineColor(6);	
       // hhit_theta_gem2->Scale(3.394e-9);
        ...
        hhit_theta_gem2_noTB->Scale(3.394e-9);
       ...
       // hhit_theta_gem2->Draw("HISt");	
        ...
        hhit_theta_gem2_noB->Scale(3.394e-9);
        hhit_theta_gem2_noB->Draw("same HISt");	
        hhit_theta_1inpoly_gem2->SetLineColor(1);	
        hhit_theta_1inpoly_gem2->Scale(3.394e-9);
        ...
        hhit_theta_45cm_gem2->SetTitle("#gamma at CC back ");	
        hhit_theta_45cm_gem2->GetXaxis()->SetRangeUser(0,95);	
        hhit_theta_45cm_gem2->Scale(3.394e-9);
        ...
        hhit_theta_25cm_gem2->Scale(3.394e-9);
        hhit_theta_25cm_gem2->Draw("same HISt");	
	TLegend *leg01 = new TLegend(0.45,0.7,0.8,0.9);
	leg01->AddEntry(hhit_theta_45cm_gem2,"40uA LD2 target ","l");
	leg01->AddEntry(hhit_theta_25cm_gem2,"40uA LD2 target 30x30x2.54cm3 poly shielding","l");
	...
	gPad->SetGridx();
      ...
      //  hhit_theta_electron->Scale(3.394e-9);
        hhit_theta_noTB_electron->Scale(3.394e-9);
       ...
       // hhit_theta_electron->Draw("HISt");	
        ...
        hhit_theta_35cm_electron->Scale(3.394e-9);
        hhit_theta_35cm_electron->Draw("same HIST");	
        hhit_theta_25cm_electron->SetLineColor(7);	
        hhit_theta_25cm_electron->Scale(3.394e-9);
        ...
        hhit_theta_45cm_electron->SetTitle("e^{-} in front of CC");	
        hhit_theta_45cm_electron->GetXaxis()->SetRangeUser(0,95);	
        hhit_theta_45cm_electron->Scale(3.394e-9);
	...
	leg21->AddEntry(hhit_theta_45cm_electron,"40uA LD2 target ","l");
	leg21->AddEntry(hhit_theta_25cm_electron,"40uA LD2 target 30x30x2.54cm3 poly shielding","l");
 ...
 //       hhit_theta_gem2_electron->Scale(3.394e-9);
        ...
        hhit_theta_gem2_noTB_electron->Scale(3.394e-9);
  ...
  //      hhit_theta_gem2_electron->Draw("HISt");	
        ...
        hhit_theta_35cm_gem2_electron->Scale(3.394e-9);
        hhit_theta_35cm_gem2_electron->Draw("same HISt");	
        hhit_theta_1inpoly_gem2_electron->Draw("same HISt");	
        hhit_theta_25cm_gem2_electron->SetLineColor(7);	
        hhit_theta_25cm_gem2_electron->Scale(3.394e-9);
        ...
        hhit_theta_45cm_gem2_electron->SetTitle("e^{-} at CC back");	
        hhit_theta_45cm_gem2_electron->GetXaxis()->SetRangeUser(0,95);	
        hhit_theta_45cm_gem2_electron->Scale(3.394e-9);
	...
	leg201->AddEntry(hhit_theta_45cm_gem2_electron,"40uA LD2 target","l");
	leg201->AddEntry(hhit_theta_25cm_gem2_electron,"40uA LD2 target 30x30x2.54cm3 poly shielding","l");
	...
	hhit_Edepgem1_electron_noTB->SetTitle("#gamma on gem1 virtual plane");
        hhit_Edepgem1_electron_noTB->Scale(3.394e-9);
	...
	hhit_Edepgem1_electron_35cm->SetLineColor(2);
        hhit_Edepgem1_electron_35cm->Scale(3.394e-9);
	...
	hhit_Edepgem1_electron_45cm->SetTitle("#gamma in front of CC");
        hhit_Edepgem1_electron_45cm->Scale(3.394e-9);
	...
	hhit_Edepgem1_electron_25cm->SetLineColor(2);
        hhit_Edepgem1_electron_25cm->Scale(3.394e-9);
	...
	leg11->AddEntry(hhit_Edepgem1_electron_45cm,Form("40uA LD2 target ; rate=%f MHz/cm2",rate_Edepgem1_electron_45cm),"l");
	leg11->AddEntry(hhit_Edepgem1_electron_25cm,Form("40uA LD2 target 30x30x2.54cm3 poly shielding; rate=%f MHz/cm2",rate_Edepgem1_electron_25cm),"l");
...
/*	hhit_Edepgem2_electron_noTB->GetYaxis()->SetTitle("rate (MHz/cm2)");
  ...
  //      hhit_Edepgem2_electron->Scale(3.394e-9);
        hhit_Edepgem2_electron_noTB->Scale(3.394e-9);
...
//	hhit_Edepgem2_electron->Draw("HIST");
	...
	hhit_Edepgem2_electron_35cm->SetLineColor(2);
        hhit_Edepgem2_electron_35cm->Scale(3.394e-9);
	...
	hhit_Edepgem2_electron_45cm->SetTitle("#gamma at CC back ");
        hhit_Edepgem2_electron_45cm->Scale(3.394e-9);
	...
	hhit_Edepgem2_electron_25cm->SetLineColor(2);
        hhit_Edepgem2_electron_25cm->Scale(3.394e-9);
	...
	leg31->AddEntry(hhit_Edepgem2_electron_45cm,Form("40uA LD2 target; rate=%f MHz/cm2",rate_Edepgem2_electron_45cm),"l");
	leg31->AddEntry(hhit_Edepgem2_electron_25cm,Form("40uA LD2 target 30x30x2.54cm3 poly shielding; rate=%f MHz/cm2",rate_Edepgem2_electron_25cm),"l");
	...
	hhit_Edepgem1_gamma_noTB->SetTitle("e^{-} on gem1 virtual plane");
        hhit_Edepgem1_gamma_noTB->Scale(3.394e-9);
	...
	hhit_Edepgem1_gamma_noB->SetLineColor(6);
        hhit_Edepgem1_gamma_noB->Scale(3.394e-9);
	...
	hhit_Edepgem1_gamma_1cmAl->SetLineColor(4);
        hhit_Edepgem1_gamma_1cmAl->Scale(3.394e-9);
//	hhit_Edepgem1_gamma_1cmAl->Draw("same HIST");
	hhit_Edepgem1_gamma_1inpoly->SetLineColor(1);
        hhit_Edepgem1_gamma_1inpoly->Scale(3.394e-9);
	...
	hhit_Edepgem1_gamma_35cm->SetLineColor(2);
        hhit_Edepgem1_gamma_35cm->Scale(3.394e-9);
	...
	hhit_Edepgem1_gamma_45cm->SetTitle("e^{-} in front of CC");
        hhit_Edepgem1_gamma_45cm->Scale(3.394e-9);
	...
	hhit_Edepgem1_gamma_25cm->SetLineColor(2);
        hhit_Edepgem1_gamma_25cm->Scale(3.394e-9);
	...
	leg111->AddEntry(hhit_Edepgem1_gamma_45cm,Form("40uA LD2 target ;rate %f MHz/cm2",rate_Edepgem1_gamma_45cm),"l");
	leg111->AddEntry(hhit_Edepgem1_gamma_25cm,Form("40uA LD2 target 30x30x2.54cm3 poly shielding; rate %f MHz/cm2",rate_Edepgem1_gamma_25cm),"l");
...
//        hhit_Edepgem2_gamma->Scale(3.394e-9);
        hhit_Edepgem2_gamma_noTB->Scale(3.394e-9);
...
//	hhit_Edepgem2_gamma->Draw("HIST");
	...
	hhit_Edepgem2_gamma_35cm->SetLineColor(2);
        hhit_Edepgem2_gamma_35cm->Scale(3.394e-9);
	...
	hhit_Edepgem2_gamma_45cm->SetTitle("e^{-} at CC back ");
        hhit_Edepgem2_gamma_45cm->Scale(3.394e-9);
	...
	hhit_Edepgem2_gamma_25cm->SetLineColor(2);
        hhit_Edepgem2_gamma_25cm->Scale(3.394e-9);
	...
	leg41->AddEntry(hhit_Edepgem2_gamma_45cm,Form("40uA LD2 target ; rate=%f MHz/cm2",rate_Edepgem2_gamma_45cm),"l");
	leg41->AddEntry(hhit_Edepgem2_gamma_25cm,Form("40uA LD2 target 30x30x2.54cm3 poly shielding; rate=%f MHz/cm2",rate_Edepgem2_gamma_25cm),"l");
	...
	gSystem->Exec("pdfunite ./c*.pdf ./HallC_Espectrum_full_scattering_20deg_CC.pdf");
