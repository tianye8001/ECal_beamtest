...
void plot_rate_sangle_BLshielding_right_fork(){
	gStyle->SetOptStat(0);
	gStyle->SetPalette(1);
	TFile *f4 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_20deg_BLshield7feet_4x30x30inpoly_r13m/HallC_beamtest_BeamOnTarget_4.955e8_8deg_80uA_sangle_5x10SC_20deg_BLshield7feet_4x30x30inpoly_r13m_reduce_tree_rate_gem_Etotcut.root");
...
//TFile *f18 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle/HallC_beamtest_BeamOnTarget_1e11_8deg_80uA_newCH_reduce_tree_rate_gem.root");
	...
	TFile *f9 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_20deg_BLshield7feet_2inpoly_r13m/HallC_beamtest_BeamOnTarget_4.995e8_8deg_80uA_sangle_5x10SC_20deg_BLshield7feet_2inpoly_r13m_reduce_tree_rate_gem_Etotcut.root");
...
//	TFile *f10 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_20deg_3inpolynear/HallC_beamtest_BeamOnTarget_3.79e8_8deg_80uA_target_step_right_fork_20deg_3inpolynear_reduce_tree_rate_gem_Etotcut.root");
	...
	TFile *f10 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_4deg_r10m_carbon_BLsh7feet_Yaxis5deg/HallC_beamtest_BeamOnTarget_4.477e8_4deg_80uA_5x10SC_r10m_cfoil_BLsh7feet_Yaxis5deg_reduce_tree_rate_gem_Etotalcut.root");
	...
	TFile *f11 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_20deg_BLshield7feet_3x30x30inpoly_r13m/HallC_beamtest_BeamOnTarget_4.97e8_8deg_80uA_sangle_5x10SC_20deg_BLshield7feet_3x30x30inpoly_r13m_reduce_tree_rate_gem_Etotcut.root");
	...
	TFile *f13 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_20deg_4x30x30inpoly_r13m/HallC_beamtest_BeamOnTarget_5e8_8deg_80uA_5x10SC_20deg_4x30x30inpoly_r13m_reduce_tree_rate_gem_Etotcut.root");
	...
	TH1F *GEM00_beam_15cm_hist = (TH1F*)gROOT->FindObject("GEM00_beam_15cm");*/
        tree_pim->Draw("SC0_Eendsum>>shower_pim(4000,0,1000)","rate*(SC0_Eendsum>1.1)","goff");
	TH1F *shower_pim_hist = (TH1F*)gROOT->FindObject("shower_pim");
        tree_beam_more->Draw("SC0_Eendsum>>shower_beam_more(4000,0,1000)","rate*(SC0_Eendsum>1.1)","goff");
	TH1F *shower_beam_more_hist = (TH1F*)gROOT->FindObject("shower_beam_more");
        tree_beam_1cm->Draw("SC0_Eendsum>>shower_beam_1cm(4000,0,1000)","rate*(SC0_Eendsum>1.1)","goff");
	TH1F *shower_beam_1cm_hist = (TH1F*)gROOT->FindObject("shower_beam_1cm");
        tree_beam_15cm->Draw("SC0_Eendsum>>shower_beam_15cm(4000,0,1000)","rate*(SC0_Eendsum>1.1)","goff");
	TH1F *shower_beam_15cm_hist = (TH1F*)gROOT->FindObject("shower_beam_15cm");
        tree_beam_config2r->Draw("SC0_Eendsum>>shower_beam_config2r(4000,0,1000)","rate*(SC0_Eendsum>1.1)","goff");
	...
	TH1F *shower_beam_SC_cut_hist = (TH1F*)gROOT->FindObject("shower_SC0_SC1_beam");*/
        tree_pim->Draw("SC1_Eendsum>>Npesum_pim(200,0,100)","rate*(SC1_Eendsum>1.1)","goff");
	TH1F *Npesum_pim_hist = (TH1F*)gROOT->FindObject("Npesum_pim");
        tree_beam_more->Draw("SC1_Eendsum>>Npesum_beam_more(200,0,100)","rate*(SC1_Eendsum>1.1)","goff");
	TH1F *Npesum_beam_more_hist = (TH1F*)gROOT->FindObject("Npesum_beam_more");
        tree_beam_config2r->Draw("SC1_Eendsum>>Npesum_beam_config2r(200,0,100)","rate*(SC1_Eendsum>1.1)","goff");
	TH1F *Npesum_beam_config2r_hist = (TH1F*)gROOT->FindObject("Npesum_beam_config2r");
        tree_beam_1cm->Draw("SC1_Eendsum>>Npesum_beam_1cm(200,0,100)","rate*(SC1_Eendsum>1.1)","goff");
	TH1F *Npesum_beam_1cm_hist = (TH1F*)gROOT->FindObject("Npesum_beam_1cm");
        tree_beam_15cm->Draw("SC1_Eendsum>>Npesum_beam_15cm(200,0,100)","rate*(SC1_Eendsum>1.1)","goff");
	...
	TH1F *GEM10_beam_config2r_hist = (TH1F*)gROOT->FindObject("GEM10_beam_config2r");
        tree_pim->Draw("SPD_Eendsum>>SPD_pim(200,0,50)","rate*(SPD_Eendsum>0.55)","goff");
	TH1F *SPD_pim_hist = (TH1F*)gROOT->FindObject("SPD_pim");
        tree_beam_more->Draw("SPD_Eendsum>>SPD_beam_more(200,0,50)","rate*(SPD_Eendsum>0.55)","goff");
	TH1F *SPD_beam_more_hist = (TH1F*)gROOT->FindObject("SPD_beam_more");
        tree_beam_1cm->Draw("SPD_Eendsum>>SPD_beam_1cm(200,0,50)","rate*(SPD_Eendsum>0.55)","goff");
	TH1F *SPD_beam_1cm_hist = (TH1F*)gROOT->FindObject("SPD_beam_1cm");
        tree_beam_15cm->Draw("SPD_Eendsum>>SPD_beam_15cm(200,0,50)","rate*(SPD_Eendsum>0.55)","goff");
	TH1F *SPD_beam_15cm_hist = (TH1F*)gROOT->FindObject("SPD_beam_15cm");
        tree_beam_config2r->Draw("SPD_Eendsum>>SPD_beam_config2r(200,0,50)","rate*(SPD_Eendsum>0.55)","goff");
	TH1F *SPD_beam_config2r_hist = (TH1F*)gROOT->FindObject("SPD_beam_config2r");
        tree_pim->Draw("LASPD_Eendsum>>LASPD_pim(200,0,50)","rate*(LASPD_Eendsum>1.8)","goff");
	TH1F *LASPD_pim_hist = (TH1F*)gROOT->FindObject("LASPD_pim");
        tree_beam_more->Draw("LASPD_Eendsum>>LASPD_beam_more(200,0,50)","rate*(LASPD_Eendsum>1.8)","goff");
	TH1F *LASPD_beam_more_hist = (TH1F*)gROOT->FindObject("LASPD_beam_more");
        tree_beam_1cm->Draw("LASPD_Eendsum>>LASPD_beam_1cm(200,0,50)","rate*(LASPD_Eendsum>1.8)","goff");
	TH1F *LASPD_beam_1cm_hist = (TH1F*)gROOT->FindObject("LASPD_beam_1cm");
        tree_beam_15cm->Draw("LASPD_Eendsum>>LASPD_beam_15cm(200,0,50)","rate*(LASPD_Eendsum>1.8)","goff");
	TH1F *LASPD_beam_15cm_hist = (TH1F*)gROOT->FindObject("LASPD_beam_15cm");
        tree_beam_config2r->Draw("LASPD_Eendsum>>LASPD_beam_config2r(200,0,50)","rate*(LASPD_Eendsum>1.8)","goff");
  ...
  leg8->AddEntry(shower_beam_config2r_hist,Form("no shielding 20 deg old SC; total rate=%f MHz",rate_beam_config2r),"l");
  leg8->AddEntry(shower_beam_more_hist,Form("7feet shielding 2x10x10 20 deg small SC; total rate=%f MHz",rate_proton_more),"l");
  leg8->AddEntry(shower_beam_1cm_hist,Form(" 7feet shielding 2x30x30 20 deg small SC; total rate=%f MHz",rate_proton_1cm),"l");
  leg8->AddEntry(shower_beam_15cm_hist,Form("2x30x30 in3 GEM00 shielding 20deg samll SC; total rate=%f MHz",rate_proton_15cm),"l");
  leg8->AddEntry(shower_pim_hist,Form("7feet shielding 20 deg old SC; total rate=%f MHz",rate_pim),"l");
  ...
  leg7->AddEntry(Npesum_beam_config2r_hist,Form("no shielding 20 deg old SC; total rate=%f MHz",rate_SC1_config2r),"l");
  leg7->AddEntry(Npesum_beam_more_hist,Form("7feet shielding 2x10x10 20 deg small SC; total rate=%f MHz",rate_SC1_beam_more),"l");
  leg7->AddEntry(Npesum_beam_1cm_hist,Form("7feet shielding 2x30x30 20 deg small SC; total rate=%f MHz",rate_SC1_beam_1cm),"l");
  leg7->AddEntry(Npesum_beam_15cm_hist,Form("7feet shielding 3x30x30 deg small SC; total rate=%f MHz",rate_SC1_beam_15cm),"l");
  leg7->AddEntry(Npesum_pim_hist,Form("7feet shielding 4x30x30 20 deg small SC; total rate=%f MHz",rate_SC1_pim),"l");
  ...
  leg9->AddEntry(GEM00_beam_config2r_hist,Form("no shielding step 20deg old SC; total rate=%f MHz",rate_proton_gem_config2r),"l");
  leg9->AddEntry(GEM00_pip_hist,Form(" no shielding; total rate=%f MHz",rate_pip_gem),"l");
  leg9->AddEntry(GEM00_beam_more_hist,Form("7feet shielding 2x10x10 20deg small SC; total rate=%f MHz",rate_proton_gem_more),"l");
  leg9->AddEntry(GEM00_beam_1cm_hist,Form("7feet shielding 2x30x30 step HMS  20deg small SC; total rate=%f MHz",rate_proton_gem_1cm),"l");
  leg9->AddEntry(GEM00_beam_15cm_hist,Form("7feet shielding 3x30x39 step HMS  20deg samll SC; total rate=%f MHz",rate_proton_gem_15cm),"l");
  leg9->AddEntry(GEM00_pim_hist,Form("7feet shielding 4x30x30  20deg old SC; total rate=%f MHz",rate_pim_gem),"l");
  ...
  leg19->AddEntry(GEM10_beam_config2r_hist,Form("no shielding step 20deg old SC; total rate=%f MHz",rate_proton_gem_config2r),"l");
  leg19->AddEntry(GEM10_pip_hist,Form(" no shielding; total rate=%f MHz",rate_pip_gem),"l");
  leg19->AddEntry(GEM10_beam_more_hist,Form("7feet shielding 2x10x10 20deg small SC; total rate=%f MHz",rate_proton_gem_more),"l");
  leg19->AddEntry(GEM10_beam_1cm_hist,Form("7feet shielding 2x30x30  20deg small SC; total rate=%f MHz",rate_proton_gem_1cm),"l");
  leg19->AddEntry(GEM10_beam_15cm_hist,Form("7feet 3x30x30 in3 shielding step HMS  20deg samll SC; total rate=%f MHz",rate_proton_gem_15cm),"l");
  leg19->AddEntry(GEM10_pim_hist,Form("7feet shielding 4x30x30  20deg old SC; total rate=%f MHz",rate_pim_gem),"l");
  leg19->AddEntry(GEM10_beam_Edep_hist,Form("2in 10x10 cm^{2} poly GEM10 step HMS 20deg; total rate=%f MHz",rate_proton_gem_Edep),"l");
  ...
  leg18->AddEntry(SPD_beam_config2r_hist,Form("no shielding 20 deg old SC; total rate=%f MHz",SPD_rate_beam_config2r),"l");
  leg18->AddEntry(SPD_beam_more_hist,Form("7feet shielding 2x10x10 20 deg small SC; total rate=%f MHz",SPD_rate_proton_more),"l");
  leg18->AddEntry(SPD_beam_1cm_hist,Form(" 7feet shielding 2x30x30 20 deg small SC; total rate=%f MHz",SPD_rate_proton_1cm),"l");
  leg18->AddEntry(SPD_beam_15cm_hist,Form("2x30x30 in3 GEM00 shielding 20deg samll SC; total rate=%f MHz",SPD_rate_proton_15cm),"l");
  leg18->AddEntry(SPD_pim_hist,Form("7feet shielding 20 deg old SC; total rate=%f MHz",SPD_rate_pim),"l");
  ...
  leg28->AddEntry(LASPD_beam_config2r_hist,Form("no shielding 20 deg old SC; total rate=%f MHz",LASPD_rate_beam_config2r),"l");
  leg28->AddEntry(LASPD_beam_more_hist,Form("7feet shielding 2x10x10 20 deg small SC; total rate=%f MHz",LASPD_rate_proton_more),"l");
  leg28->AddEntry(LASPD_beam_1cm_hist,Form(" 7feet shielding 2x30x30 20 deg small SC; total rate=%f MHz",LASPD_rate_proton_1cm),"l");
  leg28->AddEntry(LASPD_beam_15cm_hist,Form("2x30x30 in3 GEM00 shielding 20deg samll SC; total rate=%f MHz",LASPD_rate_proton_15cm),"l");
  leg28->AddEntry(LASPD_pim_hist,Form("7feet shielding 20 deg old SC; total rate=%f MHz",LASPD_rate_pim),"l");
