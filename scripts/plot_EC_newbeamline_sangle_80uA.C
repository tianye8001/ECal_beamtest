...
void plot_EC_newbeamline_sangle_80uA(){
gStyle->SetOptStat(0);
gStyle->SetPalette(1);
...
TFile *f7 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle/HallC_beamtest_BeamOnTarget_1e8_8deg_80uA_output_Nphe.root");
...
gPad->SetLogy();
 ...
 EC_shower_proton->GetYaxis()->SetRangeUser(1e-2,1e11);
...
double rate_proton= EC_shower_proton->Integral(EC_shower_proton->GetXaxis()->FindBin(0),EC_shower_proton->GetXaxis()->FindBin(200));
...
double rate_eAll= EC_shower_eAll->Integral();
  TLegend *leg8 = new TLegend(0.35,0.6,0.65,0.88);
...
//  leg8->AddEntry(EC_shower_eDIS,"eDIS*1000","l");
 ...
 EC_preshower_proton->GetYaxis()->SetRangeUser(1e-2,1e11);
...
double rate_pip_pre= EC_preshower_pip->Integral();
  TLegend *leg1 = new TLegend(0.35,0.6,0.65,0.88);
 ...
 sc1_proton->GetYaxis()->SetRangeUser(1e-2,1e9);
 sc1_proton->Draw("HIST");
 double rate_proton_sc1= sc1_proton->Integral(sc1_proton->GetXaxis()->FindBin(0),sc1_proton->GetXaxis()->FindBin(100));
 ...
 double rate_pi0_sc1= sc1_pi0->Integral(sc1_pi0->GetXaxis()->FindBin(0),sc1_pi0->GetXaxis()->FindBin(100));
  TLegend *leg21 = new TLegend(0.45,0.6,0.8,0.88);
 ...
 sc2_proton->GetYaxis()->SetRangeUser(1e-2,1e9);
 ...
 c[3]->cd(1);
  ...
  hhit_Edepspd1_proton->GetYaxis()->SetRangeUser(1e-2,1e10);
 ...
 double rate_proton_spd1= hhit_Edepspd1_proton->Integral();
  ...
  hhit_Edepspd1_pim->GetYaxis()->SetRangeUser(1e-2,1e10);
 ...
 double rate_pim_spd1= hhit_Edepspd1_pim->Integral();
  ...
  hhit_Edepspd1_pi0->GetYaxis()->SetRangeUser(1e-2,1e10);
 ...
 double rate_pi0_spd1= hhit_Edepspd1_pi0->Integral();
  ...
  hhit_Edepspd1_pip->GetYaxis()->SetRangeUser(1e-2,1e10);
 ...
 double rate_pip_spd1= hhit_Edepspd1_pip->Integral();
  ...
  hhit_Edepspd1_eAll->GetYaxis()->SetRangeUser(1e-2,1e10);
  hhit_Edepspd1_eAll->Draw("same HIST");
 double rate_eAll_spd1= hhit_Edepspd1_eAll->Integral();
  TLegend *leg13 = new TLegend(0.35,0.6,0.65,0.88);
  ...
  hhit_Edepspd2_proton->GetYaxis()->SetRangeUser(1e-2,1e10);
 ...
 double rate_proton_spd2= hhit_Edepspd2_proton->Integral();
  ...
  hhit_Edepspd2_pim->GetYaxis()->SetRangeUser(1e-2,1e10);
 ...
 double rate_pim_spd2= hhit_Edepspd2_pim->Integral();
  ...
  hhit_Edepspd2_pi0->GetYaxis()->SetRangeUser(1e-2,1e10);
 ...
 double rate_pi0_spd2= hhit_Edepspd2_pi0->Integral();
  ...
  hhit_Edepspd2_pip->GetYaxis()->SetRangeUser(1e-2,1e10);
 ...
 double rate_pip_spd2= hhit_Edepspd2_pip->Integral();
  ...
  hhit_Edepspd2_eAll->GetYaxis()->SetRangeUser(1e-2,1e10);
  hhit_Edepspd2_eAll->Draw("same HIST");
 double rate_eAll_spd2= hhit_Edepspd2_eAll->Integral();
  TLegend *leg14 = new TLegend(0.35,0.6,0.65,0.88);
