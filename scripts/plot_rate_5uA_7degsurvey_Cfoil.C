...
void plot_rate_Cer_newCh_7deg(){
	...
	TH1F *CC_beam_e_hist = (TH1F*)gROOT->FindObject("CC_beam_e");
        ...
        tree_SC1_e->Draw("PreShSum>>preshower_e(300,0,150)","rate*(PreShSum>0)","goff");
	TH1F *preshower_e_hist = (TH1F*)gROOT->FindObject("preshower_e");
        tree_SC1_electron->Draw("PreShSum>>preshower_electron(300,0,150)","rate*(PreShSum>0)","goff");
	TH1F *preshower_electron_hist = (TH1F*)gROOT->FindObject("preshower_electron");
        tree_SC1_gamma->Draw("PreShSum>>preshower_gamma(300,0,150)","rate*(PreShSum>0)","goff");
	TH1F *preshower_gamma_hist = (TH1F*)gROOT->FindObject("preshower_gamma");
        tree_beam->Draw("PreShSum>>preshower_beam(300,0,150)","rate*(PreShSum>0)","goff");
	TH1F *preshower_beam_hist = (TH1F*)gROOT->FindObject("preshower_beam");
        tree_beam_gamma->Draw("PreShSum>>preshower_beam_gamma(300,0,150)","rate*(PreShSum>0)","goff");
	TH1F *preshower_beam_gamma_hist = (TH1F*)gROOT->FindObject("preshower_beam_gamma");
        tree_beam_e->Draw("PreShSum>>preshower_beam_e(300,0,150)","rate*(PreShSum>0)","goff");
	TH1F *preshower_beam_e_hist = (TH1F*)gROOT->FindObject("preshower_beam_e");
       
        tree_SC1_e->Draw("ShowerSum>>shower_e(1000,0,2000)","rate*(ShowerSum>0)","goff");
	TH1F *shower_e_hist = (TH1F*)gROOT->FindObject("shower_e");
        tree_SC1_electron->Draw("ShowerSum>>shower_electron(1000,0,2000)","rate*(ShowerSum>0)","goff");
	TH1F *shower_electron_hist = (TH1F*)gROOT->FindObject("shower_electron");
        tree_SC1_gamma->Draw("ShowerSum>>shower_gamma(1000,0,2000)","rate*(ShowerSum>0)","goff");
	...
	TH1F *shower_beam_hist = (TH1F*)gROOT->FindObject("shower_beam");
        tree_beam_gamma->Draw("ShowerSum>>shower_beam_gamma(1000,0,2000)","rate*(ShowerSum>0)","goff");
	TH1F *shower_beam_gamma_hist = (TH1F*)gROOT->FindObject("shower_beam_gamma");
        tree_beam_e->Draw("ShowerSum>>shower_beam_e(1000,0,2000)","rate*(ShowerSum>0)","goff");
  ...
  TLegend *leg19 = new TLegend(0.15,0.68,0.6,0.88);
  leg19->AddEntry(SC3_electron_hist,Form("from bggen #pi^{+}; total rate=%f kHz",rate_electron_SC3),"l");
  leg19->AddEntry(SC3_beam_hist,Form("from BeamOnTarget+shielding; total rate=%f kHz",rate_proton_SC3),"l");
  leg19->AddEntry(SC3_beam_e_hist,Form("from BeamOnTarget; total rate=%f kHz",rate_beam_e_SC3),"l");
