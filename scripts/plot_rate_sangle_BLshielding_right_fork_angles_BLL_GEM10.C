...
//TFile *f18 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle/HallC_beamtest_BeamOnTarget_1e11_8deg_80uA_newCH_reduce_tree_rate_gem.root");
	...
	//TFile *f10 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_650cmBLLcoli_3inpoly_20deg/HallC_beamtest_BeamOnTarget_4.995e8_8deg_80uA_target_step_right_fork_20deg_650cmBLLcoli_3inpoly_reduce_tree_rate_gem_Etotcut.root");
...
//	TFile *f10 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_750cmBLLcoli_4inpoly_20deg/HallC_beamtest_BeamOnTarget_4.965e8_8deg_80uA_target_step_right_fork_20deg_750cmBLLcoli_4inpoly_reduce_tree_rate_gem_Etotcut.root");
	...
	TFile *f11 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_BLLcoli_25deg/HallC_beamtest_BeamOnTarget_5e8_8deg_80uA_target_step_right_fork_25deg_BLLcoli_reduce_tree_rate_gem_Etotcut.root");
  ...
  leg7->Draw("text same");
	...
	gPad->SetLogy();
      ...
      //  double rate_proton_gem= GEM00_beam_hist->Integral();
        ...
        GEM00_beam_config2r_hist->GetXaxis()->SetTitle("GEM10_x (cm)");
