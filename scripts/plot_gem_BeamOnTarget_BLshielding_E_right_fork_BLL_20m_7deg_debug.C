...
//	TFile *f14 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_BLshielding_GEM4cmAl/HallC_beamtest_BeamOnTarget_3.85e8_8deg_80uA_target_right_step_BLshielding2x4x190_4cmAl_output_gem_electronE_pzcut.root");
	...
	TFile *f7 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_7deg_r10m_carbon/HallC_beamtest_BeamOnTarget_2.0976e9_7deg_5uA_5x10SC_r20m_cfoil_output_gem_gammaE_pzcut_debug.root");
...
//	TFile *f7 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_vacuum_CCvacuum/HallC_beamtest_BeamOnTarget_1e10_8deg_80uA_target_step_right_output_gem_gammaE_pzcut.root");
	...
	TFile *f4 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_5uA_4SCsurvey_7deg_r20m_carbon/HallC_beamtest_BeamOnTarget_1e9_7degsurvey_5uA_4SC_r20m_cfoil_output_gem_gammaE_pzcut_debug.root");
	...
	TFile *f6 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_5uA_4SCsurvey_7deg_r20m_carbon_shielding/HallC_beamtest_BeamOnTarget_2e9_7degsurvey_5uA_4SC_r20m_cfoil_shielding_output_gem_gammaE_pzcut_debug.root");
...
//	TFile *f14 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_7deg_r10m_3He/HallC_beamtest_BeamOnTarget_5e8_7deg_80uA_5x10SC_r10m_3He_output_ec_electronE_pzcut.root");
	TFile *f14 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_5uA_4SCsurvey_7deg_r20m_carbon/HallC_beamtest_BeamOnTarget_1e9_7degsurvey_5uA_4SC_r20m_cfoil_output_gem_electronE_pzcut_debug.root");
	//TFile *f14 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_25deg/HallC_beamtest_BeamOnTarget_5e8_8deg_80uA_target_step_right_fork_25deg_output_gem_electronE_pzcut.root");
	...
	TFile *f17 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_7deg_r10m_carbon/HallC_beamtest_BeamOnTarget_2.0976e9_7deg_5uA_5x10SC_r20m_cfoil_output_gem_electronE_pzcut_debug.root");
	...
	TFile *f16 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_5uA_4SCsurvey_7deg_r20m_carbon_shielding/HallC_beamtest_BeamOnTarget_2e9_7degsurvey_5uA_4SC_r20m_cfoil_shielding_output_gem_electronE_pzcut_debug.root");
...
//	leg1->AddEntry(hhit_theta_1cmAl,"7feet shielding Yaxis 5deg + 2in poly  ","l");
	...
	leg01->AddEntry(hhit_theta_55cm_gem2,"full setup #theta=7deg old ","l");
	leg01->AddEntry(hhit_theta_45cm_gem2,"full setup #theta=7deg new+shielding","l");
	...
	leg01->AddEntry(hhit_theta_25cm_gem2,"full setup #theta=7deg new","l");
	...
	leg21->AddEntry(hhit_theta_55cm_electron,"full setup #theta=7deg old","l");
	leg21->AddEntry(hhit_theta_45cm_electron,"full setup #theta=7deg new+shielding","l");
	...
	leg21->AddEntry(hhit_theta_25cm_electron,"full setup #theta=7deg new","l");
 ...
 //       hhit_theta_gem2_electron->Scale(0.00000001);
  ...
  //      hhit_theta_gem2_electron->Draw("HISt");	
	...
	leg201->AddEntry(hhit_theta_55cm_gem2_electron,"full setup #theta=7deg old","l");
	leg201->AddEntry(hhit_theta_45cm_gem2_electron,"full setup #theta=7deg new+shielding","l");
	...
	leg201->AddEntry(hhit_theta_25cm_gem2_electron,"full setup #theta=7deg new","l");
	...
	hhit_Edepgem1_electron_45cm->SetTitle("#gamma on gem1 virtual plane");
        ...
        hhit_Edepgem1_electron_45cm->GetYaxis()->SetRangeUser(1e-5,5e0);	
...
//	leg11->AddEntry(hhit_Edepgem1_electron,"no shielding beamline survey+old simu","l");
	leg11->AddEntry(hhit_Edepgem1_electron_55cm,Form("0.04525 cm C-foil full 7 deg; rate=%f MHz/cm2",rate_Edepgem1_electron_55cm),"l");
	leg11->AddEntry(hhit_Edepgem1_electron_45cm,Form("0.04525 cm C-foil target+vacuum 7 deg; rate=%f MHz/cm2",rate_Edepgem1_electron_45cm),"l");
	...
	leg11->AddEntry(hhit_Edepgem1_electron_25cm,Form("0.04525 cm C-foil target+air 7 deg; rate=%f MHz/cm2",rate_Edepgem1_electron_25cm),"l");
...
//	hhit_Edepgem2_electron->Draw("HIST");
	...
	hhit_Edepgem2_electron_45cm->SetTitle("#gamma on gem2 virtual plane");
        ...
        hhit_Edepgem2_electron_45cm->GetYaxis()->SetRangeUser(1e-5,5e0);	
...
//	leg11->AddEntry(hhit_Edepgem1_electron,"no shielding beamline survey+old simu","l");
	leg31->AddEntry(hhit_Edepgem2_electron_55cm,Form("0.04525 cm C-foil full 7 deg old; rate=%f MHz/cm2",rate_Edepgem2_electron_55cm),"l");
	leg31->AddEntry(hhit_Edepgem2_electron_45cm,Form("0.04525 cm C-foil full 7 deg new+shileding; rate=%f MHz/cm2",rate_Edepgem2_electron_45cm),"l");
...
//	leg31->AddEntry(hhit_Edepgem2_electron_35cm,Form("7feet shielding Yaxis 5deg rate=%f MHz/cm2",rate_Edepgem2_electron_35cm),"l");
	leg31->AddEntry(hhit_Edepgem2_electron_25cm,Form("0.04525 cm C-foil full 7 deg new; rate=%f MHz/cm2",rate_Edepgem2_electron_25cm),"l");
...
//	hhit_Edepgem1_gamma_1cmAl->Draw("same HIST");
	...
	hhit_Edepgem1_gamma_45cm->SetTitle("e^{-} on gem1 virtual plane");
        ...
        hhit_Edepgem1_gamma_45cm->GetYaxis()->SetRangeUser(1e-4,1e0);	
...
//	leg111->AddEntry(hhit_Edepgem1_electron,"no shielding beamline survey+old simu","l");
	leg111->AddEntry(hhit_Edepgem1_gamma_55cm,Form("0.04525 cm C-foil full 7 deg old; rate %f MHz/cm2",rate_Edepgem1_gamma_55cm),"l");
	leg111->AddEntry(hhit_Edepgem1_gamma_45cm,Form("0.04525 cm C-foil full 7 deg new+shielding;rate %f MHz/cm2",rate_Edepgem1_gamma_45cm),"l");
...
//	leg111->AddEntry(hhit_Edepgem1_gamma_35cm,Form("10cm 3He target+beamline 7 deg 40uA E>1 MeV rate %f MHz/cm2",rate_Edepgem1_gamma_35cm),"l");
	leg111->AddEntry(hhit_Edepgem1_gamma_25cm,Form("0.04525 cm C-foil full 7 deg new; rate %f MHz/cm2",rate_Edepgem1_gamma_25cm),"l");
...
//	hhit_Edepgem2_gamma->Draw("HIST");
	...
	hhit_Edepgem2_gamma_45cm->SetTitle("e^{-} on gem2 virtual plane");
        ...
        hhit_Edepgem2_gamma_45cm->GetYaxis()->SetRangeUser(1e-4,1e0);	
...
//	leg111->AddEntry(hhit_Edepgem1_electron,"no shielding beamline survey+old simu","l");
	leg41->AddEntry(hhit_Edepgem2_gamma_55cm,Form("0.04525 cm C-foil full old 7 deg; rate=%f MHz/cm2",rate_Edepgem2_gamma_55cm),"l");
	leg41->AddEntry(hhit_Edepgem2_gamma_45cm,Form("0.04525 cm C-foil full new+shielding 7 deg; rate=%f MHz/cm2",rate_Edepgem2_gamma_45cm),"l");
...
//	leg41->AddEntry(hhit_Edepgem2_gamma_35cm,Form("7feet shielding Yaxis 5 deg rate=%f MHz/cm2",rate_Edepgem2_gamma_35cm),"l");
	leg41->AddEntry(hhit_Edepgem2_gamma_25cm,Form("0.04525 cm C-foil new 7 deg; rate=%f MHz/cm2",rate_Edepgem2_gamma_25cm),"l");
	...
	gSystem->Exec("pdfunite ./c*.pdf ./HallC_Espectrum_full_scattering_7deg_debug.pdf");
