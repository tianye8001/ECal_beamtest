...
void plot_rate_newCh(){
	gStyle->SetOptStat(0);
	gStyle->SetPalette(1);
	TFile *f5 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pip_7degsurvey_Cfoil/HallC_beamtest_bggen_Cfoil_pip_7degsurvey_filenum2000_10.6GeV_reduce_tree_rate_gem1_Etotalcut.root");
	...
	TFile *f4 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pim_7degsurvey_Cfoil/HallC_beamtest_bggen_Cfoil_pim_7degsurvey_filenum2000_10.6GeV_reduce_tree_rate_gem1_Etotalcut.root");
	TFile *f6 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pi0_7degsurvey_Cfoil/HallC_beamtest_bggen_Cfoil_pi0_7degsurvey_filenum2000_10.6GeV_reduce_tree_rate_gem1_Etotalcut.root");
	...
	TFile *f8 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_5uA_4SCsurvey_7deg_r20m_carbon/HallC_beamtest_BeamOnTarget_1e9_7degsurvey_5uA_4SC_r20m_cfoil_reduce_tree_rate_gem1_Etotalcut.root");
	TFile *f18 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_5uA_4SCsurvey_7deg_r20m_carbon_shielding/HallC_beamtest_BeamOnTarget_2e9_7degsurvey_5uA_4SC_r20m_cfoil_shielding_reduce_tree_rate_gem1_Etotalcut.root");
...
//	TFile *f9 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_dummy_80uA/HallC_beamtest_BeamOnTarget_1e10_dummy_80uA_newCh_reduce_tree_rate_test.root");
	...
	/*	int ndata = tree_eAll->Draw("(GEM00_x-GEM10_x):(GEM00_y-GEM10_y)",
		...
		*/
        ...
        tree_pip->Draw("SC_B_Eendsum>>SC2_pip(100,0,50)","rate*(SC_B_Eendsum>0 )","goff");
	TH1F *SC2_pip_hist = (TH1F*)gROOT->FindObject("SC2_pip");
        tree_pim->Draw("SC_B_Eendsum>>SC2_pim(100,0,50)","rate*(SC_B_Eendsum>0)","goff");
	TH1F *SC2_pim_hist = (TH1F*)gROOT->FindObject("SC2_pim");
        tree_pi0->Draw("SC_B_Eendsum>>SC2_pi0(100,0,50)","rate*(SC_B_Eendsum>0)","goff");
	TH1F *SC2_pi0_hist = (TH1F*)gROOT->FindObject("SC2_pi0");
        tree_beam->Draw("SC_B_Eendsum>>SC2_beam(100,0,50)","rate*(SC_B_Eendsum>0)","goff");
	...
	TH1F *SC2_beam_e_hist = (TH1F*)gROOT->FindObject("SC2_beam_e");
        tree_beam_pb->Draw("SC_B_Eendsum>>SC3_beam_pb(100,0,50)","rate*(SC_B_Eendsum>0)","goff");
	...
	TH1F *shower_beam_hist = (TH1F*)gROOT->FindObject("shower_beam");
        ...
        tree_pip->Draw("ShowerSum>>shower_pip(1000,0,2000)","rate*(ShowerSum>0 )","goff");
	TH1F *shower_pip_hist = (TH1F*)gROOT->FindObject("shower_pip");
        tree_pim->Draw("ShowerSum>>shower_pim(1000,0,2000)","rate*(ShowerSum>0 )","goff");
	TH1F *shower_pim_hist = (TH1F*)gROOT->FindObject("shower_pim");
        tree_pi0->Draw("ShowerSum>>shower_pi0(1000,0,2000)","rate*(ShowerSum>0 )","goff");
	TH1F *shower_pi0_hist = (TH1F*)gROOT->FindObject("shower_pi0");
        tree_beam->Draw("ShowerSum>>shower_beam(1000,0,2000)","rate*(ShowerSum>0)","goff");
	TH1F *shower_beam_hist = (TH1F*)gROOT->FindObject("shower_beam");
        tree_beam_preshower->Draw("ShowerSum>>shower_beam_preshower(1000,0,2000)","rate*(ShowerSum>0)","goff");
	...
	TH1F *shower_beam_bp_hist = (TH1F*)gROOT->FindObject("shower_beam_pb");
        tree_beam_electron->Draw("ShowerSum>>shower_beam_electron(1000,0,2000)","rate*(ShowerSum>0)","goff");
	...
	gPad->SetLogy();
        ...
        shower_beam_electron_hist->SetLineColor(kOrange-3);
        shower_beam_electron_hist->Scale(0.001);
        shower_beam_electron_hist->Draw("same HIST");
        double rate_beam_electron= shower_beam_electron_hist->Integral();
        shower_beam_hist->Draw("same HIST");
  ...
  leg8->AddEntry(shower_beam_electron_hist,Form("from eAll ; total rate=%f kHz",rate_beam_electron),"l");
  ...
  leg8->Draw("text same");
	...
	gPad->SetLogy();
        ...
        SC2_beam_electron_hist->SetLineColor(kOrange-3);
        SC2_beam_electron_hist->Scale(0.001);
        SC2_beam_electron_hist->Draw("same HIST");
        double rate_beam_electron_SC2= SC2_beam_electron_hist->Integral();
        SC2_pip_hist->Draw("same HIST");
        SC2_pim_hist->Draw("same HIST");
 ...
 /* leg18->AddEntry(SC2_pim_hist,Form("from bggen #pi^{-} SC1 0.5MIP cut; total rate=%f kHz",rate_pim_SC2),"l");
  ...
  leg18->AddEntry(SC2_beam_hist,Form("from eAll ; total rate=%f kHz",rate_beam_electron_SC2),"l");
  leg18->AddEntry(SC2_beam_electron_hist,Form("from BeamOnTarget ; total rate=%f kHz",rate_proton_SC2),"l");
