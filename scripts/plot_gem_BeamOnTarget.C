...
void plot_gem_BeamOnTarget(){
	...
	TFile *f2 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_15cmPb/HallC_beamtest_BeamOnTarget_1e11_8deg_80uA_newCH_35cmPb_output_gem_gamma.root");
	TFile *f3 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_1cmpb/HallC_beamtest_BeamOnTarget_0.997e11_8deg_80uA_newCH_25cmPb_output_gem_gamma.root");
	TH1F *hprocid_gem1;       
	TH1F *hpf_gem1;
	TH1F *hE_gem1;
	TH1F *hpf_gem1_1cmAl;
	...
	hhit_Edepgem1_electron_1cmAl->SetLineColor(8);
	hhit_Edepgem1_electron_1cmAl->Draw("same HIST");
	hhit_Edepgem1_electron_1inpoly->SetLineColor(7);
	...
	leg11->AddEntry(hhit_Edepgem1_electron_1cmAl,"abs(mpid)=11, 1.5 cm Pb Coli","l");
	leg11->AddEntry(hhit_Edepgem1_electron_1inpoly,"abs(mpid)=11, 1 cm Pb Coli","l");
