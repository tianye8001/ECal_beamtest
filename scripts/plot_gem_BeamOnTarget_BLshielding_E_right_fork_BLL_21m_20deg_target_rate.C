...
void plot_gem_BeamOnTarget_BLshielding_E_right_fork_debug(){
	gStyle->SetOptStat(0);
	gStyle->SetPalette(1);
	TFile *f7 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_5uA_4SCsurvey_7deg_r20m_dummy_shielding/HallC_beamtest_BeamOnTarget_8.855e7_7degsurvey_5uA_4SC_r20m_dummy_shielding_output_SCAD_gammaE_pzcut_debug.root");
	TFile *f4 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_5uA_4SCsurvey_7deg_r20m_3He_shielding/HallC_beamtest_BeamOnTarget_9.89e7_7degsurvey_5uA_4SC_r20m_3He_shielding_output_SCAD_gammaE_pzcut_debug.root");
	TFile *f14 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_5uA_4SCsurvey_7deg_r20m_3He_shielding/HallC_beamtest_BeamOnTarget_9.89e7_7degsurvey_5uA_4SC_r20m_3He_shielding_output_SCAD_electronE_pzcut_debug.root");
	TFile *f17 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_5uA_4SCsurvey_7deg_r20m_dummy_shielding/HallC_beamtest_BeamOnTarget_8.855e7_7degsurvey_5uA_4SC_r20m_dummy_shielding_output_SCAD_electronE_pzcut_debug.root");
	TFile *f6 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_5uA_4SCsurvey_7deg_r20m_dummyCarbon_shielding/HallC_beamtest_BeamOnTarget_9.435e7_7degsurvey_5uA_4SC_r20m_dummyCarbon_shielding_output_SCAD_gammaE_pzcut_debug.root");
	TFile *f16 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_5uA_4SCsurvey_7deg_r20m_dummyCarbon_shielding/HallC_beamtest_BeamOnTarget_9.435e7_7degsurvey_5uA_4SC_r20m_dummyCarbon_shielding_output_SCAD_electronE_pzcut_debug.root");
	//TFile *f6 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_5uA_4SCsurvey_7deg_r20m_carbon_shielding/HallC_beamtest_BeamOnTarget_8.61e7_7degsurvey_5uA_4SC_r20m_cfoil_shielding_output_SCAD_gammaE_pzcut_debug.root");
	//TFile *f16 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_5uA_4SCsurvey_7deg_r20m_carbon_shielding/HallC_beamtest_BeamOnTarget_8.61e7_7degsurvey_5uA_4SC_r20m_cfoil_shielding_output_SCAD_electronE_pzcut_debug.root");
	TH1F *hprocid_gem1;       
	TH1F *hpf_gem1;
	TH1F *hE_gem1;
	TH1F *hpf_gem1_1cmAl;
...
/*        hhit_theta_noTB->GetYaxis()->SetTitle("rate (MHz/cm2)");	
       ...
       // hhit_theta_noTB->Scale(2.67e-8);
        ...
        hhit_theta_45cm->SetTitle("#gamma in front of SC_A");	
        hhit_theta_45cm->GetXaxis()->SetRangeUser(0,95);	
        hhit_theta_45cm->Scale(2.67e-8);
        hhit_theta_45cm->GetYaxis()->SetRangeUser(1e-3,1e2);	
        hhit_theta_45cm->Draw("same HISt");	
        hhit_theta_25cm->SetLineColor(2);	
        hhit_theta_25cm->Scale(2.67e-8);
        hhit_theta_25cm->Draw("same HISt");	
        hhit_theta_35cm->SetLineColor(6);	
        hhit_theta_35cm->Scale(2.67e-8);
        hhit_theta_35cm->Draw("same HISt");	
	TLegend *leg1 = new TLegend(0.45,0.7,0.8,0.9);
	leg1->AddEntry(hhit_theta_45cm,"2uA Al dummy target","l");
	leg1->AddEntry(hhit_theta_35cm,"5uA C-foil target","l");
	leg1->AddEntry(hhit_theta_25cm,"2uA 3He target","l");
	...
	gPad->SetGridx();
      //  hhit_theta_gem2->SetLineColor(6);	
       // hhit_theta_gem2->Scale(7.158e-9);
        ...
        hhit_theta_gem2_noTB->Scale(7.158e-9);
       ...
       // hhit_theta_gem2->Draw("HISt");	
        ...
        hhit_theta_gem2_noB->Scale(7.158e-9);
        hhit_theta_gem2_noB->Draw("same HISt");	
        hhit_theta_1inpoly_gem2->SetLineColor(1);	
        hhit_theta_1inpoly_gem2->Scale(7.158e-9);
        ...
        hhit_theta_45cm_gem2->SetTitle("#gamma at SC_D ");	
        hhit_theta_45cm_gem2->GetXaxis()->SetRangeUser(0,95);	
        hhit_theta_45cm_gem2->Scale(7.158e-9);
        ...
        hhit_theta_25cm_gem2->Scale(7.158e-9);
        hhit_theta_25cm_gem2->Draw("same HISt");	
        hhit_theta_35cm_gem2->SetLineColor(6);	
        hhit_theta_35cm_gem2->Scale(7.158e-9);
        hhit_theta_35cm_gem2->Draw("same HISt");	
	TLegend *leg01 = new TLegend(0.45,0.7,0.8,0.9);
	leg01->AddEntry(hhit_theta_45cm_gem2,"2uA Al dummy target ","l");
	leg01->AddEntry(hhit_theta_35cm_gem2,"5uA C-foil target ","l");
	leg01->AddEntry(hhit_theta_25cm_gem2,"2uA 3He target","l");
	...
	gPad->SetGridx();
      ...
      //  hhit_theta_electron->Scale(7.158e-9);
        hhit_theta_noTB_electron->Scale(7.158e-9);
       ...
       // hhit_theta_electron->Draw("HISt");	
        ...
        hhit_theta_35cm_electron->Scale(7.158e-9);
        hhit_theta_35cm_electron->Draw("same HIST");	
        hhit_theta_25cm_electron->SetLineColor(7);	
        hhit_theta_25cm_electron->Scale(7.158e-9);
        ...
        hhit_theta_45cm_electron->SetTitle("e^{-} in front of SC_A");	
        hhit_theta_45cm_electron->GetXaxis()->SetRangeUser(0,95);	
        hhit_theta_45cm_electron->Scale(2.67e-8);
        ...
        hhit_theta_25cm_electron->Scale(2.67e-8);
        hhit_theta_25cm_electron->Draw("same HIST");	
        hhit_theta_35cm_electron->SetLineColor(6);	
        hhit_theta_35cm_electron->Scale(2.67e-8);
        hhit_theta_35cm_electron->Draw("same HIST");	
	TLegend *leg21 = new TLegend(0.4,0.73,0.8,0.9);
	leg21->AddEntry(hhit_theta_45cm_electron,"2uA Al dummy target ","l");
	leg21->AddEntry(hhit_theta_35cm_electron,"5uA C-foil target ","l");
	leg21->AddEntry(hhit_theta_25cm_electron,"2uA 3He target","l");
 ...
 //       hhit_theta_gem2_electron->Scale(7.158e-9);
        ...
        hhit_theta_gem2_noTB_electron->Scale(7.158e-9);
  ...
  //      hhit_theta_gem2_electron->Draw("HISt");	
        ...
        hhit_theta_35cm_gem2_electron->Scale(7.158e-9);
        hhit_theta_35cm_gem2_electron->Draw("same HISt");	
        hhit_theta_1inpoly_gem2_electron->Draw("same HISt");	
        hhit_theta_25cm_gem2_electron->SetLineColor(7);	
        hhit_theta_25cm_gem2_electron->Scale(7.158e-9);
        ...
        hhit_theta_45cm_gem2_electron->SetTitle("e^{-} at SC_D");	
        hhit_theta_45cm_gem2_electron->GetXaxis()->SetRangeUser(0,95);	
        hhit_theta_45cm_gem2_electron->Scale(7.158e-9);
	...
	leg201->AddEntry(hhit_theta_45cm_gem2_electron,"2uA Al dummy target","l");
	leg201->AddEntry(hhit_theta_35cm_gem2_electron,"5uA C-foil target ","l");
	leg201->AddEntry(hhit_theta_25cm_gem2_electron,"2uA 3He target ","l");
	...
	hhit_Edepgem1_electron_noTB->SetTitle("#gamma on gem1 virtual plane");
        hhit_Edepgem1_electron_noTB->Scale(7.158e-9);
	...
	hhit_Edepgem1_electron_35cm->SetLineColor(2);
        hhit_Edepgem1_electron_35cm->Scale(7.158e-9);
	...
	hhit_Edepgem1_electron_45cm->SetTitle("#gamma in front of SC_A");
        hhit_Edepgem1_electron_45cm->Scale(2.67e-8);
	...
	hhit_Edepgem1_electron_25cm->SetLineColor(2);
        hhit_Edepgem1_electron_25cm->Scale(2.67e-8);
	...
	hhit_Edepgem1_electron_35cm->SetLineColor(6);
        hhit_Edepgem1_electron_35cm->Scale(2.67e-8);
	hhit_Edepgem1_electron_35cm->Draw("same HIST");
        double rate_Edepgem1_electron_35cm= hhit_Edepgem1_electron_35cm->Integral();
	TLegend *leg11 = new TLegend(0.12,0.68,0.5,0.88);
	leg11->AddEntry(hhit_Edepgem1_electron_45cm,Form("2uA Al dummy target ; rate=%f MHz/cm2",rate_Edepgem1_electron_45cm),"l");
	leg11->AddEntry(hhit_Edepgem1_electron_35cm,Form("5uA C-foil target; rate=%f MHz/cm2",rate_Edepgem1_electron_35cm),"l");
	leg11->AddEntry(hhit_Edepgem1_electron_25cm,Form("2uA 3He target; rate=%f MHz/cm2",rate_Edepgem1_electron_25cm),"l");
...
/*	hhit_Edepgem2_electron_noTB->GetYaxis()->SetTitle("rate (MHz/cm2)");
  ...
  //      hhit_Edepgem2_electron->Scale(7.158e-9);
        hhit_Edepgem2_electron_noTB->Scale(7.158e-9);
...
//	hhit_Edepgem2_electron->Draw("HIST");
	...
	hhit_Edepgem2_electron_35cm->SetLineColor(2);
        hhit_Edepgem2_electron_35cm->Scale(7.158e-9);
	...
	hhit_Edepgem2_electron_45cm->SetTitle("#gamma at SC_D ");
        hhit_Edepgem2_electron_45cm->Scale(7.158e-9);
	...
	hhit_Edepgem2_electron_25cm->SetLineColor(2);
        hhit_Edepgem2_electron_25cm->Scale(7.158e-9);
	...
	leg31->AddEntry(hhit_Edepgem2_electron_45cm,Form("2uA Al dummy target; rate=%f MHz/cm2",rate_Edepgem2_electron_45cm),"l");
	leg31->AddEntry(hhit_Edepgem2_electron_35cm,Form("5uA C-foil target ; rate=%f MHz/cm2",rate_Edepgem2_electron_35cm),"l");
	leg31->AddEntry(hhit_Edepgem2_electron_25cm,Form("2uA 3He target ; rate=%f MHz/cm2",rate_Edepgem2_electron_25cm),"l");
	...
	hhit_Edepgem1_gamma_noTB->SetTitle("e^{-} on gem1 virtual plane");
        hhit_Edepgem1_gamma_noTB->Scale(7.158e-9);
	...
	hhit_Edepgem1_gamma_noB->SetLineColor(6);
        hhit_Edepgem1_gamma_noB->Scale(7.158e-9);
	...
	hhit_Edepgem1_gamma_1cmAl->SetLineColor(4);
        hhit_Edepgem1_gamma_1cmAl->Scale(7.158e-9);
//	hhit_Edepgem1_gamma_1cmAl->Draw("same HIST");
	hhit_Edepgem1_gamma_1inpoly->SetLineColor(1);
        hhit_Edepgem1_gamma_1inpoly->Scale(7.158e-9);
	...
	hhit_Edepgem1_gamma_35cm->SetLineColor(2);
        hhit_Edepgem1_gamma_35cm->Scale(7.158e-9);
	...
	hhit_Edepgem1_gamma_45cm->SetTitle("e^{-} in front of SC_A");
        hhit_Edepgem1_gamma_45cm->Scale(2.67e-8);
	...
	hhit_Edepgem1_gamma_25cm->SetLineColor(2);
        hhit_Edepgem1_gamma_25cm->Scale(2.67e-8);
	...
	hhit_Edepgem1_gamma_35cm->SetLineColor(6);
        hhit_Edepgem1_gamma_35cm->Scale(2.67e-8);
	hhit_Edepgem1_gamma_35cm->Draw("same HIST");
        double rate_Edepgem1_gamma_35cm= hhit_Edepgem1_gamma_35cm->Integral();
	TLegend *leg111 = new TLegend(0.12,0.7,0.5,0.88);
	leg111->AddEntry(hhit_Edepgem1_gamma_45cm,Form("2uA Al dummy target ;rate %f MHz/cm2",rate_Edepgem1_gamma_45cm),"l");
	leg111->AddEntry(hhit_Edepgem1_gamma_35cm,Form("3uA C-foil target ; rate %f MHz/cm2",rate_Edepgem1_gamma_35cm),"l");
	leg111->AddEntry(hhit_Edepgem1_gamma_25cm,Form("2uA 3He target ; rate %f MHz/cm2",rate_Edepgem1_gamma_25cm),"l");
...
//        hhit_Edepgem2_gamma->Scale(7.158e-9);
        hhit_Edepgem2_gamma_noTB->Scale(7.158e-9);
...
//	hhit_Edepgem2_gamma->Draw("HIST");
	...
	hhit_Edepgem2_gamma_35cm->SetLineColor(2);
        hhit_Edepgem2_gamma_35cm->Scale(7.158e-9);
	...
	hhit_Edepgem2_gamma_45cm->SetTitle("e^{-} at SC_D ");
        hhit_Edepgem2_gamma_45cm->Scale(7.158e-9);
	...
	hhit_Edepgem2_gamma_25cm->SetLineColor(2);
        hhit_Edepgem2_gamma_25cm->Scale(7.158e-9);
	...
	leg41->AddEntry(hhit_Edepgem2_gamma_45cm,Form("2uA Al dummy target ; rate=%f MHz/cm2",rate_Edepgem2_gamma_45cm),"l");
	leg41->AddEntry(hhit_Edepgem2_gamma_35cm,Form("5uA C-foil target ; rate=%f MHz/cm2",rate_Edepgem2_gamma_35cm),"l");
	leg41->AddEntry(hhit_Edepgem2_gamma_25cm,Form("2uA 3He target ; rate=%f MHz/cm2",rate_Edepgem2_gamma_25cm),"l");
	...
	gSystem->Exec("pdfunite ./c*.pdf ./HallC_Espectrum_full_scattering_20deg_SC_AD.pdf");
