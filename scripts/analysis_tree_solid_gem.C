...
bool process_tree_solid_gem(TTree *tree_solid_gem,double *Eend_gem1gas,double *Eend_gem2gas, double &Eend_total_gem1, double &Eend_total_gem2, int &procID_gem, int &mpid_gem, int &pid_gem)
{
