...
int analysis_hadron_all(string inputfile_name,string runmode="trigger", bool Is_tellorig=false,string filetype="",bool Is_new=true){
...
sprintf(outputfile_name, "%s_output_positron_all_more.root",the_filename);
