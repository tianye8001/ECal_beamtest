...
void plot_rate_newCh(){
	gStyle->SetOptStat(0);
	gStyle->SetPalette(1);
	TFile *f5 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pip_4deg_Cfoil/HallC_beamtest_bggen_Cfoil_pip_4deg_filenum1000_reduce_tree_rate_gem_Etotalcut.root");
	...
	TFile *f4 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pim_4deg_Cfoil/HallC_beamtest_bggen_Cfoil_pim_4deg_filenum1000_reduce_tree_rate_gem_Etotalcut.root");
	TFile *f6 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pi0_4deg_Cfoil/HallC_beamtest_bggen_Cfoil_pi0_4deg_filenum1000_reduce_tree_rate_gem_Etotalcut.root");
	TFile *f7 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_eAll_4deg_Cfoil/HallC_beamtest_eAll_Cfoil_4deg_filenum100_1e6_reduce_tree_rate_gem_Etotalcut.root");
	TFile *f8 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_4deg_r10m_carbon/HallC_beamtest_BeamOnTarget_4.884e8_4deg_80uA_5x10SC_r10m_cfoil_reduce_tree_rate_gem_Etotalcut.root");
...
//	TH1F *shower_beam_dum_hist = (TH1F*)gROOT->FindObject("shower_beam_dum");
        tree_pip->Draw("ShowerSum>>shower_pip(200,0,1200)","rate*(ShowerSum>600 )","goff");
	TH1F *shower_pip_hist = (TH1F*)gROOT->FindObject("shower_pip");
        tree_pim->Draw("ShowerSum>>shower_pim(200,0,1200)","rate*(ShowerSum>600 )","goff");
	TH1F *shower_pim_hist = (TH1F*)gROOT->FindObject("shower_pim");
        tree_pi0->Draw("ShowerSum>>shower_pi0(200,0,1200)","rate*(ShowerSum>600 )","goff");
	TH1F *shower_pi0_hist = (TH1F*)gROOT->FindObject("shower_pi0");
        tree_eAll->Draw("ShowerSum>>shower_eAll(200,0,1200)","rate*(ShowerSum>600 && GEM00_Edep>35e-6 && GEM10_Edep>35e-6 )","goff");
	TH1F *shower_eAll_hist = (TH1F*)gROOT->FindObject("shower_eAll");
        tree_beam->Draw("ShowerSum>>shower_beam(200,0,1200)","rate*(ShowerSum>600 )","goff");
	TH1F *shower_beam_hist = (TH1F*)gROOT->FindObject("shower_beam");
  ...
  leg8->AddEntry(shower_eAll_hist,Form("eAll*1000; total rate=%f kHz",rate_eAll),"l");
