...
void plot_rate_sangle_newCh(){
	...
	TH1F *ShowerSum_gamma_hist = (TH1F*)gROOT->FindObject("ShSum_gamma");
        tree_e->Draw("Shower_r>>Shr_e(1000,0,1000)","","goff");
	TH1F *ShowerR_e_hist = (TH1F*)gROOT->FindObject("Shr_e");
        tree_gamma->Draw("Shower_r>>Shr_gamma(1000,0,1000)","","goff");
	TH1F *ShowerR_gamma_hist = (TH1F*)gROOT->FindObject("Shr_gamma");
        tree_e->Draw("Shower_l>>Shl_e(1000,0,1000)","","goff");
	TH1F *ShowerL_e_hist = (TH1F*)gROOT->FindObject("Shl_e");
        tree_gamma->Draw("Shower_l>>Shl_gamma(1000,0,1000)","","goff");
	TH1F *ShowerL_gamma_hist = (TH1F*)gROOT->FindObject("Shl_gamma");
        tree_e->Draw("Shower_t>>Sht_e(1000,0,1000)","","goff");
	TH1F *ShowerT_e_hist = (TH1F*)gROOT->FindObject("Sht_e");
        tree_gamma->Draw("Shower_t>>Sht_gamma(1000,0,1000)","","goff");
  ...
  leg8->AddEntry(ShowerSum_e_hist,"5GeV e^{-} in front of Showerower","l");
  leg8->AddEntry(ShowerSum_gamma_hist,"5GeV #gamma in front of Showerower","l");
  ...
  TLegend *leg18 = new TLegend(0.45,0.7,0.8,0.88);
  leg18->AddEntry(PreShL_e_hist,"5GeV e^{-} in front of PreShower","l");
  leg18->AddEntry(PreShL_gamma_hist,"5GeV #gamma in front of PreShower","l");
  ...
  TLegend *leg9 = new TLegend(0.45,0.7,0.8,0.88);
  leg9->AddEntry(PreShSum_e_hist,"5GeV e^{-} in front of PreShower","l");
  leg9->AddEntry(PreShSum_gamma_hist,"5GeV #gamma in front of PreShower","l");
