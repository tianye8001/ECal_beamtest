...
void plot_gem_BeamOnTarget(){
	gStyle->SetOptStat(0);
	gStyle->SetPalette(1);
	TFile *f11 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_vacuum/HallC_beamtest_BeamOnTarget_1e10_8deg_80uA_target_vacuum_output_gem_gammaE_pzcut.root");
	TFile *f1 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_vacuum_floor/HallC_beamtest_BeamOnTarget_1e11_8deg_80uA_target_vacuum_floor_output_gem_gammaE_pzcut.root");
	TFile *f1 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_vacuum_CCvacuum/HallC_beamtest_BeamOnTarget_1e10_8deg_80uA_target_step_right_output_gem_gammaE_pzcut.root");
	...
	TFile *f12 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_vacuum/HallC_beamtest_BeamOnTarget_1e10_8deg_80uA_target_vacuum_output_gem_electronE_pzcut.root");
	TFile *f2 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_vacuum_CCvacuum/HallC_beamtest_BeamOnTarget_1e10_8deg_80uA_target_step_right_output_gem_electronE_pzcut.root");
	TFile *f3 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_vacuum/HallC_beamtest_BeamOnTarget_1e10_8deg_80uA_target_vacuum_output_gem_gammaE_pzcut_vzcut.root");
	TFile *f4 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_vacuum/HallC_beamtest_BeamOnTarget_1e10_8deg_80uA_target_vacuum_output_gem_electronE_pzcut_vzcut.root");
	...
	TFile *f6 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_vacuum_nospd/HallC_beamtest_BeamOnTarget_1e10_8deg_80uA_target_vacuum_nospd_output_gem_electronE_pzcut.root");
	TH1F *hprocid_gem1;       
	TH1F *hpf_gem1;
	TH1F *hE_gem1;
	TH1F *hE_gem1_floor;
	...
	TH1F *hhit_theta_electron_gem1;
        ...
        hE_gem1_floor = (TH1F*)f11->Get("hE_gem1");
        ...
        hE_gem1_1cmAl_floor = (TH1F*)f12->Get("hE_gem1");
...
/*	gPad->SetLogy();
	...
	hE_gem1->Draw("HIST ");
	hE_gem1_floor->SetLineColor(7);
	hE_gem1_floor->Draw("same HIST ");
	hE_gem1_1cmAl->SetLineColor(4);
	hE_gem1_1cmAl->Draw("same HIST");
	hE_gem1_1cmAl_floor->SetLineColor(8);
	hE_gem1_1cmAl_floor->Draw("same HIST");
...
//	hE_gem1_1inpoly->Draw("same HIST");
	...
	leg11->AddEntry(hE_gem1_floor,"#gamma hit on gem1 detector on floor","l");
	leg11->AddEntry(hE_gem1_cut,"#gamma from target hit on gem1","l");
	leg11->AddEntry(hE_gem1_1cmAl,"e^{-} hit on gem1","l");
	leg11->AddEntry(hE_gem1_1cmAl_floor,"e^{-} hit on gem1 detector on floor","l");
...
/*	hhit_Egem1_other->SetLineColor(6);
	...
	TLegend *leg1 = new TLegend(0.12,0.7,0.42,0.85);
...
//	leg1->AddEntry(hhit_Egem1_other,"other","l");
	...
	TLegend *leg121 = new TLegend(0.12,0.4,0.39,0.8);
	...
	TLegend *leg111 = new TLegend(0.4,0.65,0.7,0.85);
	...
	gSystem->Exec("pdfunite ./c*.pdf ./HallC_BeamOnTarget_8deg_gem1_gamma_vacuum.pdf");
