...
void plot_rate_Cer_newCh_7deg(){
	...
	TFile *f3 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_eAll_18deg_LD2_20m_30x30x2.5cm3_poly_beamline/HallC_beamtest_eAll_LD2_18deg_filenum9991_9.991e8_10.6GeV_shielding_30x30x2.5cm3_poly_beamline_reduce_tree_rate_gem1_Etotalcut_40uA_Q210MeV.root");
	TFile *f4 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pi0_18deg_LD_21m_30degcut_poly/HallC_beamtest_bggen_LH2_pi0_18deg_LD_21m_30degcut_poly_filenum5290_reduce_tree_rate_gem1_Etotalcut_40uA_Q210MeV.root");
	...
	TFile *f18 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pim_18deg_LD_21m_30degcut_poly/HallC_beamtest_bggen_LH2_pim_18deg_LD_21m_30degcut_poly_filenum7660_reduce_tree_rate_gem1_Etotalcut_40uA_Q210MeV.root");
...
//LASPD
	...
	TH1F *preshower_beam_gamma_hist = (TH1F*)gROOT->FindObject("preshower_beam_gamma");
        ...
        tree_SC1_e->Draw("ShowerSum>>shower_e(1000,0,1000)","rate*(ShowerSum>0 )","goff");
	TH1F *shower_e_hist = (TH1F*)gROOT->FindObject("shower_e");
        tree_SC1_electron->Draw("ShowerSum>>shower_electron(1000,0,1000)","rate*(ShowerSum>0)","goff");
	TH1F *shower_electron_hist = (TH1F*)gROOT->FindObject("shower_electron");
        tree_SC1_gamma->Draw("ShowerSum>>shower_gamma(1000,0,1000)","rate*(ShowerSum>0)","goff");
	TH1F *shower_gamma_hist = (TH1F*)gROOT->FindObject("shower_gamma");
        tree_beam->Draw("ShowerSum>>shower_beam(1000,0,1000)","rate*(ShowerSum>0)","goff");
	TH1F *shower_beam_hist = (TH1F*)gROOT->FindObject("shower_beam");
        tree_beam_gamma->Draw("ShowerSum>>shower_beam_gamma(1000,0,1000)","rate*(ShowerSum>0)","goff");
	TH1F *shower_beam_gamma_hist = (TH1F*)gROOT->FindObject("shower_beam_gamma");
        tree_beam_eAll->Draw("ShowerSum>>shower_beam_eall(1000,0,1000)","rate*(ShowerSum>0)","goff");
  ...
  leg91->Draw("text same");
	...
	gSystem->Exec("pdfunite ./c*.pdf ./HallC_comparison_Edep_rate_18deg_21m_40uA_TS4cut2.pdf");
