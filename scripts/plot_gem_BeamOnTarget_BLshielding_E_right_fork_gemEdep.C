...
void plot_gem_BeamOnTarget_BLshielding_E_right_fork_debug_gemEdep(){
	gStyle->SetOptStat(0);
	gStyle->SetPalette(1);
...
//	TFile *f14 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_BLshielding_GEM4cmAl/HallC_beamtest_BeamOnTarget_3.85e8_8deg_80uA_target_right_step_BLshielding2x4x190_4cmAl_output_gem_electronE_pzcut.root");
	...
	TFile *f7 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_15deg/HallC_beamtest_BeamOnTarget_9.725e8_8deg_80uA_target_step_right_15deg_output_gem_gammaE_pzcut.root");
	...
	TFile *f17 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_15deg/HallC_beamtest_BeamOnTarget_9.725e8_8deg_80uA_target_step_right_15deg_output_gem_electronE_pzcut.root");
...
//	TFile *f7 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_vacuum_CCvacuum/HallC_beamtest_BeamOnTarget_1e10_8deg_80uA_target_step_right_output_gem_gammaE_pzcut.root");
	TFile *f4 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_20deg/HallC_beamtest_BeamOnTarget_8.485e8_8deg_80uA_target_step_right_20deg_output_gem_gammaE_pzcut.root");
	...
	TFile *f14 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_20deg/HallC_beamtest_BeamOnTarget_8.485e8_8deg_80uA_target_step_right_20deg_output_gem_electronE_pzcut.root");
	...
	TH1F *hhit_Edepgem1_compton_35cm;
        ...
        hhit_Edepgem1_electron_noTB = (TH1F*)f9->Get("hit_Edepgem1");
        hhit_Edepgem12_electron_noTB = (TH1F*)f9->Get("hit_Edepgem12");
        hhit_Edepgem12_electron = (TH1F*)f1->Get("hit_Egem12");
        hhit_Edepgem12_electron_test = (TH1F*)f1->Get("hit_Egem12_test");
        hhit_Edepgem1_electron_noB = (TH1F*)f10->Get("hit_Edepgem1");
        ...
        hhit_Edepgem1_electron_1cmAl = (TH1F*)f2->Get("hit_Edepgem1");
        hhit_Edepgem1_electron_1inpoly = (TH1F*)f3->Get("hit_Edepgem1");
        hhit_Edepgem1_electron_35cm = (TH1F*)f5->Get("hit_Edepgem1");
        hhit_Edepgem1_electron_25cm = (TH1F*)f4->Get("hit_Edepgem1");
        hhit_Edepgem1_electron_45cm = (TH1F*)f6->Get("hit_Edepgem1");
        hhit_Edepgem1_electron_55cm = (TH1F*)f7->Get("hit_Edepgem1");
        ...
        hhit_Edepgem1_gamma_noTB = (TH1F*)f19->Get("hit_Edepgem1");
        hhit_Edepgem1_gamma_noB = (TH1F*)f110->Get("hit_Edepgem1");
        ...
        hhit_Edepgem1_gamma_1cmAl = (TH1F*)f12->Get("hit_Edepgem1");
        hhit_Edepgem1_gamma_1inpoly = (TH1F*)f13->Get("hit_Edepgem1");
        hhit_Edepgem1_gamma_35cm = (TH1F*)f15->Get("hit_Edepgem1");
        hhit_Edepgem1_gamma_45cm = (TH1F*)f16->Get("hit_Edepgem1");
        hhit_Edepgem1_gamma_55cm = (TH1F*)f17->Get("hit_Edepgem1");
        hhit_Edepgem1_gamma_25cm = (TH1F*)f14->Get("hit_Edepgem1");
        hhit_Edepgem1_gamma_15deg = (TH1F*)f40->Get("hit_Edepgem1");
        hhit_Edepgem1_gamma_20degv = (TH1F*)f41->Get("hit_Edepgem1");
        hhit_Edepgem2_gamma_15deg = (TH1F*)f40->Get("hit_Edepgem2");
        hhit_Edepgem2_gamma_20degv = (TH1F*)f41->Get("hit_Edepgem2");
        ...
        hhit_Edepgem2_electron_noTB = (TH1F*)f9->Get("hit_Edepgem2");
        hhit_Edepgem2_electron_noB = (TH1F*)f10->Get("hit_Edepgem2");
        ...
        hhit_Edepgem2_electron_1cmAl = (TH1F*)f2->Get("hit_Edepgem2");
        hhit_Edepgem2_electron_1inpoly = (TH1F*)f3->Get("hit_Edepgem2");
        hhit_Edepgem2_electron_35cm = (TH1F*)f5->Get("hit_Edepgem2");
        hhit_Edepgem2_electron_45cm = (TH1F*)f6->Get("hit_Edepgem2");
        hhit_Edepgem2_electron_25cm = (TH1F*)f4->Get("hit_Edepgem2");
        hhit_Edepgem2_electron_55cm = (TH1F*)f7->Get("hit_Edepgem2");
        ...
        hhit_Edepgem2_gamma_noTB = (TH1F*)f19->Get("hit_Edepgem2");
        hhit_Edepgem2_gamma_noB = (TH1F*)f110->Get("hit_Edepgem2");
        ...
        hhit_Edepgem2_gamma_1cmAl = (TH1F*)f12->Get("hit_Edepgem2");
        hhit_Edepgem2_gamma_1inpoly = (TH1F*)f13->Get("hit_Edepgem2");
        hhit_Edepgem2_gamma_35cm = (TH1F*)f15->Get("hit_Edepgem2");
        hhit_Edepgem2_gamma_45cm = (TH1F*)f16->Get("hit_Edepgem2");
        hhit_Edepgem2_gamma_55cm = (TH1F*)f17->Get("hit_Edepgem2");
        hhit_Edepgem2_gamma_25cm = (TH1F*)f14->Get("hit_Edepgem2");
...
//	leg11->AddEntry(hhit_Edepgem1_electron,"no shielding beamline survey+old simu","l");
	leg11->AddEntry(hhit_Edepgem1_electron_45cm,"no shielding target vacuum","l");
	leg11->AddEntry(hhit_Edepgem1_electron_35cm,"no shielding target vacuum + CC air","l");
	...
	leg11->AddEntry(hhit_Edepgem1_electron_55cm,"Nosh full=target+chamber+beamline step 15deg ","l");
	leg11->AddEntry(hhit_Edepgem1_electron_25cm,"Nosh full=target+chamber+beamline step 20deg","l");
...
//	leg11->AddEntry(hhit_Edepgem1_electron,"no shielding beamline survey+old simu","l");
	leg31->AddEntry(hhit_Edepgem2_electron_45cm,"no shielding target vacuum","l");
	leg31->AddEntry(hhit_Edepgem2_electron_35cm,"no shielding target vacuum + CC air","l");
	...
	leg31->AddEntry(hhit_Edepgem2_electron_55cm,"Nosh full=target+chamber+beamline step 15deg ","l");
	leg31->AddEntry(hhit_Edepgem2_electron_25cm,"Nosh full=target+chamber+beamline step 20deg","l");
...
//	hhit_Edepgem1_gamma_1cmAl->Draw("same HIST");
	...
	hhit_Edepgem1_gamma_15deg->SetLineColor(kOrange-3);
	...
	TLegend *leg111 = new TLegend(0.12,0.12,0.58,0.4);
//	leg111->AddEntry(hhit_Edepgem1_electron,"no shielding beamline survey+old simu","l");
	leg111->AddEntry(hhit_Edepgem1_gamma_45cm,Form("no shielding target vacuum rate %f kHz",rate_Edepgem1_gamma_45cm),"l");
...
//	leg111->AddEntry(hhit_Edepgem1_gamma_1cmAl,"2x4x190 in^{3} Pb shielding full ","l");
	leg111->AddEntry(hhit_Edepgem1_gamma_55cm,Form("Nosh full=target+chamber+beamline step 15deg rate %f kHz",rate_Edepgem1_gamma_55cm),"l");
	leg111->AddEntry(hhit_Edepgem1_gamma_25cm,Form("Nosh full=target+chamber+beamline step 20deg rate %f kHz",rate_Edepgem1_gamma_25cm),"l");
	leg111->AddEntry(hhit_Edepgem1_gamma_15deg,Form("Nosh target vacuum #theta=15deg rate %f kHz",rate_Edepgem1_gamma_15deg),"l");
...
//	hhit_Edepgem2_gamma->Draw("HIST");
	...
	hhit_Edepgem2_gamma_15deg->SetLineColor(kOrange-3);
        hhit_Edepgem2_gamma_15deg->Scale(0.001);
	hhit_Edepgem2_gamma_15deg->Draw("same HIST");
	hhit_Edepgem2_gamma_20degv->SetLineColor(9);
        hhit_Edepgem2_gamma_20degv->Scale(0.001);
	hhit_Edepgem2_gamma_20degv->Draw("same HIST");
	TLegend *leg41 = new TLegend(0.22,0.12,0.58,0.38);
//	leg111->AddEntry(hhit_Edepgem1_electron,"no shielding beamline survey+old simu","l");
	leg41->AddEntry(hhit_Edepgem2_gamma_45cm,"no shielding target vacuum","l");
	leg41->AddEntry(hhit_Edepgem2_gamma_35cm,"no shielding target vacuum + CC air","l");
	...
	leg41->AddEntry(hhit_Edepgem2_gamma_55cm,"NoSh full=target+chamber+beamline step 15deg ","l");
	leg41->AddEntry(hhit_Edepgem2_gamma_25cm,"Nosh full=target+chamber+beamline step 20deg","l");
	leg41->AddEntry(hhit_Edepgem2_gamma_15deg,"Nosh target vacuum #theta=15deg","l");
	leg41->AddEntry(hhit_Edepgem2_gamma_20degv,"Nosh target vacuum #theta=20deg rate","l");
	...
	gSystem->Exec("pdfunite ./c*.pdf ./HallC_BeamOnTarget_8deg_BLshielding_comparision.pdf");
