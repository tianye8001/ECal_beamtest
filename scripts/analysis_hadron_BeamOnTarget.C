...
int analysis_hadron_BeamOnTarget(string inputfile_name,string runmode="trigger", bool Is_tellorig=false,string filetype="",bool Is_new=true){
	...
	sprintf(outputfile_name, "%s_output_Nphe_target.root",the_filename);
	...
	//	TH2F *vertexZ_vs_E_hist=new TH2F("vertexZ_vs_E_hist","vertex;z (cm);E (MeV)",2080,-40,1000,500,0,500);	

	const int n=10;
	string detname[n]={"sc0","sc1","ec_front","ec_back","gem1","gem2","cc_win","FASPD","LASPD"};
	TH1F *hhit_vz[n], *hhit_z[n],*hhit_vz_cut[n],*hhit_z_cut[n];
	TH2F *hhit_vR_vs_vz[n],*hhit_R_vs_z[n],*hhit_PhiR[n],*hhit_vR_vs_vz_cut[n],*hhit_R_vs_z_cut[n],*gen_theta_vs_p_cut[n];
	TH1F *hhit_E[n],*hhit_E_mip[n],*hhit_E_photonele[n],*hhit_E_ele[n],*hhit_Edep[n],*hhit_p[n],*hhit_Ek[n],*hhit_Ec[n],*hhit_E_cut[n],*hhit_p_cut[n], *hhit_Ek_cut[n],*gen_theta_cut[n],*gen_p_cut[n], *hhit_pid[n], *hhit_mpid[n], *hhit_procID[n];		  	
	TH1F *hhit_vz_cutr[n],*hhit_z_cutr[n],*hhit_vz_cute[n],*hhit_z_cute[n],*hhit_E_cutr[n],*hhit_p_cutr[n], *hhit_Ek_cutr[n],*gen_theta_cutr[n],*gen_p_cutr[n],*hhit_E_cute[n],*hhit_p_cute[n], *hhit_Ek_cute[n],*gen_theta_cute[n],*gen_p_cute[n],*hhit_t_cutgamma[n],*hhit_t_gamma[n],*hhit_t_cute[n],*hhit_t_cut[n];
	TH2F *hhit_vR_vs_vz_cutr[n],*hhit_R_vs_z_cutr[n],*hhit_vR_vs_vz_cute[n],*hhit_R_vs_z_cute[n],*gen_theta_vs_p_cutr[n],*gen_theta_vs_p_cute[n],*vertexZ_vs_E_hist[n],*vertexZ_vs_E_cut_hist[n],*vertexZ_vs_p_cute_hist[n],*vertexZ_vs_p_cutr_hist[n]; 
	for(int i=0;i<n;i++){
		char hstname[100];
		sprintf(hstname,"hit_vz_%i",i);
		hhit_vz[i]=new TH1F(hstname,detname[i].c_str(),1300,-100,1200);  
		sprintf(hstname,"hit_z_%i",i);
		hhit_z[i]=new TH1F(hstname,detname[i].c_str(),1300,-100,1200);  
		sprintf(hstname,"hit_R_vs_vz_%i",i);
		hhit_vR_vs_vz[i]=new TH2F(hstname,detname[i].c_str(),1300,-100,1200,1000,0,1000);        
		sprintf(hstname,"hit_R_vs_z_%i",i);
		hhit_R_vs_z[i]=new TH2F(hstname,detname[i].c_str(),1100,-20,1080,1000,0,1000);        
		...
		hhit_Edep[i]=new TH1F(hstname,detname[i].c_str(),1100,0,11);	  
		sprintf(hstname,"hit_momentum_%i",i);
		hhit_p[i]=new TH1F(hstname,detname[i].c_str(),1100,0,11);
		sprintf(hstname,"hit_Ek_%i",i);
		hhit_Ek[i]=new TH1F(hstname,detname[i].c_str(),1100,0,11);
		sprintf(hstname,"hit_Ec_%i",i);
		hhit_Ec[i]=new TH1F(hstname,detname[i].c_str(),1100,0,11);
		sprintf(hstname,"hit_momentum_cut_%i",i);
		hhit_p_cut[i]=new TH1F(hstname,detname[i].c_str(),1100,0,11);
		sprintf(hstname,"hit_E_cut_%i",i);
		hhit_E_cut[i]=new TH1F(hstname,detname[i].c_str(),1100,0,11);
		sprintf(hstname,"hit_Ek_cut_%i",i);
		hhit_Ek_cut[i]=new TH1F(hstname,detname[i].c_str(),1100,0,11);
		sprintf(hstname,"hit_vz_cut_%i",i);
		hhit_vz_cut[i]=new TH1F(hstname,detname[i].c_str(),1300,-100,1200);  
		sprintf(hstname,"hit_z_cut_%i",i);
		hhit_z_cut[i]=new TH1F(hstname,detname[i].c_str(),1300,-100,1200);  
		sprintf(hstname,"hit_R_vs_vz_cut_%i",i);
		hhit_vR_vs_vz_cut[i]=new TH2F(hstname,detname[i].c_str(),1300,-100,1200,1000,0,1000);        
		sprintf(hstname,"hit_R_vs_z_cut_%i",i);
		hhit_R_vs_z_cut[i]=new TH2F(hstname,detname[i].c_str(),1100,-20,1080,1000,0,1000);        
		sprintf(hstname,"gen_theta_vs_p_cut_%i",i);
		gen_theta_vs_p_cut[i]=new TH2F(hstname,detname[i].c_str(),180,0,90,110,0,11);        
		sprintf(hstname,"gen_theta_cut_%i",i);
		gen_theta_cut[i]=new TH1F(hstname,detname[i].c_str(),180,0,90);        
		sprintf(hstname,"gen_p_cut_%i",i);
		gen_p_cut[i]=new TH1F(hstname,detname[i].c_str(),1100,0,11);        
		sprintf(hstname,"hit_pid_%i",i);
		hhit_pid[i]=new TH1F(hstname,detname[i].c_str(),6000,-2999.5,3000.5);
		sprintf(hstname,"hit_mpid_%i",i);
		hhit_mpid[i]=new TH1F(hstname,detname[i].c_str(),6000,-2999.5,3000.5);
		sprintf(hstname,"hit_procID_%i",i);
		hhit_procID[i]=new TH1F(hstname,detname[i].c_str(),101,-0.5,100.5);
		sprintf(hstname,"hit_momentum_cutr_%i",i);
		hhit_p_cutr[i]=new TH1F(hstname,detname[i].c_str(),1100,0,11);
		sprintf(hstname,"hit_E_cutr_%i",i);
		hhit_E_cutr[i]=new TH1F(hstname,detname[i].c_str(),1100,0,11);
		sprintf(hstname,"hit_Ek_cutr_%i",i);
		hhit_Ek_cutr[i]=new TH1F(hstname,detname[i].c_str(),1100,0,11);
		sprintf(hstname,"hit_vz_cutr_%i",i);
		hhit_vz_cutr[i]=new TH1F(hstname,detname[i].c_str(),1300,-100,1200);  
		sprintf(hstname,"hit_z_cutr_%i",i);
		hhit_z_cutr[i]=new TH1F(hstname,detname[i].c_str(),1300,-100,1200);  
		sprintf(hstname,"hit_R_vs_vz_cutr_%i",i);
		hhit_vR_vs_vz_cutr[i]=new TH2F(hstname,detname[i].c_str(),1300,-100,1200,1000,0,1000);        
		sprintf(hstname,"hit_R_vs_z_cutr_%i",i);
		hhit_R_vs_z_cutr[i]=new TH2F(hstname,detname[i].c_str(),1100,-20,1080,1000,0,1000);        
		sprintf(hstname,"gen_theta_vs_p_cutr_%i",i);
		gen_theta_vs_p_cutr[i]=new TH2F(hstname,detname[i].c_str(),180,0,90,110,0,11);        
		sprintf(hstname,"gen_theta_cutr_%i",i);
		gen_theta_cutr[i]=new TH1F(hstname,detname[i].c_str(),180,0,90);        
		sprintf(hstname,"gen_p_cutr_%i",i);
		gen_p_cutr[i]=new TH1F(hstname,detname[i].c_str(),1100,0,11);        
		sprintf(hstname,"hit_momentum_cute_%i",i);
		hhit_p_cute[i]=new TH1F(hstname,detname[i].c_str(),1100,0,11);
		sprintf(hstname,"hit_E_cute_%i",i);
		hhit_E_cute[i]=new TH1F(hstname,detname[i].c_str(),1100,0,11);
		sprintf(hstname,"hit_Ek_cute_%i",i);
		hhit_Ek_cute[i]=new TH1F(hstname,detname[i].c_str(),1100,0,11);
		sprintf(hstname,"hit_vz_cute_%i",i);
		hhit_vz_cute[i]=new TH1F(hstname,detname[i].c_str(),1300,-100,1200);  
		sprintf(hstname,"hit_z_cute_%i",i);
		hhit_z_cute[i]=new TH1F(hstname,detname[i].c_str(),1300,-100,1200);  
		sprintf(hstname,"hit_R_vs_vz_cute_%i",i);
		hhit_vR_vs_vz_cute[i]=new TH2F(hstname,detname[i].c_str(),1300,-100,1200,1000,0,1000);        
		sprintf(hstname,"hit_R_vs_z_cute_%i",i);
		hhit_R_vs_z_cute[i]=new TH2F(hstname,detname[i].c_str(),1100,-20,1080,1000,0,1000);        
		sprintf(hstname,"gen_theta_vs_p_cute_%i",i);
		gen_theta_vs_p_cute[i]=new TH2F(hstname,detname[i].c_str(),180,0,90,110,0,11);        
		sprintf(hstname,"gen_theta_cute_%i",i);
		gen_theta_cute[i]=new TH1F(hstname,detname[i].c_str(),180,0,90);        
		sprintf(hstname,"gen_p_cute_%i",i);
		gen_p_cute[i]=new TH1F(hstname,detname[i].c_str(),1100,0,11);        
		sprintf(hstname,"hit_t_cutgamma_%i",i);
		hhit_t_cutgamma[i]=new TH1F(hstname,detname[i].c_str(),110000,27,38);
		sprintf(hstname,"hit_t_cute_%i",i);
		hhit_t_cute[i]=new TH1F(hstname,detname[i].c_str(),110000,27,38);
		sprintf(hstname,"hit_t_gamma_%i",i);
		hhit_t_gamma[i]=new TH1F(hstname,detname[i].c_str(),2000,0,200);
		sprintf(hstname,"hit_t_cut_%i",i);
		hhit_t_cut[i]=new TH1F(hstname,detname[i].c_str(),110000,27,38);
		sprintf(hstname,"hit_E_vs_vz_%i",i);
		vertexZ_vs_E_hist[i]=new TH2F(hstname,detname[i].c_str(),1100,0,11,4100,-50,2000);        
		sprintf(hstname,"hit_E_vs_vz_cut_%i",i);
		vertexZ_vs_E_cut_hist[i]=new TH2F(hstname,detname[i].c_str(),1100,0,11,4100,-50,2000);        
		sprintf(hstname,"hit_p_vs_vz_cute_%i",i);
		vertexZ_vs_p_cute_hist[i]=new TH2F(hstname,detname[i].c_str(),1300,-100,1200,1100,0,11);        
		sprintf(hstname,"hit_p_vs_vz_cutr_%i",i);
		vertexZ_vs_p_cutr_hist[i]=new TH2F(hstname,detname[i].c_str(),1300,-100,1200,1100,0,11);        
	}

	TH1F *hhit_Edepsc1=new TH1F("hit_Edepsc1","SC1;Edep (GeV);rate(Hz)",400,0,200);
	TH1F *hhit_Edepsc2=new TH1F("hit_Edepsc2","SC2;Edep (GeV);rate(Hz)",400,0,200);
	TH1F *hhit_Edepspd1=new TH1F("hit_Edepspd1","SPD1;Edep (GeV);rate(Hz)",200,0,100);
	TH1F *hhit_Edepspd2=new TH1F("hit_Edepspd2","SPD2;Edep (GeV);rate(Hz)",200,0,100);
	TH1F *hhit_Edepspd1_trigger=new TH1F("hit_Edepspd1_trigger","SPD1;Edep (GeV);rate(Hz)",200,0,100);
	TH1F *hhit_Edepspd2_trigger=new TH1F("hit_Edepspd2_trigger","SPD2;Edep (GeV);rate(Hz)",200,0,100);
	TH1F *hhit_Edepsc1_trigger=new TH1F("hit_Edepsc1_trigger","SC1;Edep (GeV);rate(Hz)",400,0,200);
	TH1F *hhit_Edepsc2_trigger=new TH1F("hit_Edepsc2_trigger","SC2;Edep (GeV);rate(Hz)",400,0,200);
	...
	TH1F *hhit_Edepspd1_trigger1=new TH1F("hit_Edepspd1_trigger1","SPD1;Edep (GeV);rate(Hz)",200,0,100);
	TH1F *hhit_Edepspd2_trigger1=new TH1F("hit_Edepspd2_trigger1","SPD2;Edep (GeV);rate(Hz)",200,0,100);
	TH1F *hhit_Edepsc1_trigger1=new TH1F("hit_Edepsc1_trigger1","SC1;Edep (GeV);rate(Hz)",400,0,200);
	TH1F *hhit_Edepsc2_trigger1=new TH1F("hit_Edepsc2_trigger1","SC2;Edep (GeV);rate(Hz)",400,0,200);
	TH1F *hhit_Edepspd1_trigger2=new TH1F("hit_Edepspd1_trigger2","SPD1;Edep (GeV);rate(Hz)",200,0,100);
	TH1F *hhit_Edepspd2_trigger2=new TH1F("hit_Edepspd2_trigger2","SPD2;Edep (GeV);rate(Hz)",200,0,100);
	TH1F *hhit_Edepsc1_trigger2=new TH1F("hit_Edepsc1_trigger2","SC1;Edep (GeV);rate(Hz)",400,0,200);
	TH1F *hhit_Edepsc2_trigger2=new TH1F("hit_Edepsc2_trigger2","SC2;Edep (GeV);rate(Hz)",400,0,200);
	TH1F *hhit_Edepspd1_trigger3=new TH1F("hit_Edepspd1_trigger3","SPD1;Edep (GeV);rate(Hz)",200,0,100);
	TH1F *hhit_Edepspd2_trigger3=new TH1F("hit_Edepspd2_trigger3","SPD2;Edep (GeV);rate(Hz)",200,0,100);
	TH1F *hhit_Edepsc1_trigger3=new TH1F("hit_Edepsc1_trigger3","SC1;Edep (GeV);rate(Hz)",400,0,200);
	TH1F *hhit_Edepsc2_trigger3=new TH1F("hit_Edepsc2_trigger3","SC2;Edep (GeV);rate(Hz)",400,0,200);
	...
	TH2F *hec_Eend_2D=new TH2F("ec_Eend_2D","EC;Eend_shower;Eend_preshower",200,0,500,200,0,100);
	TH1F *hec_Eend_shower=new TH1F("ec_Eend_shower","EC;Eend [MeV]",400,0,200);
	TH1F *hec_Eend_preshower=new TH1F("ec_Eend_preshower","EC;Eend_preshower [MeV]",200,0,100);
	TH1F *hec_Eend_shower_e=new TH1F("ec_Eend_shower_e","EC electron;Eend [MeV]",400,0,200);
	TH1F *hec_Eend_preshower_e=new TH1F("ec_Eend_preshower_e","EC electron;Eend_preshower [MeV]",200,0,100);
	TH1F *hec_Eend_shower_ep=new TH1F("ec_Eend_shower_ep","EC positron;Eend [MeV]",400,0,200);
	TH1F *hec_Eend_preshower_ep=new TH1F("ec_Eend_preshower_ep","EC positron;Eend_preshower [MeV]",200,0,100);
	TH1F *hec_Eend_shower_r=new TH1F("ec_Eend_shower_r","EC gamma;Eend [MeV]",400,0,200);
	TH1F *hec_Eend_preshower_r=new TH1F("ec_Eend_preshower_r","EC gamma;Eend_preshower [MeV]",200,0,100);

	TH1F *hec_Eend_shower_e_proc=new TH1F("ec_Eend_shower_e_proc","EC electron;procID",131,-0.5,130.5);
	TH1F *hec_Eend_preshower_e_proc=new TH1F("ec_Eend_preshower_e_proc","EC electron;procID",131,-0.5,130.5);
	TH1F *hec_Eend_shower_ep_proc=new TH1F("ec_Eend_shower_ep_proc","EC positron;procID",131,-0.5,130.5);
	TH1F *hec_Eend_preshower_ep_proc=new TH1F("ec_Eend_preshower_ep_proc","EC positron;procID",131,-0.5,130.5);
	TH1F *hec_Eend_shower_r_proc=new TH1F("ec_Eend_shower_r_proc","EC gamma;procID",131,-0.5,130.5);
	TH1F *hec_Eend_preshower_r_proc=new TH1F("ec_Eend_preshower_r_proc","EC gamma;procID",131,-0.5,130.5);

	TH2F *hec_Eend_2D_trigger=new TH2F("ec_Eend_2D_trigger","EC;Eend_shower;procID",200,0,500,200,0,100);
	TH1F *hec_Eend_shower_trigger=new TH1F("ec_Eend_shower_trigger","EC;Eend [MeV]",400,0,200);
	TH1F *hec_Eend_preshower_trigger=new TH1F("ec_Eend_preshower_trigger","EC;Eend_preshower [MeV]",200,0,100);
	TH1F *hec_Eend_shower_trigger1=new TH1F("ec_Eend_shower_trigger1","EC;Eend [MeV]",400,0,200);
	TH1F *hec_Eend_preshower_trigger1=new TH1F("ec_Eend_preshower_trigger1","EC;Eend_preshower [MeV]",200,0,100);
	TH1F *hec_Eend_shower_trigger2=new TH1F("ec_Eend_shower_trigger2","EC;Eend [MeV]",400,0,200);
	TH1F *hec_Eend_preshower_trigger2=new TH1F("ec_Eend_preshower_trigger2","EC;Eend_preshower [MeV]",200,0,100);
	TH1F *hec_Eend_shower_trigger3=new TH1F("ec_Eend_shower_trigger3","EC;Eend [MeV]",400,0,200);
	TH1F *hec_Eend_preshower_trigger3=new TH1F("ec_Eend_preshower_trigger3","EC;Eend_preshower [MeV]",200,0,100);
	//-------------------------
...
/*	if (Is_new){
	...
	double vr_max=0,vz_max=0,p_max=0,z_max=0,r_max=0;
        int id_max=-1;
        int pid_max=-1;
	double Ek=0;
	double Ec=0;
	int trigger_sc=0;
	int trigger_Tshower=0;
	int hit_id=-1;
	int hit_showerN=0;
	...
	for(long int i=0;i<N_events;i++){	  		
		...
		for (Int_t j=0;j<flux_hitn->size();j++) {
			...
			//if (flux_tid->at(j)==1 && hit_id==2) {//cout << flux_id->at(j) << " " << flux_avg_z->at(j) << endl;
			//		Fillecal=kTRUE;
			if(hit_id==2){
				hit_preshowerN ++;
			}else hit_preshowerN=hit_preshowerN;
			/*            if(hit_id==1 && flux_avg_t->at(j)>35 && flux_avg_t->at(j)<36){
				      cout<<"flux_event="<<i<<"flux_index="<<j<<"  "<<"hit_pid="<<flux_pid->at(j)<<"hit_mpid="<<flux_mpid->at(j)<<"time="<<flux_avg_t->at(j)<<endl; 
				      }*/
			hhit_vR_vs_vz[hit_id]->Fill(hit_vz,hit_vr,rate);
			hhit_R_vs_z[hit_id]->Fill(hit_z,hit_r,rate);
			hhit_vz[hit_id]->Fill(hit_vz,rate);
			hhit_z[hit_id]->Fill(hit_z,rate);
			hhit_pid[hit_id]->Fill(flux_pid->at(j),rate);
			hhit_mpid[hit_id]->Fill(flux_mpid->at(j),rate);
			hhit_procID[hit_id]->Fill(flux_procID->at(j),rate);
			hhit_t_gamma[hit_id]->Fill(flux_avg_t->at(j),rate);
			double E=flux_trackE->at(j)/1e3,Edep=flux_totEdep->at(j)/1e3;		  
			hhit_Edep[hit_id]->Fill(Edep,rate);		  
			hhit_E[hit_id]->Fill(E,rate);
			hhit_p[hit_id]->Fill(hit_p,rate);
			vertexZ_vs_E_hist[hit_id]->Fill(E,hit_vz,rate);
		//	hhit_Ek[hit_id]->Fill(Ek,rate);
		//	hhit_Ec[hit_id]->Fill(Ec,rate);
			//double Ek=E-Mp;
			//double Ec=sqrt(hit_p*hit_p+Mp*Mp);
			//if(BOT==1 ){
                           if(/*abs(hit_vz)<0.5 &&*/ E>2){
                              cout<<"event="<<i<<"  flux="<<j<<" z="<<hit_vz<<"edep_6p1_max="<<edep_6p1_max<<"E="<<E<<"pid="<<flux_pid->at(j)<<endl;
                           }
			  if (E >= edep_6p1_max ){
			        edep_6p1_max=E;
				p_max=hit_p;
                               ...
                               //cout<<"event="<<i<<"  flux="<<j<<"  id_max="<<id_max<<"edep_6p1_max="<<edep_6p1_max<<"E="<<E<<"pid="<<flux_pid->at(j)<<endl;
                           }
			/*	hhit_vR_vs_vz_cut[hit_id]->Fill(vz_max,vr_max,rate);
				hhit_vz_cut[hit_id]->Fill(vz_max,rate);
				hhit_z_cut[hit_id]->Fill(z_max,rate);
				hhit_R_vs_z_cut[hit_id]->Fill(z_max,r_max,rate);
				hhit_E_cut[hit_id]->Fill(edep_6p1_max,rate);
				hhit_p_cut[hit_id]->Fill(p_max,rate);
				vertexZ_vs_p_cut_hist[hit_id]->Fill(vz_max,p_max,rate);*/
			//}
                               //cout<<"no a beam on target file"<<endl;
				if(pid_gen!=111){ 
					Ek=E-Mp;
					Ec=sqrt(hit_p*hit_p+Mp*Mp);
					if (flux_tid->at(j) ==1 ){
						hhit_vR_vs_vz_cut[hit_id]->Fill(hit_vz,hit_vr,rate);
						hhit_vz_cut[hit_id]->Fill(hit_vz,rate);
						hhit_z_cut[hit_id]->Fill(hit_z,rate);
						hhit_R_vs_z_cut[hit_id]->Fill(hit_z,hit_r,rate);
						hhit_E_cut[hit_id]->Fill(E,rate);
						hhit_p_cut[hit_id]->Fill(hit_p,rate);
						hhit_Ek_cut[hit_id]->Fill(Ec,rate);
						gen_theta_cut[hit_id]->Fill(theta_gen,rate);
						gen_p_cut[hit_id]->Fill(p_gen/1e3,rate);
						gen_theta_vs_p_cut[hit_id]->Fill(theta_gen,p_gen/1e3);
						hhit_t_cutgamma[hit_id]->Fill(flux_avg_t->at(j),rate);
						vertexZ_vs_E_cut_hist[hit_id]->Fill(E,hit_vz,rate);
						//cout<<"event="<<i<<"flux_j="<<j<<"hit_id="<<hit_id<<"PID="<<flux_pid->at(j)<<"tid="<<flux_tid->at(j)<<"hit_p="<<hit_p<<endl;
					}else if(abs(flux_pid->at(j)) ==11){
						gen_theta_vs_p_cute[hit_id]->Fill(theta_gen,p_gen/1e3);
					}
				}else {
					if (abs(flux_pid->at(j))==11 && flux_mpid->at(j)==22 ){
						Ek=E-0.000511;
						Ec=sqrt(hit_p*hit_p+0.000511*0.000511);
						hhit_vR_vs_vz_cute[hit_id]->Fill(hit_vz,hit_vr,rate);
						hhit_vz_cute[hit_id]->Fill(hit_vz,rate);
						hhit_z_cute[hit_id]->Fill(hit_z,rate);
						hhit_R_vs_z_cute[hit_id]->Fill(hit_z,hit_r,rate);
						hhit_E_cute[hit_id]->Fill(E,rate);
						hhit_p_cute[hit_id]->Fill(hit_p,rate);
						hhit_Ek_cute[hit_id]->Fill(Ec,rate);
						gen_theta_cute[hit_id]->Fill(theta_gen,rate);
						gen_p_cute[hit_id]->Fill(p_gen/1e3,rate);
						gen_theta_vs_p_cute[hit_id]->Fill(theta_gen,p_gen/1e3);
						vertexZ_vs_p_cute_hist[hit_id]->Fill(hit_vz,hit_p,rate);
						hhit_t_cute[hit_id]->Fill(flux_avg_t->at(j),rate);
					}
					if (abs(flux_pid->at(j)) ==11 ){
						...
						gen_p_cut[hit_id]->Fill(p_gen/1e3,rate);
						gen_theta_vs_p_cut[hit_id]->Fill(theta_gen,p_gen/1e3);
						hhit_t_cut[hit_id]->Fill(flux_avg_t->at(j),rate);
						vertexZ_vs_E_cut_hist[hit_id]->Fill(E,hit_vz,rate);
						//cout<<"event="<<i<<"flux_j="<<j<<"hit_id="<<hit_id<<"PID="<<flux_pid->at(j)<<"tid="<<flux_tid->at(j)<<"hit_p="<<hit_p<<"mPID="<<flux_mpid->at(j)<<endl;
					}
					if (flux_pid->at(j) ==22 && flux_mpid->at(j)==111 && flux_mtid->at(j)==1 ){
						Ek=E;
						Ec=hit_p;
						hhit_vR_vs_vz_cutr[hit_id]->Fill(hit_vz,hit_vr,rate);
						hhit_vz_cutr[hit_id]->Fill(hit_vz,rate);
						hhit_z_cutr[hit_id]->Fill(hit_z,rate);
						hhit_R_vs_z_cutr[hit_id]->Fill(hit_z,hit_r,rate);
						hhit_E_cutr[hit_id]->Fill(E,rate);
						hhit_p_cutr[hit_id]->Fill(hit_p,rate);
						hhit_Ek_cutr[hit_id]->Fill(Ec,rate);
						gen_theta_cutr[hit_id]->Fill(theta_gen,rate);
						gen_p_cutr[hit_id]->Fill(p_gen/1e3,rate);
						gen_theta_vs_p_cutr[hit_id]->Fill(theta_gen,p_gen/1e3);
						hhit_t_cutgamma[hit_id]->Fill(flux_avg_t->at(j),rate);
						vertexZ_vs_p_cutr_hist[hit_id]->Fill(hit_vz,hit_p,rate);
						Fillecal=kTRUE;

					}else {Fillecal=kFALSE;}

				/*hhit_Edep[hit_id]->Fill(Edep,rate);		  
				hhit_E[hit_id]->Fill(E,rate);
				hhit_p[hit_id]->Fill(hit_p,rate);
				vertexZ_vs_p_hist[hit_id]->Fill(hit_vz,hit_p,rate);
				hhit_Ek[hit_id]->Fill(Ek,rate);
				hhit_Ec[hit_id]->Fill(Ec,rate);*/
			...
			if(BOT==1&& abs(vz_max)<0.5){
				hhit_vR_vs_vz_cut[id_max]->Fill(vz_max,vr_max,rate);
				hhit_vz_cut[id_max]->Fill(vz_max,rate);
				hhit_z_cut[id_max]->Fill(z_max,rate);
				hhit_R_vs_z_cut[id_max]->Fill(z_max,r_max,rate);
				hhit_E_cut[id_max]->Fill(edep_6p1_max,rate);
				hhit_p_cut[id_max]->Fill(p_max,rate);
				vertexZ_vs_E_cut_hist[id_max]->Fill(edep_6p1_max,vz_max,rate);
                          // if(id_max==2){
                          // cout<<"event="<<i<<"vz="<<vz_max<<" " <<"E="<<edep_6p1_max<<"pid="<<pid_max <<endl;
                          // }
                        }
		//fill every events
		...
		//if(ntrigsecs_hgc>0){
		//  cout<<"event="<<i<<"ntrigsecs_hgc="<<ntrigsecs_hgc<<endl;
		// }
		for (Int_t j=0;j<flux_hitn->size();j++) {
			if(flux_id->at(j)==1) {
		...
		if(true){
			...
			for(int sensor_id=0;sensor_id<ch_hgc;sensor_id++){
				...
				double Eend_ec_e=0;
				double Eend_ec_ps_e=0;	
				double Eend_ec_ep=0;
				double Eend_ec_ps_ep=0;	
				double Eend_ec_r=0;
				double Eend_ec_ps_r=0;	
				//if(hit_id>=0){
				//cout<<"event="<<i<<"hit_id="<<hit_id<<"hit_preshowerN="<<hit_preshowerN<<endl;
				// }
				// check EC double peaks 
				if(hit_preshowerN>0){
					for (int j=0;j<solid_ec_ps_hitn->size();j++){
						if(solid_ec_ps_pid->at(j)==11 && solid_ec_ps_mpid->at(j)==22){
							//if(solid_ec_ps_pid->at(j)==11 ){
							Eend_ec_ps_e += solid_ec_ps_totEend->at(j);
							//cout<<"event="<<i<<"  index="<<j<<"  solid_ec_procID="<<solid_ec_ps_procID->at(j)<<"solid_ec_ps_mpid="<<solid_ec_ps_mpid->at(j)<<endl;
							hec_Eend_preshower_e_proc->Fill(solid_ec_ps_procID->at(j));
						}else Eend_ec_ps_e = solid_ec_ps_totEend->at(j);
						if(solid_ec_ps_pid->at(j)==-11 && solid_ec_ps_mpid->at(j)==22){
							//if(solid_ec_ps_pid->at(j)==-11 ){
							hec_Eend_preshower_ep_proc->Fill(solid_ec_ps_procID->at(j));
							//cout<<"event="<<i<<"  index_positron="<<j<<"  solid_ec_procID="<<solid_ec_ps_procID->at(j)<<"solid_ec_ps_mpid="<<solid_ec_ps_mpid->at(j)<<"Edep="<<solid_ec_ps_totEend->at(j)<<endl;
							Eend_ec_ps_ep += solid_ec_ps_totEend->at(j);
						}else Eend_ec_ps_ep = solid_ec_ps_totEend->at(j);
						if(solid_ec_ps_pid->at(j)==22 && solid_ec_ps_mpid->at(j)==111 ){
							//if(solid_ec_ps_pid->at(j)==22  ){
							hec_Eend_preshower_r_proc->Fill(solid_ec_ps_procID->at(j));
							//cout<<"event="<<i<<"  index_gamma="<<j<<"  solid_ec_procID="<<solid_ec_ps_procID->at(j)<<"solid_ec_ps_mpid="<<solid_ec_ps_mpid->at(j)<<"Edep="<<solid_ec_ps_totEend->at(j)<<endl;
							Eend_ec_ps_r += solid_ec_ps_totEend->at(j);
						}else Eend_ec_ps_r = solid_ec_ps_totEend->at(j);
						}
						if(Eend_ec_ps_e>0){
							hec_Eend_preshower_e->Fill(Eend_ec_ps_e,rate);
						}
						if(Eend_ec_ps_ep>0){
							hec_Eend_preshower_ep->Fill(Eend_ec_ps_ep,rate);
						}
						if(Eend_ec_ps_r>0){
							hec_Eend_preshower_r->Fill(Eend_ec_ps_r,rate);
						}
						for (int j=0;j<solid_ec_hitn->size();j++) {
							if(solid_ec_pid->at(j)==11 && solid_ec_mpid->at(j)==22 ){
								//if(solid_ec_pid->at(j)==11  ){
								Eend_ec_e += solid_ec_totEend->at(j);
								hec_Eend_shower_e_proc->Fill(solid_ec_procID->at(j));
							}else Eend_ec_e= solid_ec_totEend->at(j);

							if(solid_ec_pid->at(j)==-11 && solid_ec_mpid->at(j)==22 ){
								//if(solid_ec_pid->at(j)==-11 ){
								Eend_ec_ep += solid_ec_totEend->at(j);
								hec_Eend_shower_ep_proc->Fill(solid_ec_procID->at(j));
							}else Eend_ec_ep = solid_ec_totEend->at(j);
							if(solid_ec_pid->at(j)==22 && solid_ec_mpid->at(j)==111){
								//if(solid_ec_pid->at(j)==22 ){
								hec_Eend_shower_r_proc->Fill(solid_ec_procID->at(j));
								Eend_ec_r += solid_ec_totEend->at(j);
							}else Eend_ec_r = solid_ec_totEend->at(j);
							}
							if(Eend_ec_e>0){
								hec_Eend_shower_e->Fill(Eend_ec_e,rate);
							}
							if(Eend_ec_ep>0){
								hec_Eend_shower_ep->Fill(Eend_ec_ep,rate);
							}
							if(Eend_ec_r>0){
								hec_Eend_shower_r->Fill(Eend_ec_r,rate);
							}
							}//hit_preshowerN>0 cut
							...
							//if(Edep_sc1>0){ 
							//cout <<"event="<<i<<"sc1 and s2 " << Edep_sc1 << "\t" << Edep_sc2  << endl;
							// } 
							if(Edep_sc1>0){
							...
							if(Eend_ec[1]>0 && Eend_ec_ps[1]>0){
								trigger_Tshower=1;
							}else trigger_Tshower=0;
							if(trigger_sc==1 || trigger_Tshower==1){
								hec_Eend_2D_trigger->Fill(Eend_ec_sum,Eend_ec_ps_sum);
								hec_Eend_shower_trigger->Fill(Eend_ec_sum,rate); 
								hec_Eend_preshower_trigger->Fill(Eend_ec_ps_sum,rate);
								hhit_Edepspd1_trigger->Fill(Edep_spd1,rate);
								hhit_Edepspd2_trigger->Fill(Edep_spd2,rate);
								hhit_Edepsc1_trigger->Fill(Edep_sc1,rate);
								hhit_Edepsc2_trigger->Fill(Edep_sc2,rate);
							} 
							if(trigger_sc==1){
								hec_Eend_shower_trigger1->Fill(Eend_ec_sum,rate); 
								hec_Eend_preshower_trigger1->Fill(Eend_ec_ps_sum,rate);
								hhit_Edepspd1_trigger1->Fill(Edep_spd1,rate);
								hhit_Edepspd2_trigger1->Fill(Edep_spd2,rate);
								hhit_Edepsc1_trigger1->Fill(Edep_sc1,rate);
								hhit_Edepsc2_trigger1->Fill(Edep_sc2,rate);
							} 
							if(trigger_Tshower==1){
								hec_Eend_shower_trigger2->Fill(Eend_ec_sum,rate); 
								hec_Eend_preshower_trigger2->Fill(Eend_ec_ps_sum,rate);
								hhit_Edepspd1_trigger2->Fill(Edep_spd1,rate);
								hhit_Edepspd2_trigger2->Fill(Edep_spd2,rate);
								hhit_Edepsc1_trigger2->Fill(Edep_sc1,rate);
								hhit_Edepsc2_trigger2->Fill(Edep_sc2,rate);
							} 
							if(Eend_ec_sum>0 /*&& Eend_ec_ps_sum>0*/){
								hec_Eend_shower_trigger3->Fill(Eend_ec_sum,rate); 
								hec_Eend_preshower_trigger3->Fill(Eend_ec_ps_sum,rate);
								hhit_Edepspd1_trigger3->Fill(Edep_spd1,rate);
								hhit_Edepspd2_trigger3->Fill(Edep_spd2,rate);
								hhit_Edepsc1_trigger3->Fill(Edep_sc1,rate);
								hhit_Edepsc2_trigger3->Fill(Edep_sc2,rate);
							} 
							//	}//end fillcal
						...
						// c2->SaveAs("c2.png");
						// c1->SaveAs("c1.png");
						TCanvas *c_hitec = new TCanvas("c_hitec", "c_hitec",1000,600);
						c_hitec->Divide(3,2);
						c_hitec->cd(1);
						hhit_E[2]->SetLineColor(1);
						hhit_E[2]->Draw("HIST");
						hhit_Ec[2]->SetLineColor(2);
						hhit_Ec[2]->Draw("same HIST");
						c_hitec->cd(2);
						hhit_E[3]->SetLineColor(1);
						hhit_E[3]->Draw("HIST");
						hhit_Ec[3]->SetLineColor(2);
						hhit_Ec[3]->Draw("same HIST");
						c_hitec->cd(3);
						hhit_E[4]->SetLineColor(1);
						hhit_E[4]->Draw("HIST");
						hhit_Ec[4]->SetLineColor(2);
						hhit_Ec[4]->Draw("same HIST");
						c_hitec->cd(4);
						hhit_E[5]->SetLineColor(1);
						hhit_E[5]->Draw("HIST");
						hhit_Ec[5]->SetLineColor(2);
						hhit_Ec[5]->Draw("same HIST");
						c_hitec->cd(5);
						hhit_E[6]->SetLineColor(1);
						hhit_E[6]->Draw("HIST");
						hhit_Ec[6]->SetLineColor(2);
						hhit_Ec[6]->Draw("same HIST");

						/*TCanvas *c_hit_xy_orig = new TCanvas("hit_xy_orig", "hit_xy_orig",1000,600);
						  c_hit_xy_orig->Divide(3,2);
						  c_hit_xy_orig->cd(1);
						...
						hec_Eend_2D_trigger->SetMarkerColor(6);
						hec_Eend_2D_trigger->Draw("same");
						c_EC->cd(2);
						hec_Eend_shower->SetLineColor(1);
						hec_Eend_shower->Draw("HIST");
						hec_Eend_shower_trigger->SetLineColor(2);
						hec_Eend_shower_trigger->Draw("same HIST");
						c_EC->cd(3);
						hec_Eend_preshower->SetLineColor(1);
						hec_Eend_preshower->Draw("HIST");
						hec_Eend_preshower_trigger->SetLineColor(2);
						hec_Eend_preshower_trigger->Draw("same HIST");
						...
						hhit_Edepsc1->Draw("HIST");
						hhit_Edepsc2->SetLineColor(kRed);
						hhit_Edepsc2->Draw("same HIST");
						c_sc->cd(2);
						gPad->SetLogy();
						hhit_Edepspd1->SetLineColor(kBlack);
						hhit_Edepspd1->Draw("HIST");
						hhit_Edepspd2->SetLineColor(kRed);
						hhit_Edepspd2->Draw("same HIST");
