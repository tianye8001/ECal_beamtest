...
void plot_rate_sangle_BLshielding_right_fork(){
	gStyle->SetOptStat(0);
	gStyle->SetPalette(1);
	TFile *f4 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_20deg_r13m_BLshield7feet/HallC_beamtest_BeamOnTarget_5e8_8deg_80uA_sangle_right_fork_20deg_BLshield7feet_r13m_reduce_tree_rate_gem_Etotcut.root");
...
//TFile *f18 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle/HallC_beamtest_BeamOnTarget_1e11_8deg_80uA_newCH_reduce_tree_rate_gem.root");
	...
	TFile *f9 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_20deg_r13m/HallC_beamtest_BeamOnTarget_5e8_8deg_80uA_5x10SC_20deg_newtest_r13m_reduce_tree_rate_gem_Etotcut.root");
...
//	TFile *f10 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_20deg_3inpolynear/HallC_beamtest_BeamOnTarget_3.79e8_8deg_80uA_target_step_right_fork_20deg_3inpolynear_reduce_tree_rate_gem_Etotcut.root");
	...
	TFile *f10 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_20deg_BLshield7feet_r13m/HallC_beamtest_BeamOnTarget_5e8_8deg_80uA_5x10SC_20deg_BLshield7feet_newtest_r13m_reduce_tree_rate_gem_Etotcut.root");
	...
	TFile *f11 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_20deg/HallC_beamtest_BeamOnTarget_1e9_8deg_80uA_target_step_right_20deg_reduce_tree_rate_gem_Etotcut.root");
	...
	TFile *f13 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_20deg_r13m/HallC_beamtest_BeamOnTarget_5e8_8deg_80uA_target_step_right_fork_20deg_newtest_r13m_reduce_tree_rate_gem_Etotcut.root");
	...
	TH1F *GEM00_beam_15cm_hist = (TH1F*)gROOT->FindObject("GEM00_beam_15cm");*/
        tree_pim->Draw("SC0_Eendsum>>shower_pim(4000,0,1000)","rate*(SC0_Eendsum>0)","goff");
	TH1F *shower_pim_hist = (TH1F*)gROOT->FindObject("shower_pim");
        tree_beam_more->Draw("SC0_Eendsum>>shower_beam_more(4000,0,1000)","rate*(SC0_Eendsum>0)","goff");
	TH1F *shower_beam_more_hist = (TH1F*)gROOT->FindObject("shower_beam_more");
        tree_beam_1cm->Draw("SC0_Eendsum>>shower_beam_1cm(4000,0,1000)","rate*(SC0_Eendsum>0)","goff");
	TH1F *shower_beam_1cm_hist = (TH1F*)gROOT->FindObject("shower_beam_1cm");
        tree_beam_15cm->Draw("SC0_Eendsum>>shower_beam_15cm(4000,0,1000)","rate*(SC0_Eendsum>0)","goff");
	TH1F *shower_beam_15cm_hist = (TH1F*)gROOT->FindObject("shower_beam_15cm");
        tree_beam_config2r->Draw("SC0_Eendsum>>shower_beam_config2r(4000,0,1000)","rate*(SC0_Eendsum>0)","goff");
	...
	TH1F *shower_beam_SC_cut_hist = (TH1F*)gROOT->FindObject("shower_SC0_SC1_beam");*/
        tree_pim->Draw("SC1_Eendsum>>Npesum_pim(200,0,100)","rate*(SC1_Eendsum>0)","goff");
	TH1F *Npesum_pim_hist = (TH1F*)gROOT->FindObject("Npesum_pim");
        tree_beam_more->Draw("SC1_Eendsum>>Npesum_beam_more(200,0,100)","rate*(SC1_Eendsum>0)","goff");
	TH1F *Npesum_beam_more_hist = (TH1F*)gROOT->FindObject("Npesum_beam_more");
        tree_beam_config2r->Draw("SC1_Eendsum>>Npesum_beam_config2r(200,0,100)","rate*(SC1_Eendsum>0)","goff");
	TH1F *Npesum_beam_config2r_hist = (TH1F*)gROOT->FindObject("Npesum_beam_config2r");
        tree_beam_1cm->Draw("SC1_Eendsum>>Npesum_beam_1cm(200,0,100)","rate*(SC1_Eendsum>0)","goff");
	TH1F *Npesum_beam_1cm_hist = (TH1F*)gROOT->FindObject("Npesum_beam_1cm");
        tree_beam_15cm->Draw("SC1_Eendsum>>Npesum_beam_15cm(200,0,100)","rate*(SC1_Eendsum>0)","goff");
	...
	TH1F *GEM10_beam_hist = (TH1F*)gROOT->FindObject("GEM10_beam");
        tree_beam_Edep->Draw("GEM10_x>>GEM10_beam_Edep(256,-5.12,5.12)","rate*(GEM10_Edep>0)","goff");
  ...
  leg8->AddEntry(shower_beam_more_hist,Form("no shielding 20 deg small SC; total rate=%f MHz",rate_proton_more),"l");
  leg8->AddEntry(shower_beam_1cm_hist,Form(" 7feet shielding 20 deg small SC; total rate=%f MHz",rate_proton_1cm),"l");
  ...
  leg7->AddEntry(Npesum_beam_more_hist,Form("no shielding 20 deg small SC; total rate=%f MHz",rate_SC1_beam_more),"l");
  leg7->AddEntry(Npesum_beam_1cm_hist,Form("7feet shielding 20 deg small SC; total rate=%f MHz",rate_SC1_beam_1cm),"l");
  leg7->AddEntry(Npesum_beam_15cm_hist,Form("8feet shielding 20 deg small SC; total rate=%f MHz",rate_SC1_beam_15cm),"l");
  leg7->AddEntry(Npesum_pim_hist,Form("7feet shielding 20 deg old SC; total rate=%f MHz",rate_SC1_pim),"l");
  ...
  leg9->AddEntry(GEM00_beam_more_hist,Form("no shielding step HMS 20deg small SC; total rate=%f MHz",rate_proton_gem_more),"l");
  leg9->AddEntry(GEM00_beam_1cm_hist,Form("7feet shielding step HMS  20deg small SC; total rate=%f MHz",rate_proton_gem_1cm),"l");
  leg9->AddEntry(GEM00_beam_15cm_hist,Form("2x30x30 in3 shielding step HMS  20deg samll SC; total rate=%f MHz",rate_proton_gem_15cm),"l");
  leg9->AddEntry(GEM00_pim_hist,Form("7feet shielding step HMS  20deg old SC; total rate=%f MHz",rate_pim_gem),"l");
  ...
  leg19->AddEntry(GEM10_beam_more_hist,Form("no shielding step HMS 20deg small SC; total rate=%f MHz",rate_proton_gem_more),"l");
  leg19->AddEntry(GEM10_beam_1cm_hist,Form("7feet shielding step HMS  20deg small SC; total rate=%f MHz",rate_proton_gem_1cm),"l");
  leg19->AddEntry(GEM10_beam_15cm_hist,Form("2x30x30 in3 shielding step HMS  20deg samll SC; total rate=%f MHz",rate_proton_gem_15cm),"l");
  leg19->AddEntry(GEM10_pim_hist,Form("7feet shielding step HMS  20deg old SC; total rate=%f MHz",rate_pim_gem),"l");
