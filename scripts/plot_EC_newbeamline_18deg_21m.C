...
TFile *f13 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_eAll_18deg_LD2_20m_30x30x2.5cm3_poly/HallC_beamtest_eAll_LD2_18deg_filenum993_9.93e7_10.6GeV_shielding_output_Nphe_finetime_Q2cut_100MeV.root");
TFile *f17 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_18deg_LD2_r20m_shielding_poly/HallC_beamtest_BeamOnTarget_1.0986e9_60uA_4SCs_18deg_r20m_LD2_shielding_output_Nphe.root");
TFile *f7 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_18deg_LD2_r20m_shielding_30x30x2.54cm3_poly/HallC_beamtest_BeamOnTarget_1.1964e9_40uA_4SCs_18deg_r20m_LD2_shielding_30x30x2.54cm3_new_output_Nphe.root");
TFile *f8 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pim_18deg_LD_21m_30degcut_poly/HallC_beamtest_bggen_LH2_pim_18deg_LD_21m_30degcut_poly_filenum7660_output_Nphe.root");
TFile *f9 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pip_18deg_LD_21m_30degcut_poly/HallC_beamtest_bggen_LH2_pip_18deg_LD_21m_30degcut_poly_filenum15290_output_Nphe.root");
TFile *f10 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pi0_18deg_LD_21m_30degcut_poly/HallC_beamtest_bggen_LH2_pi0_18deg_LD_21m_30degcut_poly_filenum5290_output_Nphe.root");
...
gPad->SetGridy();
 ...
 // hhit_p_beam_cut[m]->Draw("same HIST");
  hhit_p_pi0_cute[m]->SetLineColor(7);
  hhit_p_pi0_cute[m]->Scale(0.001);
  hhit_p_pi0_cute[m]->Rebin(rebinfac2);
  hhit_p_pi0_cute[m]->Draw("same HIST");
  }
 c[0]->cd(1);
  ...
  leg12->AddEntry(hhit_p_pi0_cute[2],"e^{-} and e^{+} of #gamma from #pi^{0}","l");
  leg12->AddEntry(hhit_p_proton_cut[2],"from BeamOnTarget","l");
//  leg12->AddEntry(hhit_p_beam_cut[2],"from BeamOnTarget+30x30x2.54cm3 ploly","l");
...
gPad->SetGridy();
 ...
 c[2]->cd(2);
  TLegend *leg122 = new TLegend(0.15,0.6,0.65,0.88);
 ...
 // leg122->AddEntry(hhit_E_beam[2],"from BeamOnTarget+30x30x2.54cm3 poly","l");
...
gPad->SetGridy();
 gPad->SetLogy();
  ...
  hhit_p_proton[m]->Rebin(rebinfac2);
 ...
 for(int m=0;m<12;m++){
  ...
  hhit_E_proton_cut[m]->GetXaxis()->SetTitle("FP_tid1 E (GeV)");
