...
void plot_rate_sangle_BLshielding(){
	gStyle->SetOptStat(0);
	gStyle->SetPalette(1);
	TFile *f5 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_step_BL2x4x160/HallC_beamtest_BeamOnTarget_9.525e8_8deg_80uA_newCH_right_CAD_2x4x160_reduce_tree_rate_gem_Etotcut.root");
	...
	TFile *f4 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_step_BL2x4x90/HallC_beamtest_BeamOnTarget_9.555e8_8deg_80uA_newCH_right_CAD_BL2x4x90_reduce_tree_rate_gem_Etotcut.root");
	...
	TFile *f8 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_TGonly/HallC_beamtest_BeamOnTarget_0.95e10_8deg_80uA_target_air_reduce_tree_rate_gem_Etotcut.root");
	...
	TFile *f13 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_step_less/HallC_beamtest_BeamOnTarget_9.925e8_8deg_80uA_newCH_right_CAD_reduce_tree_rate_gem_Etotcut.root");
	...
	TH1F *Npesum_beam_hist = (TH1F*)gROOT->FindObject("Npesum_beam");
        tree_pip->Draw("GEM10_x>>GEM00_pip(256,-5.12,5.12)","rate*(GEM10_Edep>35e-6)","goff");
	TH1F *GEM00_pip_hist = (TH1F*)gROOT->FindObject("GEM00_pip");
        tree_pim->Draw("GEM10_x>>GEM00_pim(256,-5.12,5.12)","rate*(GEM10_Edep>35e-6)","goff");
	TH1F *GEM00_pim_hist = (TH1F*)gROOT->FindObject("GEM00_pim");
        tree_pi0->Draw("GEM10_x>>GEM00_pi0(256,-5.12,5.12)","rate*( GEM10_Edep>35e-6)","goff");
	TH1F *GEM00_pi0_hist = (TH1F*)gROOT->FindObject("GEM00_pi0");
        tree_eAll->Draw("GEM10_x>>GEM00_eAll(256,-5.12,5.12)","rate*(GEM10_Edep>35e-6)","goff");
	TH1F *GEM00_eAll_hist = (TH1F*)gROOT->FindObject("GEM00_eAll");
        tree_beam->Draw("GEM10_x>>GEM00_beam(256,-5.12,5.12)","rate*(GEM10_Edep>35e-6)","goff");
	TH1F *GEM00_beam_hist = (TH1F*)gROOT->FindObject("GEM00_beam");
        tree_beam_Edep->Draw("GEM10_x>>GEM00_beam_Edep(256,-5.12,5.12)","rate*(GEM10_Edep>0)","goff");
	TH1F *GEM00_beam_Edep_hist = (TH1F*)gROOT->FindObject("GEM00_beam_Edep");
        tree_beam_more->Draw("GEM10_x>>GEM00_beam_more(256,-5.12,5.12)","rate*(GEM10_Edep>35e-6)","goff");
	TH1F *GEM00_beam_more_hist = (TH1F*)gROOT->FindObject("GEM00_beam_more");
        tree_beam_1cm->Draw("GEM10_x>>GEM00_beam_1cm(256,-5.12,5.12)","rate*(GEM10_Edep>35e-6)","goff");
	TH1F *GEM00_beam_1cm_hist = (TH1F*)gROOT->FindObject("GEM00_beam_1cm");
        tree_beam_15cm->Draw("GEM10_x>>GEM00_beam_15cm(256,-5.12,5.12)","rate*(GEM10_Edep>35e-6)","goff");
	TH1F *GEM00_beam_15cm_hist = (TH1F*)gROOT->FindObject("GEM00_beam_15cm");
        tree_beam_config2->Draw("GEM10_x>>GEM00_beam_config2(256,-5.12,5.12)","rate*(GEM10_Edep>35e-6)","goff");
	TH1F *GEM00_beam_config2_hist = (TH1F*)gROOT->FindObject("GEM00_beam_config2");
        tree_beam_config2r->Draw("GEM10_x>>GEM00_beam_config2r(256,-5.12,5.12)","rate*(GEM10_Edep>35e-6)","goff");
...
//  leg8->AddEntry(eAll_clone_hist,Form("eAll+pions; total rate=%f kHz",rate_eAll_clone),"l");
  ...
  leg8->Draw("text same");
	...
	gPad->SetLogy();
        ...
        Npesum_pi0_hist->Scale(0.000001);
        Npesum_pi0_hist->Draw("same HIST");
        Npesum_eAll_hist->SetLineColor(4);
        Npesum_eAll_hist->Scale(0.000001);
  ...
  leg7->Draw("text same");
	...
	gPad->SetLogy();
        ...
        GEM00_beam_hist->GetXaxis()->SetTitle("GEM10_x (cm)");
  ...
  //      GEM00_beam_config2_hist->Draw("same HIST");
        ...
        GEM00_beam_config2r_hist->SetLineColor(30);
  ...
  leg9->AddEntry(GEM00_beam_hist,Form("no shielding 35e^{-6} cut; total rate=%f MHz",rate_proton_gem),"l");
 // leg9->AddEntry(GEM00_beam_config2_hist,Form("no shielding step SHMS 35e^{-6} cut; total rate=%f MHz",rate_proton_gem_config2),"l");
  ...
  leg9->AddEntry(GEM00_beam_Edep_hist,Form("no shielding ; total rate=%f MHz",rate_proton_gem_Edep),"l");
  leg9->AddEntry(GEM00_pip_hist,Form("step HMS, 2 in Pb 4x160 in^{2}; total rate=%f MHz",rate_pip_gem),"l");
  //leg9->AddEntry(GEM00_pim_hist,Form("step HMS, 2 in Pb 4x90 in^{2}; total rate=%f MHz",rate_pim_gem),"l");
/*  leg9->AddEntry(GEM00_eAll_hist,Form("2 in Pb 7x30 in^{2}; total rate=%f MHz",rate_eAll_gem),"l");
  leg9->AddEntry(GEM00_pi0_hist,Form("2 in Pb 5x60 in^{2}; total rate=%f MHz",rate_pi0_gem),"l");
  leg9->AddEntry(GEM00_beam_1cm_hist,Form("4 in Pb  5x60 in^{2}; total rate=%f MHz",rate_proton_gem_1cm),"l");
  leg9->AddEntry(GEM00_beam_more_hist,Form("2 in Pb 5x70 in^{2}; total rate=%f MHz",rate_proton_gem_more),"l");
  leg9->AddEntry(GEM00_beam_15cm_hist,Form("2 in Pb 5x80 in^{2}; total rate=%f MHz",rate_proton_gem_15cm),"l");*/
