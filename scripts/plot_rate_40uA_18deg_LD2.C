...
void plot_rate_Cer_newCh_7deg(){
	...
	TFile *f2 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pip_18deg_LD_21m_30degcut_poly/HallC_beamtest_bggen_LH2_pip_18deg_LD_21m_30degcut_poly_filenum6020_reduce_tree_rate_gem1_Etotalcut_40uA_Q210MeV.root");
	...
	TFile *f3 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_eAll_18deg_LD2_20m_30x30x2.5cm3_poly_beamline/HallC_beamtest_eAll_LD2_18deg_filenum9991_9.991e8_10.6GeV_shielding_30x30x2.5cm3_poly_beamline_reduce_tree_rate_gem1_Etotalcut_40uA_Q2100MeV.root");
	...
	TFile *f4 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pi0_18deg_LD_21m_30degcut_poly/HallC_beamtest_bggen_LH2_pi0_18deg_LD_21m_30degcut_poly_filenum3030_reduce_tree_rate_gem1_Etotalcut_40uA_Q210MeV.root");
...
//	TFile *f38 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_20deg_LD2_r20m_shielding_30x30x5cm3/HallC_beamtest_BeamOnTarget_9.909e8_60uA_4SCs_20deg_r20m_LD2_shielding_30x30x5cm3_reduce_tree_rate_preshower_Etotalcut_gamma_40uA.root");
	...
	//TFile *f38 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pi0_18deg_LD_21m_30degcut_poly/HallC_beamtest_bggen_LD2_pi0_18deg_filenum3860_21m_shielding_30degcut_reduce_tree_rate_gem1_Etotalcut_40uA_Q2100MeV.root");
	TFile *f38 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pi0_18deg_LD_21m_30degcut_poly/HallC_beamtest_bggen_LH2_pi0_18deg_LD_21m_30degcut_poly_filenum3030_reduce_tree_rate_gem1_Etotalcut_40uA_Q210MeV.root");
	...
	TFile *f18 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pim_18deg_LD_21m_30degcut_poly/HallC_beamtest_bggen_LH2_pim_18deg_LD_21m_30degcut_poly_filenum2980_reduce_tree_rate_gem1_Etotalcut_40uA_Q210MeV.root");
	...
	TFile *f29 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_18deg_LD2_r20m_shielding_poly/HallC_beamtest_BeamOnTarget_1.0986e9_60uA_4SCs_18deg_r20m_LD2_shielding_reduce_tree_rate_gem1_Etotalcut_40uA_Q2100MeV.root");
        //change
//	TFile *f19 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_20deg_LD2_r20m_shielding_30x30x5cm3/HallC_beamtest_BeamOnTarget_9.909e8_60uA_4SCs_20deg_r20m_LD2_shielding_30x30x5cm3_reduce_tree_rate_gem1_Etotalcut_40uA.root");
	TFile *f19 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_18deg_LD2_r20m_shielding_30x30x2.54cm3_poly/HallC_beamtest_BeamOnTarget_1.1964e9_40uA_4SCs_18deg_r20m_LD2_shielding_30x30x2.54cm3_new_reduce_tree_rate_gem1_Etotalcut_40uA_Q2100MeV.root");
	...
	TFile *f50 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_eAll_18deg_LD2_20m_30x30x2.5cm3_poly/HallC_beamtest_eAll_LD2_18deg_filenum7992_7.992e8_10.6GeV_shielding_reduce_tree_rate_gem1_Etotalcut_40uA_Q2100MeV.root");
	TFile *f14 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_eAll_18deg_LD2_20m_30x30x2.5cm3_poly_beamline/HallC_beamtest_eAll_LD2_18deg_filenum9991_9.991e8_10.6GeV_shielding_30x30x2.5cm3_poly_beamline_reduce_tree_rate_gem1_Etotalcut_40uA_Q2100MeV.root");
	TFile *f51 = new TFile("/w/halla-scshelf2102/parity/disk1/yetian/solid/analysis_rawdata/level1_script/beamtest_level1_4501_0.root");
	TTree *tree_beam_data = (TTree*) f51->Get("T");
	...
	TH1F *preshower_beam_18_hist = (TH1F*)gROOT->FindObject("preshower_beam_18");
        ...
        tree_SC1_e->Draw("ShowerSum>>shower_e(1000,0,1000)","rate*(ShowerSum>697.4 )","goff");
	TH1F *shower_e_hist = (TH1F*)gROOT->FindObject("shower_e");
        tree_SC1_electron->Draw("ShowerSum>>shower_electron(1000,0,1000)","rate*(ShowerSum>697.4)","goff");
	TH1F *shower_electron_hist = (TH1F*)gROOT->FindObject("shower_electron");
        tree_SC1_gamma->Draw("ShowerSum>>shower_gamma(1000,0,1000)","rate*(ShowerSum>697.4)","goff");
	TH1F *shower_gamma_hist = (TH1F*)gROOT->FindObject("shower_gamma");
        tree_beam->Draw("ShowerSum>>shower_beam(1000,0,1000)","rate*(ShowerSum>697.4)","goff");
	TH1F *shower_beam_hist = (TH1F*)gROOT->FindObject("shower_beam");
        tree_beam_gamma->Draw("ShowerSum>>shower_beam_gamma(1000,0,1000)","rate*(ShowerSum>697.4)","goff");
	TH1F *shower_beam_gamma_hist = (TH1F*)gROOT->FindObject("shower_beam_gamma");
        tree_beam_e->Draw("ShowerSum>>shower_beam_e(1000,0,1000)","rate*(ShowerSum>697.4)","goff");
	TH1F *shower_beam_e_hist = (TH1F*)gROOT->FindObject("shower_beam_e");
        tree_beam_old->Draw("ShowerSum>>shower_beam_old(1000,0,1000)","rate*(ShowerSum>697.4)","goff");
	TH1F *shower_beam_old_hist = (TH1F*)gROOT->FindObject("shower_beam_old");
        tree_beam_r->Draw("ShowerSum>>shower_beam_r(1000,0,1000)","rate*(ShowerSum>697.4)","goff");
	TH1F *shower_beam_r_hist = (TH1F*)gROOT->FindObject("shower_beam_r");
        tree_beam_5cm->Draw("ShowerSum>>shower_beam_5cm(1000,0,1000)","rate*(ShowerSum>697.4)","goff");
	TH1F *shower_beam_5cm_hist = (TH1F*)gROOT->FindObject("shower_beam_5cm");
        tree_beam_18->Draw("ShowerSum>>shower_beam_18(1000,0,1000)","rate*(ShowerSum>697.4)","goff");
	TH1F *shower_beam_18_hist = (TH1F*)gROOT->FindObject("shower_beam_18");
        tree_beam_data->Draw("Shower_r*0.086>>shower_R_data(1000,0,1000)","TrigType==8","goff");
	TH1F *shower_R_data_hist = (TH1F*)gROOT->FindObject("shower_R_data");
        tree_beam_data->Draw("Shower_t*0.084>>shower_T_data(1000,0,1000)","TrigType==8","goff");
	TH1F *shower_T_data_hist = (TH1F*)gROOT->FindObject("shower_T_data");
        tree_beam_data->Draw("Shower_l*0.095>>shower_L_data(1000,0,1000)","TrigType==8","goff");
	TH1F *shower_L_data_hist = (TH1F*)gROOT->FindObject("shower_L_data");
...
//  leg58->AddEntry(LASPD_beam_e_hist,Form("from 20deg BeamOnTarget+30x30x2.5cm3 ploly; total rate=%f kHz",rate_beam_e_LASPD),"l");
 ...
 // leg28->AddEntry(preshower_beam_18_hist,Form("from 18deg eAll; total rate=%f kHz",rate_beam_18_preshower),"l");
  ...
  //      shower_beam_e_hist->Draw("same HIST");
        ...
        shower_R_data_hist->SetLineColor(30);
        shower_R_data_hist->Scale(shower_beam_gamma_hist->Integral()/shower_R_data_hist->Integral());
        shower_R_data_hist->Rebin(rebinfac);
        shower_R_data_hist->Draw("same HIST");
        shower_T_data_hist->SetLineColor(kOrange-3);
        shower_T_data_hist->Scale(shower_beam_gamma_hist->Integral()/shower_T_data_hist->Integral());
        shower_T_data_hist->Rebin(rebinfac);
        shower_T_data_hist->Draw("same HIST");
...
//  leg29->AddEntry(shower_beam_5cm_hist,Form("from 18deg BeamOnTarget+30x30x2.5cm3 poly; total rate=%f kHz",rate_beam_5cm_shower),"l");
  leg29->AddEntry(shower_beam_18_hist,Form("from 18deg eAll no beamline; total rate=%f kHz",rate_beam_18_shower),"l");
  ...
  leg29->AddEntry(shower_R_data_hist,"Shower_right data","l");
  leg29->AddEntry(shower_T_data_hist,"Shower_top data","l");
...
/*	c[1] = new TCanvas("c[1]","c[1]",1000,1000);
 ...
 // leg91->AddEntry(GEM10_beam_5cm_hist,Form("18deg BeamOnTarget 30x30x2.5cm3; total rate=%f kHz",rate_beam_5cm_gem1),"l");
  ...
  leg91->Draw("text same");
	...
	gSystem->Exec("pdfunite ./c*.pdf ./HallC_comparison_Edep_rate_18deg_21m_40uA.pdf");
