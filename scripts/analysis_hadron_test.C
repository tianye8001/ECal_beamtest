...
int analysis_hadron_test(string inputfile_name,string runmode="trigger", bool Is_tellorig=false,string filetype="",bool Is_new=true){
...
sprintf(outputfile_name, "HallC_beamtest_bggen_LH2_nobeamline_pi0_filenum15660_output_positron_shower_all.root",the_filename);
