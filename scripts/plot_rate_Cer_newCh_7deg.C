...
void plot_rate_Cer_newCh_7deg(){
	gStyle->SetOptStat(0);
	gStyle->SetPalette(1);
	TFile *f5 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pip_7deg_Cfoil/HallC_beamtest_bggen_Cfoil_pip_7deg_filenum1000_reduce_tree_rate_gem_Etotalcut.root");
	...
	TFile *f4 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pim_7deg_Cfoil/HallC_beamtest_bggen_Cfoil_pim_7deg_filenum1000_reduce_tree_rate_gem_Etotalcut.root");
	TFile *f6 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pi0_7deg_Cfoil/HallC_beamtest_bggen_Cfoil_pi0_7deg_filenum1000_reduce_tree_rate_gem_Etotalcut.root");
	TFile *f7 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_eAll_7deg_Cfoil/HallC_beamtest_eAll_Cfoil_7deg_filenum454_4.54e6_reduce_tree_rate_gem_Etotalcut.root");
