...
//	TFile *f7 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_vacuum_CCvacuum/HallC_beamtest_BeamOnTarget_1e10_8deg_80uA_target_step_right_output_gem_gammaE_pzcut.root");
	...
	gPad->SetGridx();
       ...
       // hhit_theta_noTB->Scale(0.001);
        ...
        hhit_theta_1inpoly->Draw("same HISt");	
        hhit_theta_25cm->SetLineColor(7);	
	...
	leg1->AddEntry(hhit_theta_45cm,"no shielding target vacuum rate ","l");
	leg1->AddEntry(hhit_theta_35cm,"no shielding target vacuum+CC air","l");
	...
	leg1->AddEntry(hhit_theta_25cm,"Nosh full=target+chamber+beamline step 20deg","l");
	...
	gPad->SetGridx();
      //  hhit_theta_gem2->SetLineColor(6);	
       ...
       // hhit_theta_gem2->Draw("HISt");	
        ...
        hhit_theta_1inpoly_gem2->Draw("same HISt");	
        hhit_theta_25cm_gem2->SetLineColor(7);	
	...
	leg01->AddEntry(hhit_theta_45cm_gem2,"no shielding target vacuum","l");
	leg01->AddEntry(hhit_theta_35cm_gem2,"no shielding target vacuum + CC air","l");
	...
	leg01->AddEntry(hhit_theta_25cm_gem2,"Nosh full=target+chamber+beamline step 20deg","l");
	...
	leg21->AddEntry(hhit_theta_45cm,"no shielding target vacuum","l");
	leg21->AddEntry(hhit_theta_35cm,"no shielding target vacuum + CC air","l");
...
//	leg21->AddEntry(hhit_theta,"no shielding beamline survey+old simu","l");
	...
	leg21->AddEntry(hhit_theta_25cm,"Nosh full=target+chamber+beamline step 20deg","l");
 ...
 //       hhit_theta_gem2_electron->Scale(0.001);
  ...
  //      hhit_theta_gem2_electron->Draw("HISt");	
	...
	leg201->AddEntry(hhit_theta_45cm_gem2_electron,"no shielding target vacuum","l");
	leg201->AddEntry(hhit_theta_35cm_gem2_electron,"no shielding target vacuum + CC air","l");
...
//	leg201->AddEntry(hhit_theta,"no shielding beamline survey+old simu","l");
	leg201->AddEntry(hhit_theta_1inpoly_gem2_electron,Form("NoSh full=target+chamber+beamline step rate= %f kHz",rate_theta_1inpoly_gem2_electron),"l");
	leg201->AddEntry(hhit_theta_1cmAl_gem2_electron,"2x4x190 in^{3} Pb shielding full ","l");
	leg201->AddEntry(hhit_theta_25cm_gem2_electron,"Nosh full=target+chamber+beamline step 20deg","l");
	...
	hhit_Edepgem1_electron_45cm->GetYaxis()->SetTitle("rate (MHz)");
	hhit_Edepgem1_electron_45cm->SetTitle("#gamma on gem1 virtual plane");
        hhit_Edepgem1_electron_45cm->Scale(0.000001);
        hhit_Edepgem1_electron_45cm->GetYaxis()->SetRangeUser(1e-5,2e-1);	
	...
	hhit_Edepgem1_electron_25cm->SetLineColor(2);
        hhit_Edepgem1_electron_25cm->Scale(0.000001);
	...
	hhit_Edepgem1_electron_55cm->SetLineColor(4);
        hhit_Edepgem1_electron_55cm->Scale(0.000001);
	...
	hhit_Edepgem1_electron_35cm->SetLineColor(6);
        hhit_Edepgem1_electron_35cm->Scale(0.000001);
	hhit_Edepgem1_electron_35cm->Draw("same HIST");
	...
	hhit_Edepgem1_electron_1cmAl->SetLineColor(kOrange-3);
        hhit_Edepgem1_electron_1cmAl->Scale(0.000001);
	hhit_Edepgem1_electron_1cmAl->Draw("same HIST");
...
//	leg11->AddEntry(hhit_Edepgem1_electron,"no shielding beamline survey+old simu","l");
	leg11->AddEntry(hhit_Edepgem1_electron_45cm,Form("no shielding target vacuum #theta=8deg rate=%f MHz",rate_Edepgem1_electron_45cm),"l");
	leg11->AddEntry(hhit_Edepgem1_electron_35cm,Form("no shielding target vacuum #theta=15deg rate=%f MHz",rate_Edepgem1_electron_35cm),"l");
...
//	leg11->AddEntry(hhit_Edepgem1_electron_1inpoly,Form("NoSh full=target+chamber+beamline step rate %f kHz",rate_Edepgem1_electron_1inpoly),"l");
	leg11->AddEntry(hhit_Edepgem1_electron_1cmAl,Form("no shielding target vacuum #theta=20deg rate=%f MHz",rate_Edepgem1_electron_1cmAl),"l");
	leg11->AddEntry(hhit_Edepgem1_electron_25cm,Form("Nosh target vacuum #theta=25deg rate=%f MHz",rate_Edepgem1_electron_25cm),"l");
	leg11->AddEntry(hhit_Edepgem1_electron_55cm,Form("Nosh target vacuum #theta=30deg rate=%f MHz",rate_Edepgem1_electron_55cm),"l");
...
//	hhit_Edepgem2_electron->Draw("HIST");
	...
	hhit_Edepgem2_electron_45cm->GetYaxis()->SetTitle("rate (MHz)");
	hhit_Edepgem2_electron_45cm->SetTitle("#gamma on gem2 virtual plane");
        hhit_Edepgem2_electron_45cm->Scale(0.000001);
        hhit_Edepgem2_electron_45cm->GetYaxis()->SetRangeUser(1e-5,7e-1);	
	...
	hhit_Edepgem2_electron_25cm->SetLineColor(2);
        hhit_Edepgem2_electron_25cm->Scale(0.000001);
	...
	hhit_Edepgem2_electron_55cm->SetLineColor(4);
        hhit_Edepgem2_electron_55cm->Scale(0.000001);
	...
	hhit_Edepgem2_electron_35cm->SetLineColor(6);
        hhit_Edepgem2_electron_35cm->Scale(0.0000000001);
	hhit_Edepgem2_electron_35cm->Draw("same HIST");
	...
	hhit_Edepgem2_electron_1cmAl->SetLineColor(kOrange-3);
        hhit_Edepgem2_electron_1cmAl->Scale(0.0000000001);
	hhit_Edepgem2_electron_1cmAl->Draw("same HIST");
        double rate_Edepgem2_electron_1cmAl= hhit_Edepgem2_electron_1cmAl->Integral();
	TLegend *leg31 = new TLegend(0.22,0.68,0.58,0.88);
//	leg11->AddEntry(hhit_Edepgem1_electron,"no shielding beamline survey+old simu","l");
	leg31->AddEntry(hhit_Edepgem2_electron_45cm,Form("no shielding target vacuum #theta=8deg rate=%f MHz",rate_Edepgem2_electron_45cm),"l");
	leg31->AddEntry(hhit_Edepgem2_electron_35cm,Form("Nosh full=target vacuum #theta=15deg rate=%f MHz",rate_Edepgem2_electron_35cm),"l");
	...
	leg31->AddEntry(hhit_Edepgem2_electron_1cmAl,Form("Nosh full=target vacuum #theta=20deg rate=%f MHz",rate_Edepgem2_electron_1cmAl),"l");
	leg31->AddEntry(hhit_Edepgem2_electron_25cm,Form("Nosh full=target vacuum #theta=25deg rate=%f MHz",rate_Edepgem2_electron_25cm),"l");
	leg31->AddEntry(hhit_Edepgem2_electron_55cm,Form("Nosh full=target vacuum #theta=30deg rate=%f MHz",rate_Edepgem2_electron_55cm),"l");
...
//	hhit_Edepgem1_gamma_1cmAl->Draw("same HIST");
	...
	hhit_Edepgem1_gamma_45cm->GetYaxis()->SetTitle("rate (MHz)");
	hhit_Edepgem1_gamma_45cm->SetTitle("e^{-} on gem1 virtual plane");
        hhit_Edepgem1_gamma_45cm->Scale(0.000001);
        hhit_Edepgem1_gamma_45cm->GetYaxis()->SetRangeUser(1e-2,5e0);	
	...
	hhit_Edepgem1_gamma_25cm->SetLineColor(2);
        hhit_Edepgem1_gamma_25cm->Scale(0.000001);
	...
	hhit_Edepgem1_gamma_55cm->SetLineColor(4);
        hhit_Edepgem1_gamma_55cm->Scale(0.000001);
	...
	hhit_Edepgem1_gamma_20degv->SetLineColor(kOrange-3);
        hhit_Edepgem1_gamma_20degv->Scale(0.000001);
	hhit_Edepgem1_gamma_20degv->Draw("same HIST");
        double rate_Edepgem1_gamma_20degv= hhit_Edepgem1_gamma_20degv->Integral();*/
	TLegend *leg111 = new TLegend(0.12,0.65,0.65,0.88);
//	leg111->AddEntry(hhit_Edepgem1_electron,"no shielding beamline survey+old simu","l");
	leg111->AddEntry(hhit_Edepgem1_gamma_45cm,Form("no shielding target vacuum #theta=8deg rate %f MHz",rate_Edepgem1_gamma_45cm),"l");
	...
	leg111->AddEntry(hhit_Edepgem1_gamma_35cm,Form("Nosh target vacuum #theta=15deg rate %f MHz",rate_Edepgem1_gamma_35cm),"l");
	leg111->AddEntry(hhit_Edepgem1_gamma_1cmAl,Form("Nosh target vacuum #theta=20deg rate %f MHz",rate_Edepgem1_gamma_1cmAl),"l");
//	leg111->AddEntry(hhit_Edepgem1_gamma_1cmAl,"2x4x190 in^{3} Pb shielding full ","l");
	leg111->AddEntry(hhit_Edepgem1_gamma_25cm,Form("Nosh target vacuum #theta=25deg rate %f MHz",rate_Edepgem1_gamma_25cm),"l");
	leg111->AddEntry(hhit_Edepgem1_gamma_55cm,Form("Nosh target vacuum #theta=30deg rate %f MHz",rate_Edepgem1_gamma_55cm),"l");
...
//	hhit_Edepgem2_gamma->Draw("HIST");
	...
	hhit_Edepgem2_gamma_45cm->GetYaxis()->SetTitle("rate (MHz)");
	hhit_Edepgem2_gamma_45cm->SetTitle("e^{-} on gem2 virtual plane");
        hhit_Edepgem2_gamma_45cm->Scale(0.000001);
        hhit_Edepgem2_gamma_45cm->GetYaxis()->SetRangeUser(1e-4,9e-1);	
	...
	hhit_Edepgem2_gamma_25cm->SetLineColor(2);
        hhit_Edepgem2_gamma_25cm->Scale(0.000001);
...
/*	hhit_Edepgem2_gamma_15deg->SetLineColor(6);
	...
	hhit_Edepgem2_gamma_20degv->SetLineColor(kOrange-3);
        hhit_Edepgem2_gamma_20degv->Scale(0.000001);
...
//	leg111->AddEntry(hhit_Edepgem1_electron,"no shielding beamline survey+old simu","l");
	leg41->AddEntry(hhit_Edepgem2_gamma_45cm,Form("no shielding target vacuum #theta=8deg rate=%f MHz",rate_Edepgem2_gamma_45cm),"l");
	leg41->AddEntry(hhit_Edepgem2_gamma_35cm,Form("no shielding target vacuum #theta=15deg rate=%f MHz",rate_Edepgem2_gamma_35cm),"l");
...
*/
	leg41->AddEntry(hhit_Edepgem2_gamma_1cmAl,Form("no shielding target vacuum #theta=20deg rate=%f MHz",rate_Edepgem2_gamma_1cmAl),"l");
//	leg41->AddEntry(hhit_Edepgem2_gamma_15deg,Form("Nosh target vacuum #theta=15deg rate=%f MHz",rate_Edepgem2_gamma_15deg),"l");
//	leg41->AddEntry(hhit_Edepgem2_gamma_20degv,Form("Nosh target vacuum #theta=20deg rate=%f MHz",rate_Edepgem2_gamma_20degv),"l");
	leg41->AddEntry(hhit_Edepgem2_gamma_25cm,Form("Nosh target vacuum #theta=25deg rate=%f MHz",rate_Edepgem2_gamma_25cm),"l");
	leg41->AddEntry(hhit_Edepgem2_gamma_55cm,Form("NoSh target vacuum #theta=30deg rate=%f MHz",rate_Edepgem2_gamma_55cm),"l");
