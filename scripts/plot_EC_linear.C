...
void plot_EC_linear(){
gStyle->SetOptStat(0);
  TFile *f1 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pim/HallC_beamtest_bggen_LH2_pim_filenum11250_output.root");
  ...
  TFile *f13 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_eAll/HallC_bggen_LH2_beamtest_full_eAll_filenum100_1e8_test_output.root");
  TFile *f3 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_eAll/HallC_bggen_LH2_beamtest_full_eAll_filenum100_1e8_nobeamline_output.root");
...
TFile *f7 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_proton/HallC_beamtest_bggen_LH2_proton_filenum28960_output.root");
TFile *f8 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pim/HallC_beamtest_bggen_LH2_pim_filenum11250_output.root");
TFile *f9 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pip/HallC_beamtest_bggen_LH2_pip_filenum16330_output.root");
TFile *f17 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_proton/HallC_beamtest_bggen_LH2_proton_filenum28960_nobeamline_output.root");
TFile *f18 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pim/HallC_beamtest_bggen_LH2_pim_filenum11250_nobeamline_output.root");
TFile *f19 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pip/HallC_beamtest_bggen_LH2_pip_filenum16330_nobeamline_output.root");
TFile *f27 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_proton/HallC_beamtest_bggen_LH2_proton_filenum1750_nobeamline_mother_output.root");
TFile *f28 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pim/HallC_beamtest_bggen_LH2_pim_filenum2270_nobeamline_mother_output.root");
TFile *f29 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pip/HallC_beamtest_bggen_LH2_pip_filenum2030_nobeamline_mother_output.root");
TFile *f10 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pi0/HallC_beamtest_bggen_LH2_pi0_filenum15720_output.root");
TFile *f20 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_nobeamline_pi0/HallC_beamtest_bggen_LH2_nobeamline_pi0_filenum15660_output.root");
...
TH2F *EC_shower_2D_proton_trigger;
 EC_shower_2D_pim = (TH2F*)f1->Get("ec_Eend_2D");
 EC_shower_2D_pip = (TH2F*)f2->Get("ec_Eend_2D");
 EC_shower_2D_pi0 = (TH2F*)f10->Get("ec_Eend_2D");
 EC_shower_2D_eAll = (TH2F*)f13->Get("ec_Eend_2D");
 EC_shower_2D_proton = (TH2F*)f7->Get("ec_Eend_2D");
 ...
 EC_shower_pim = (TH1F*)f1->Get("ec_Eend_shower");
 EC_shower_pip = (TH1F*)f2->Get("ec_Eend_shower");
...
double rate_proton= EC_shower_proton->Integral();
  TLegend *leg8 = new TLegend(0.45,0.4,0.8,0.68);
...
double rate_proton_pre= EC_preshower_proton->Integral();
  TLegend *leg1 = new TLegend(0.45,0.4,0.8,0.68);
...
gPad->SetGridy();
// gPad->SetLogy();
  hit_R_vs_vz_pi0[m]->Draw("COLZ"); 
  hit_R_vs_vz_pi0[m]->GetXaxis()->SetTitle("vertex z (cm)"); 
  hit_R_vs_vz_pi0[m]->GetYaxis()->SetTitle("vertex R (cm)"); 
  hit_R_vs_vz_pi0_nob[m]->SetMarkerColor(2); 
  hit_R_vs_vz_pi0_nob[m]->Draw("same p*"); 
...
// EC_shower_2D_eAll_trigger->Draw("COLZ");
// EC_shower_2D_pim_trigger->SetMarkerColor(2);
 EC_shower_2D_pim->Draw("COLZ");
 EC_shower_2D_pip->SetMarkerColor(6);
 EC_shower_2D_pip->Draw("same");
 EC_shower_2D_pi0->SetMarkerColor(3);
 EC_shower_2D_pi0->Draw("same");
 EC_shower_2D_proton->SetMarkerColor(1);
 EC_shower_2D_proton->Draw("same");
  TLegend *leg223 = new TLegend(0.4,0.35,0.8,0.48);
//  leg223->AddEntry(EC_shower_2D_eAll_trigger,"eAll","p");
 ...
 for(int a=0;a<9;a++){
    c[a]->SaveAs(Form("c%d.pdf",a));
             ...
             gSystem->Exec("pdfunite ./c*.pdf ./HallC_trigger_rate_comparison.pdf");
