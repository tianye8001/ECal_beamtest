...
int analysis_hadron_pi0(string inputfile_name,string runmode="trigger", bool Is_tellorig=false,string filetype="",bool Is_new=true){
...
sprintf(outputfile_name, "%s_output_positron_motherID_right.root",the_filename);
