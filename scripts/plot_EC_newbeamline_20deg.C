...
gStyle->SetOptStat(0);
gStyle->SetPalette(1);
  TFile *f13 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_eAll_20deg_LD2/HallC_beamtest_eAll_LD2_20deg_filenum993_4.965e7_output_Nphe_finetime_Q2cut_100MeV.root");
TFile *f7 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_20deg_LD2_r10m/HallC_beamtest_BeamOnTarget_4.968e8_8deg_80uA_5x10SC_20deg_r10m_output_Nphe.root");
TFile *f8 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pim_20deg_LD/HallC_beamtest_bggen_LD2_pim_20deg_filenum1170_output_Nphe.root");
TFile *f9 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pip_20deg_LD/HallC_beamtest_bggen_LD2_pip_20deg_filenum1300_output_Nphe.root");
TFile *f10 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pi0_20deg_LD/HallC_beamtest_bggen_LD2_pi0_20deg_filenum1300_output_Nphe.root");
...
gPad->SetGridy();
  ...
  hhit_p_cut_eAll[m]->GetYaxis()->SetRangeUser(1e-4,1e3);
  hhit_p_cut_eAll[m]->GetXaxis()->SetRangeUser(0,7);
...
gPad->SetGridy();
 ...
 c[2]->cd(2);
  TLegend *leg122 = new TLegend(0.25,0.5,0.65,0.88);
  leg122->AddEntry(hhit_E_eAll[2],"from eAll","l");
...
gPad->SetLogy();
 ...
 for(int a=0;a<3;a++){
    c[a]->SaveAs(Form("c%d.pdf",a));
             ...
             gSystem->Exec("pdfunite ./c*.pdf ./HallC_trigger_rate_comparison_newbeamline_20deg.pdf");
