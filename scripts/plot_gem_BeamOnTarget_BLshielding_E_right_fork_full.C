...
//	leg1->AddEntry(hhit_theta_1inpoly,Form("NoSh full=full+chamber+beamline step rate=%f MHz/cm2",rate_theta_linpoly),"l");
	leg1->AddEntry(hhit_theta_1cmAl,"no shielding full step #theta=20deg  ","l");
	leg1->AddEntry(hhit_theta_25cm,"no shielding full step #theta=25deg","l");
	leg1->AddEntry(hhit_theta_55cm,"no shielding full step #theta=30deg","l");
...
//	leg01->AddEntry(hhit_theta_1inpoly_gem2,Form("NoSh full=full+chamber+beamline step rate=%f MHz/cm2",rate_theta_linpoly_gem2),"l");
	leg01->AddEntry(hhit_theta_1cmAl_gem2,"no shielding full step #theta=20deg ","l");
	leg01->AddEntry(hhit_theta_25cm_gem2,"no shielding full step #theta=25deg","l");
	leg01->AddEntry(hhit_theta_55cm_gem2,"no shielding full step #theta=30deg","l");
...
//	leg21->AddEntry(hhit_theta_1inpoly,Form("NoSh full=full+chamber+beamline step rate= %f MHz/cm2",rate_theta_1inpoly_electron),"l");
	leg21->AddEntry(hhit_theta_1cmAl_electron,"no shielding full step #theta=20deg","l");
	leg21->AddEntry(hhit_theta_25cm_electron,"no shielding full step #theta=25deg","l");
	leg21->AddEntry(hhit_theta_55cm_electron,"no shielding full step #theta=30deg","l");
 ...
 //       hhit_theta_gem2_electron->Scale(0.00000001);
  ...
  //      hhit_theta_gem2_electron->Draw("HISt");	
	...
	leg201->AddEntry(hhit_theta_1cmAl_gem2_electron,"no shielding full step #theta=20deg","l");
	leg201->AddEntry(hhit_theta_25cm_gem2_electron,"no shielding full step #theta=25deg","l");
	leg201->AddEntry(hhit_theta_55cm_gem2_electron,"no shielding full step #theta=30deg","l");
...
//	leg11->AddEntry(hhit_Edepgem1_electron_1inpoly,Form("NoSh full=full+chamber+beamline step rate %f MHz/cm2",rate_Edepgem1_electron_1inpoly),"l");
	leg11->AddEntry(hhit_Edepgem1_electron_1cmAl,Form("no shielding full step #theta=20deg rate=%f MHz/cm2",rate_Edepgem1_electron_1cmAl),"l");
	leg11->AddEntry(hhit_Edepgem1_electron_25cm,Form("Nosh full step #theta=25deg rate=%f MHz/cm2",rate_Edepgem1_electron_25cm),"l");
	leg11->AddEntry(hhit_Edepgem1_electron_55cm,Form("Nosh full step #theta=30deg rate=%f MHz/cm2",rate_Edepgem1_electron_55cm),"l");
...
//	leg11->AddEntry(hhit_Edepgem1_electron,"no shielding beamline survey+old simu","l");
	...
	leg31->AddEntry(hhit_Edepgem2_electron_1cmAl,Form("Nosh full step #theta=20deg rate=%f MHz/cm2",rate_Edepgem2_electron_1cmAl),"l");
	leg31->AddEntry(hhit_Edepgem2_electron_25cm,Form("Nosh full step #theta=25deg rate=%f MHz/cm2",rate_Edepgem2_electron_25cm),"l");
	leg31->AddEntry(hhit_Edepgem2_electron_55cm,Form("Nosh full step #theta=30deg rate=%f MHz/cm2",rate_Edepgem2_electron_55cm),"l");
...
//	leg111->AddEntry(hhit_Edepgem1_electron,"no shielding beamline survey+old simu","l");
	...
	leg111->AddEntry(hhit_Edepgem1_gamma_1cmAl,Form("Nosh full step #theta=20deg rate %f MHz/cm2",rate_Edepgem1_gamma_1cmAl),"l");
//	leg111->AddEntry(hhit_Edepgem1_gamma_1cmAl,"2x4x190 in^{3} Pb shielding full ","l");
	...
	leg111->AddEntry(hhit_Edepgem1_gamma_55cm,Form("Nosh full step #theta=30deg rate %f MHz/cm2",rate_Edepgem1_gamma_55cm),"l");
...
*/
	leg41->AddEntry(hhit_Edepgem2_gamma_1cmAl,Form("no shielding full step #theta=20deg rate=%f MHz/cm2",rate_Edepgem2_gamma_1cmAl),"l");
...
//	leg41->AddEntry(hhit_Edepgem2_gamma_20degv,Form("Nosh full step #theta=20deg rate=%f MHz/cm2",rate_Edepgem2_gamma_20degv),"l");
	...
	leg41->AddEntry(hhit_Edepgem2_gamma_55cm,Form("NoSh full step #theta=30deg rate=%f MHz/cm2",rate_Edepgem2_gamma_55cm),"l");
