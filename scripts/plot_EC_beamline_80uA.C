...
TFile *f7 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_TACH_80uA/HallC_beamtest_BeamOnTarget_1.884e10_80uA_output_Nphe.root");
...
TFile *f8 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pim_80uA/HallC_beamtest_bggen_LH2_pim_80uA_filenum19880_output_Nphe.root");
//TFile *f8 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_TACH_40uA/HallC_beamtest_BeamOnTarget_1.992e10_80uA_output_Nphe.root");
...
TFile *f9 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pip_80uA/HallC_beamtest_bggen_LH2_pip_80uA_filenum19870_output_Nphe.root");
...
TFile *f10 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pi0_80uA/HallC_beamtest_bggen_LH2_pi0_80uA_filenum19880_output_Nphe.root");
...
gPad->SetLogy();
 ...
 EC_shower_proton->GetYaxis()->SetRangeUser(1e-3,1e6);
 EC_shower_proton->SetTitle("shower Edep trigger2");
...
lmin5->Draw("same"); 
 ...
 EC_preshower_proton->GetYaxis()->SetRangeUser(1e-3,1e6);
// EC_preshower_proton->GetXaxis()->SetRangeUser(0,50);
 EC_preshower_proton->GetYaxis()->SetTitle("rate (kHz)");
 EC_preshower_proton->SetTitle("preshower Edep trigger2");
...
lmin4->Draw("same"); 
 ...
 c[3]->cd(1);
  ...
  hhit_Edepspd1_proton->GetYaxis()->SetRangeUser(1e-3,1e7);
 ...
 double rate_proton_spd1= hhit_Edepspd1_proton->Integral();
  ...
  hhit_Edepspd1_pim->GetYaxis()->SetRangeUser(1e-3,1e7);
 ...
 double rate_pim_spd1= hhit_Edepspd1_pim->Integral();
  ...
  hhit_Edepspd1_pi0->GetYaxis()->SetRangeUser(1e-3,1e7);
 ...
 double rate_pi0_spd1= hhit_Edepspd1_pi0->Integral();
  ...
  hhit_Edepspd1_pip->GetYaxis()->SetRangeUser(1e-3,1e7);
 ...
 double rate_pip_spd1= hhit_Edepspd1_pip->Integral();
  ...
  hhit_Edepspd1_eAll->GetYaxis()->SetRangeUser(1e-3,1e7);
 ...
 double rate_eAll_spd1= hhit_Edepspd1_eAll->Integral();
  ...
  hhit_Edepspd2_proton->GetYaxis()->SetRangeUser(1e-3,1e7);
 ...
 double rate_proton_spd2= hhit_Edepspd2_proton->Integral();
  ...
  hhit_Edepspd2_pim->GetYaxis()->SetRangeUser(1e-3,1e7);
 ...
 double rate_pim_spd2= hhit_Edepspd2_pim->Integral();
  ...
  hhit_Edepspd2_pi0->GetYaxis()->SetRangeUser(1e-3,1e7);
 ...
 double rate_pi0_spd2= hhit_Edepspd2_pi0->Integral();
  ...
  hhit_Edepspd2_pip->GetYaxis()->SetRangeUser(1e-3,1e7);
 ...
 double rate_pip_spd2= hhit_Edepspd2_pip->Integral();
  ...
  hhit_Edepspd2_eAll->GetYaxis()->SetRangeUser(1e-3,1e7);
