...
void plot_gem_BeamOnTarget_BLshielding_E_right_fork_debug(){
	gStyle->SetOptStat(0);
	gStyle->SetPalette(1);
	TFile *f4 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pim_18deg_LD_21m_30degcut_poly/HallC_beamtest_bggen_LH2_pim_18deg_LD_21m_30degcut_poly_filenum29270_output_preshower_theta_rate_tid1.root");
	TFile *f7 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pip_18deg_LD_21m_30degcut_poly/HallC_beamtest_bggen_LH2_pip_18deg_LD_21m_30degcut_poly_filenum33740_output_preshower_theta_rate_tid1.root");
	TFile *f17 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_eAll_18deg_LD2_20m_30x30x2.5cm3_poly_beamline/HallC_beamtest_eAll_LD2_18deg_filenum9991_9.991e8_10.6GeV_shielding_30x30x2.5cm3_poly_beamline_output_preshower_theta_rate_tid1_ebug.root");
...
/*        hhit_theta_noTB->GetYaxis()->SetTitle("rate (MHz/cm2)");	
       ...
       // hhit_theta_noTB->Scale(0.00000001);
        ...
        hhit_theta_45cm->GetYaxis()->SetRangeUser(1e-3,1e1);	
	...
	leg1->AddEntry(hhit_theta_45cm,"40uA LD2 #pi^{+} from bggen #pi^{+}","l");
	leg1->AddEntry(hhit_theta_25cm,"40uA LD2 #pi^{-} from bggen #pi^{-}","l");
	leg1->AddEntry(hhit_theta_45cm_electron,"40uA LD2 e^{-} from eAll","l");
	...
	gPad->SetGridx();
      //  hhit_theta_gem2->SetLineColor(6);	
       ...
       // hhit_theta_45cm_gem2->Scale(0.00000000716);
        hhit_theta_45cm_gem2->GetYaxis()->SetRangeUser(1e-3,1e1);	
	...
	leg01->AddEntry(hhit_theta_45cm_gem2,"40uA LD2 #pi^{+}","l");
	leg01->AddEntry(hhit_theta_25cm_gem2,"40uA LD2 #pi^{-}","l");
	leg01->AddEntry(hhit_theta_45cm_gem2_electron,"40uA LD2 e^{-}","l");
	...
	gPad->SetGridx();
      ...
      //  hhit_theta_electron->Scale(0.00000001);
       ...
       // hhit_theta_45cm_electron->Scale(0.0000000267);
        hhit_theta_45cm_electron->GetYaxis()->SetRangeUser(1e-3,1e1);	
