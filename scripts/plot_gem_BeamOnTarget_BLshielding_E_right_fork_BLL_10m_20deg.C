...
void plot_gem_BeamOnTarget_BLshielding_E_right_fork_debug(){
	...
	TFile *f2 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_20deg_r10m_BLsh7feet_Yaxis16deg/HallC_beamtest_BeamOnTarget_3.996e8_8deg_80uA_5x10SC_20deg_r10m_BLsh7feet_16degYaxis_output_gem_gammaE_pzcut.root");
//	TFile *f2 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_BLshielding_far/HallC_beamtest_BeamOnTarget_5e8_8deg_80uA_target_right_step_BLshielding2x4x190_far_output_gem_gammaE_pzcut.root");
	...
	TFile *f12 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_20deg_r10m_BLsh7feet_Yaxis16deg/HallC_beamtest_BeamOnTarget_3.996e8_8deg_80uA_5x10SC_20deg_r10m_BLsh7feet_16degYaxis_output_gem_electronE_pzcut.root");
...
//	TFile *f7 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_vacuum_CCvacuum/HallC_beamtest_BeamOnTarget_1e10_8deg_80uA_target_step_right_output_gem_gammaE_pzcut.root");
	...
	TFile *f5 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_20deg_r10m_BLsh9feet_Yaxis70deg/HallC_beamtest_BeamOnTarget_3.855e8_20deg_80uA_5x10SC_8deg_r10m_BLsh9feet_70degYaxis_output_gem_gammaE_pzcut.root");
	...
	//TFile *f6 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_20deg/HallC_beamtest_BeamOnTarget_1e9_8deg_80uA_target_step_right_20deg_output_gem_gammaE_pzcut.root");
	//TFile *f6 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_20deg_r10m_BLsh7feet_Yaxis18deg/HallC_beamtest_BeamOnTarget_4e8_20deg_80uA_5x10SC_20deg_r10m_BLsh7feet_18degYaxis_output_gem_gammaE_pzcut.root");
	TFile *f6 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_20deg_r10m_BLsh7feet_Yaxis20deg/HallC_beamtest_BeamOnTarget_3.934e8_20deg_80uA_5x10SC_20deg_r10m_BLsh7feet_20degYaxis_output_gem_gammaE_pzcut.root");
	...
	TFile *f15 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_20deg_r10m_BLsh9feet_Yaxis70deg/HallC_beamtest_BeamOnTarget_3.855e8_20deg_80uA_5x10SC_8deg_r10m_BLsh9feet_70degYaxis_output_gem_electronE_pzcut.root");
	...
	//TFile *f16 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_20deg/HallC_beamtest_BeamOnTarget_1e9_8deg_80uA_target_step_right_20deg_output_gem_electronE_pzcut.root");
	TFile *f16 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_20deg_r10m_BLsh7feet_Yaxis20deg/HallC_beamtest_BeamOnTarget_3.934e8_20deg_80uA_5x10SC_20deg_r10m_BLsh7feet_20degYaxis_output_gem_electronE_pzcut.root");
...
/*        hhit_theta_noTB->GetYaxis()->SetTitle("rate (MHz/cm2)");	
	...
	leg1->AddEntry(hhit_theta_45cm,"7feet shielding full step #theta=20deg Yaxis 20deg","l");
	leg1->AddEntry(hhit_theta_35cm,"9feet shielding full step #theta=20deg Yaxis 70deg","l");
...
//	leg1->AddEntry(hhit_theta_1inpoly,Form("NoSh full=full+chamber+beamline step rate=%f MHz/cm2",rate_theta_linpoly),"l");
	leg1->AddEntry(hhit_theta_1cmAl,"7feet shielding full step #theta=20deg Yaxis 16deg  ","l");
	leg1->AddEntry(hhit_theta_25cm,"7feet shielding full step #theta=20deg Yaxis 70deg","l");
	leg1->AddEntry(hhit_theta_55cm,"no shielding full step #theta=20deg 10m ","l");
	...
	leg01->AddEntry(hhit_theta_45cm_gem2,"7feet shielding full step #theta=20deg Yaxis 20deg","l");
	leg01->AddEntry(hhit_theta_35cm_gem2,"9feet shielding full step #theta=20deg Yaxis 70deg","l");
...
//	leg01->AddEntry(hhit_theta_1inpoly_gem2,Form("NoSh full=full+chamber+beamline step rate=%f MHz/cm2",rate_theta_linpoly_gem2),"l");
	leg01->AddEntry(hhit_theta_1cmAl_gem2,"7feet shielding full step #theta=20deg Yaxis 16deg","l");
	leg01->AddEntry(hhit_theta_25cm_gem2,"7feet shielding full step #theta=20deg Yaxis 70deg","l");
	leg01->AddEntry(hhit_theta_55cm_gem2,"no shielding full step #theta=20deg 10m","l");
	...
	leg21->AddEntry(hhit_theta_45cm_electron,"7feet shielding full step #theta=20deg Yaxis 20deg","l");
	leg21->AddEntry(hhit_theta_35cm_electron,"9feet shielding full step #theta=20deg Yaxis 70deg","l");
...
//	leg21->AddEntry(hhit_theta_1inpoly,Form("NoSh full=full+chamber+beamline step rate= %f MHz/cm2",rate_theta_1inpoly_electron),"l");
	leg21->AddEntry(hhit_theta_1cmAl_electron,"7feet shielding full step #theta=20deg Yaxis 16deg ","l");
	leg21->AddEntry(hhit_theta_25cm_electron,"7feet shielding full step #theta=20deg Yaxis 70deg","l");
	leg21->AddEntry(hhit_theta_55cm_electron,"no shielding full step #theta=20deg 10m","l");
 ...
 //       hhit_theta_gem2_electron->Scale(0.00000001);
  ...
  //      hhit_theta_gem2_electron->Draw("HISt");	
	...
	leg201->AddEntry(hhit_theta_45cm_gem2_electron,"7feet shielding full step #theta=20deg Yaxis 20deg","l");
	leg201->AddEntry(hhit_theta_35cm_gem2_electron,"9feet shielding full step #theta=20deg Yaxis 70deg","l");
	leg201->AddEntry(hhit_theta_1cmAl_gem2_electron,"7feet shielding full step #theta=20deg Yaxis 16deg","l");
	leg201->AddEntry(hhit_theta_25cm_gem2_electron,"7feet shielding full step #theta=20deg Yaxis 70deg","l");
	leg201->AddEntry(hhit_theta_55cm_gem2_electron,"no shielding full step #theta=20deg 10m","l");
...
//	leg11->AddEntry(hhit_Edepgem1_electron,"no shielding beamline survey+old simu","l");
	leg11->AddEntry(hhit_Edepgem1_electron_45cm,Form("7feet shielding full step #theta=20deg Yaxis 20deg rate=%f MHz/cm2",rate_Edepgem1_electron_45cm),"l");
	leg11->AddEntry(hhit_Edepgem1_electron_35cm,Form("9feet shielding full step #theta=20deg Yaxis 70deg rate=%f MHz/cm2",rate_Edepgem1_electron_35cm),"l");
...
//	leg11->AddEntry(hhit_Edepgem1_electron_1inpoly,Form("NoSh full=full+chamber+beamline step rate %f MHz/cm2",rate_Edepgem1_electron_1inpoly),"l");
	leg11->AddEntry(hhit_Edepgem1_electron_1cmAl,Form("7feet shielding full step #theta=20deg Yaxis 16deg rate=%f MHz/cm2",rate_Edepgem1_electron_1cmAl),"l");
	leg11->AddEntry(hhit_Edepgem1_electron_25cm,Form("7feet full step #theta=20deg Yaxis 70deg rate=%f MHz/cm2",rate_Edepgem1_electron_25cm),"l");
	leg11->AddEntry(hhit_Edepgem1_electron_55cm,Form("Nosh full step #theta=20deg 10 m rate=%f MHz/cm2",rate_Edepgem1_electron_55cm),"l");
...
//	leg11->AddEntry(hhit_Edepgem1_electron,"no shielding beamline survey+old simu","l");
	leg31->AddEntry(hhit_Edepgem2_electron_45cm,Form("7feet shielding full step #theta=20deg Yaxis 20deg rate=%f MHz/cm2",rate_Edepgem2_electron_45cm),"l");
	leg31->AddEntry(hhit_Edepgem2_electron_35cm,Form("9feet shielding full step #theta=20deg Yaxis 70deg rate=%f MHz/cm2",rate_Edepgem2_electron_35cm),"l");
	...
	leg31->AddEntry(hhit_Edepgem2_electron_1cmAl,Form("7feet full step #theta=20deg Yaxis 16deg rate=%f MHz/cm2",rate_Edepgem2_electron_1cmAl),"l");
	leg31->AddEntry(hhit_Edepgem2_electron_25cm,Form("7feet full step #theta=20deg Yaxis 70deg rate=%f MHz/cm2",rate_Edepgem2_electron_25cm),"l");
	leg31->AddEntry(hhit_Edepgem2_electron_55cm,Form("Nosh full step #theta=20deg  10m rate=%f MHz/cm2",rate_Edepgem2_electron_55cm),"l");
...
//	leg111->AddEntry(hhit_Edepgem1_electron,"no shielding beamline survey+old simu","l");
	leg111->AddEntry(hhit_Edepgem1_gamma_45cm,Form("7feet shielding full step #theta=20deg Yaxis 20deg rate %f MHz/cm2",rate_Edepgem1_gamma_45cm),"l");
	...
	leg111->AddEntry(hhit_Edepgem1_gamma_35cm,Form("9feet shielding full step #theta=20deg Yaxis 70 deg rate %f MHz/cm2",rate_Edepgem1_gamma_35cm),"l");
	leg111->AddEntry(hhit_Edepgem1_gamma_1cmAl,Form("7feet shielding full step #theta=20deg Yaxis 16deg rate %f MHz/cm2",rate_Edepgem1_gamma_1cmAl),"l");
//	leg111->AddEntry(hhit_Edepgem1_gamma_1cmAl,"2x4x190 in^{3} Pb shielding full ","l");
	leg111->AddEntry(hhit_Edepgem1_gamma_25cm,Form("4feet full step #theta=20deg Yaxis 70deg rate %f MHz/cm2",rate_Edepgem1_gamma_25cm),"l");
	leg111->AddEntry(hhit_Edepgem1_gamma_55cm,Form("Nosh full step #theta=20deg 10m rate %f MHz/cm2",rate_Edepgem1_gamma_55cm),"l");
...
//	leg111->AddEntry(hhit_Edepgem1_electron,"no shielding beamline survey+old simu","l");
	leg41->AddEntry(hhit_Edepgem2_gamma_45cm,Form("7feet shielding full step #theta=20deg Yaxis 20deg rate=%f MHz/cm2",rate_Edepgem2_gamma_45cm),"l");
	leg41->AddEntry(hhit_Edepgem2_gamma_35cm,Form("9feet shielding full step #theta=20deg Yaxis 70deg rate=%f MHz/cm2",rate_Edepgem2_gamma_35cm),"l");
...
*/
	leg41->AddEntry(hhit_Edepgem2_gamma_1cmAl,Form("7feet shielding full step #theta=20deg Yaxis 16deg rate=%f MHz/cm2",rate_Edepgem2_gamma_1cmAl),"l");
...
//	leg41->AddEntry(hhit_Edepgem2_gamma_20degv,Form("Nosh full step #theta=20deg rate=%f MHz/cm2",rate_Edepgem2_gamma_20degv),"l");
	leg41->AddEntry(hhit_Edepgem2_gamma_25cm,Form("7feet full step #theta=820deg Yaxis 70deg rate=%f MHz/cm2",rate_Edepgem2_gamma_25cm),"l");
	leg41->AddEntry(hhit_Edepgem2_gamma_55cm,Form("NoSh full step #theta=20deg 10m rate=%f MHz/cm2",rate_Edepgem2_gamma_55cm),"l");
	...
	gSystem->Exec("pdfunite ./c*.pdf ./HallC_Espectrum_full_scattering_angles.pdf");
