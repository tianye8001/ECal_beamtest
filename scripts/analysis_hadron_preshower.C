...
int analysis_hadron_preshower(string inputfile_name,string runmode="trigger", bool Is_tellorig=false,string filetype="",bool Is_new=true){
...
sprintf(outputfile_name, "HallC_beamtest_bggen_LH2_nobeamline_pi0_filenum15660_output_positron_preshower_all_test.root",the_filename);
...
// 	htime_photon[1]=new TH1F("time_photon_1","time",400,0,1000);	
	...
	TH1F *hhit_E[n],*hhit_E_mip[n],*hhit_E_photonele[n],*hhit_E_ele[n],*hhit_Edep[n],*hhit_p[n],*hhit_Ek[n],*hhit_Ec[n],*hhit_E_cut[n],*hhit_p_cut[n], *hhit_Ek_cut[n],*gen_theta_cut[n],*gen_p_cut[n], *hhit_pid[n], *hhit_mpid[n], *hhit_procID[n];		  	
        TH1F *hhit_vz_cutr[n],*hhit_z_cutr[n],*hhit_vz_cute[n],*hhit_z_cute[n],*hhit_E_cutr[n],*hhit_p_cutr[n], *hhit_Ek_cutr[n],*gen_theta_cutr[n],*gen_p_cutr[n],*hhit_E_cute[n],*hhit_p_cute[n], *hhit_Ek_cute[n],*gen_theta_cute[n],*gen_p_cute[n];
        TH2F *hhit_vR_vs_vz_cutr[n],*hhit_R_vs_z_cutr[n],*hhit_vR_vs_vz_cute[n],*hhit_R_vs_z_cute[n],*gen_theta_vs_p_cutr[n],*gen_theta_vs_p_cute[n]; 
	for(int i=0;i<n;i++){
	  char hstname[100];
	  sprintf(hstname,"hit_vz_%i",i);
	  hhit_vz[i]=new TH1F(hstname,detname[i].c_str(),900,-100,800);  
	  sprintf(hstname,"hit_z_%i",i);
	  hhit_z[i]=new TH1F(hstname,detname[i].c_str(),900,-100,800);  
	  sprintf(hstname,"hit_R_vs_vz_%i",i);
	  hhit_vR_vs_vz[i]=new TH2F(hstname,detname[i].c_str(),900,-100,800,1000,0,1000);        
	  sprintf(hstname,"hit_R_vs_z_%i",i);
	  hhit_R_vs_z[i]=new TH2F(hstname,detname[i].c_str(),900,-20,880,1000,0,1000);        
	  ...
	  hhit_E[i]=new TH1F(hstname,detname[i].c_str(),500,0,5);
	  ...
	  hhit_Edep[i]=new TH1F(hstname,detname[i].c_str(),5000,0,5);	  
	  sprintf(hstname,"hit_momentum_%i",i);
	  hhit_p[i]=new TH1F(hstname,detname[i].c_str(),500,0,5);
	  sprintf(hstname,"hit_Ek_%i",i);
	  hhit_Ek[i]=new TH1F(hstname,detname[i].c_str(),500,0,5);
	  sprintf(hstname,"hit_Ec_%i",i);
	  hhit_Ec[i]=new TH1F(hstname,detname[i].c_str(),500,0,5);
	  sprintf(hstname,"hit_momentum_cut_%i",i);
	  hhit_p_cut[i]=new TH1F(hstname,detname[i].c_str(),500,0,5);
	  sprintf(hstname,"hit_E_cut_%i",i);
	  hhit_E_cut[i]=new TH1F(hstname,detname[i].c_str(),500,0,5);
	  sprintf(hstname,"hit_Ek_cut_%i",i);
	  hhit_Ek_cut[i]=new TH1F(hstname,detname[i].c_str(),500,0,5);
	  sprintf(hstname,"hit_vz_cut_%i",i);
	  hhit_vz_cut[i]=new TH1F(hstname,detname[i].c_str(),900,-100,800);  
	  sprintf(hstname,"hit_z_cut_%i",i);
	  hhit_z_cut[i]=new TH1F(hstname,detname[i].c_str(),900,-100,800);  
	  sprintf(hstname,"hit_R_vs_vz_cut_%i",i);
	  hhit_vR_vs_vz_cut[i]=new TH2F(hstname,detname[i].c_str(),900,-100,800,1000,0,1000);        
	  sprintf(hstname,"hit_R_vs_z_cut_%i",i);
	  hhit_R_vs_z_cut[i]=new TH2F(hstname,detname[i].c_str(),900,-20,880,1000,0,1000);        
	  ...
	  gen_p_cut[i]=new TH1F(hstname,detname[i].c_str(),110,0,11);        
	  ...
	  hhit_p_cutr[i]=new TH1F(hstname,detname[i].c_str(),500,0,5);
	  sprintf(hstname,"hit_E_cutr_%i",i);
	  hhit_E_cutr[i]=new TH1F(hstname,detname[i].c_str(),500,0,5);
	  sprintf(hstname,"hit_Ek_cutr_%i",i);
	  hhit_Ek_cutr[i]=new TH1F(hstname,detname[i].c_str(),500,0,5);
	  sprintf(hstname,"hit_vz_cutr_%i",i);
	  hhit_vz_cutr[i]=new TH1F(hstname,detname[i].c_str(),900,-100,800);  
	  sprintf(hstname,"hit_z_cutr_%i",i);
	  hhit_z_cutr[i]=new TH1F(hstname,detname[i].c_str(),900,-100,800);  
	  sprintf(hstname,"hit_R_vs_vz_cutr_%i",i);
	  hhit_vR_vs_vz_cutr[i]=new TH2F(hstname,detname[i].c_str(),900,-100,800,1000,0,1000);        
	  sprintf(hstname,"hit_R_vs_z_cutr_%i",i);
	  hhit_R_vs_z_cutr[i]=new TH2F(hstname,detname[i].c_str(),900,-20,880,1000,0,1000);        
	  ...
	  gen_p_cutr[i]=new TH1F(hstname,detname[i].c_str(),110,0,11);        
	  sprintf(hstname,"hit_momentum_cute_%i",i);
	  hhit_p_cute[i]=new TH1F(hstname,detname[i].c_str(),500,0,5);
	  sprintf(hstname,"hit_E_cute_%i",i);
	  hhit_E_cute[i]=new TH1F(hstname,detname[i].c_str(),500,0,5);
	  sprintf(hstname,"hit_Ek_cute_%i",i);
	  hhit_Ek_cute[i]=new TH1F(hstname,detname[i].c_str(),500,0,5);
	  sprintf(hstname,"hit_vz_cute_%i",i);
	  hhit_vz_cute[i]=new TH1F(hstname,detname[i].c_str(),900,-100,800);  
	  sprintf(hstname,"hit_z_cute_%i",i);
	  hhit_z_cute[i]=new TH1F(hstname,detname[i].c_str(),900,-100,800);  
	  sprintf(hstname,"hit_R_vs_vz_cute_%i",i);
	  hhit_vR_vs_vz_cute[i]=new TH2F(hstname,detname[i].c_str(),900,-100,800,1000,0,1000);        
	  sprintf(hstname,"hit_R_vs_z_cute_%i",i);
	  hhit_R_vs_z_cute[i]=new TH2F(hstname,detname[i].c_str(),900,-20,880,1000,0,1000);        
	  ...
	  gen_p_cute[i]=new TH1F(hstname,detname[i].c_str(),110,0,11);        
	}
...
// 	TH1F *hhit_Pec_proton=new TH1F("hit_Pec_proton","EC;P(GeV);rate(Hz)",1100,0,11);	
	...
	TH1F *hec_Eend_shower_e=new TH1F("ec_Eend_shower_e","EC electron;Eend [MeV]",200,0,200);
	TH1F *hec_Eend_preshower_e=new TH1F("ec_Eend_preshower_e","EC electron;Eend_preshower [MeV]",200,0,100);
	TH1F *hec_Eend_shower_ep=new TH1F("ec_Eend_shower_ep","EC positron;Eend [MeV]",200,0,200);
	TH1F *hec_Eend_preshower_ep=new TH1F("ec_Eend_preshower_ep","EC positron;Eend_preshower [MeV]",200,0,100);
	TH1F *hec_Eend_shower_mother_ep=new TH1F("ec_Eend_shower_mother_ep","EC gamma;Eend [MeV]",200,0,200);
	TH1F *hec_Eend_preshower_mother_ep=new TH1F("ec_Eend_preshower_mother_ep","EC gamma;Eend_preshower [MeV]",200,0,100);
	TH1F *hec_Eend_shower_mother_e=new TH1F("ec_Eend_shower_mother_e","EC gamma;Eend [MeV]",200,0,200);
	TH1F *hec_Eend_preshower_mother_e=new TH1F("ec_Eend_preshower_mother_e","EC gamma;Eend_preshower [MeV]",200,0,100);
	TH1F *hec_Eend_shower_r=new TH1F("ec_Eend_shower_r","EC gamma;Eend [MeV]",200,0,200);
	TH1F *hec_Eend_preshower_r=new TH1F("ec_Eend_preshower_r","EC gamma;Eend_preshower [MeV]",200,0,100);
	TH1F *hec_Eend_shower_mother_r=new TH1F("ec_Eend_shower_mother_r","EC gamma;Eend [MeV]",200,0,200);
	TH1F *hec_Eend_preshower_mother_r=new TH1F("ec_Eend_preshower_mother_r","EC gamma;Eend_preshower [MeV]",200,0,100);
	TH1F *hec_Eend_shower_o=new TH1F("ec_Eend_shower_o","EC other;Eend [MeV]",200,0,200);
	TH1F *hec_Eend_preshower_o=new TH1F("ec_Eend_preshower_o","EC other;Eend_preshower [MeV]",200,0,100);
	TH1F *hec_Eend_preshower_PID=new TH1F("ec_Eend_preshower_PID","EC other;PID_preshower [MeV]",6000,-2999.5,3000.5);
	...
	TH1F *hec_Eend_shower_mother_e_proc=new TH1F("ec_Eend_shower_mother_e_proc","EC electron;procID",131,-0.5,130.5);
	TH1F *hec_Eend_preshower_mother_e_proc=new TH1F("ec_Eend_preshower_mother_e_proc","EC electron;procID",131,-0.5,130.5);
	TH1F *hec_Eend_shower_mother_ep_proc=new TH1F("ec_Eend_shower_mother_ep_proc","EC positron;procID",131,-0.5,130.5);
	TH1F *hec_Eend_preshower_mother_ep_proc=new TH1F("ec_Eend_preshower_mother_ep_proc","EC positron;procID",131,-0.5,130.5);
	TH1F *hec_Eend_shower_mother_r_proc=new TH1F("ec_Eend_shower_mother_r_proc","EC gamma;procID",131,-0.5,130.5);
	TH1F *hec_Eend_preshower_mother_r_proc=new TH1F("ec_Eend_preshower_mother_r_proc","EC gamma;procID",131,-0.5,130.5);
	TH2F *hec_Eend_2D_trigger=new TH2F("ec_Eend_2D_trigger","EC;Eend_shower;procID",200,0,500,200,0,100);
	TH1F *hec_Eend_shower_trigger=new TH1F("ec_Eend_shower_trigger","EC;Eend [MeV]",200,0,200);
...
// 	long int N_events = (long int)tree_header->GetEntries();
	...
	double trigger_ec=0;
        ...
        double edep_6p1_max1= 0;
        int edep_max_pid=0;
        int edep_max_mpid=0;
        int edep_max_procID=0;
...
// 		  if (hit_id==-1) {/cout << flux_id->at(j) << " " << flux_avg_z->at(j) << endl;
                  if(hit_id==2){
                    hit_preshowerN ++;
                   // cout<< "event= "<<i<<"flux="<<j<< "flux_pid="<<flux_pid->at(j) << "flux_mpid= " << flux_mpid->at(j)<<"flux_tid="<<flux_tid->at(j)<<"flux_mtid="<<flux_mtid->at(j) << "flux_trackE= " << flux_trackE->at(j) << " flux_pf=" << hit_p << endl;  
                  if (E >= edep_6p1_max1){
                     edep_6p1_max1=E;
                     edep_max_pid=flux_pid->at(j);
                     edep_max_mpid=flux_mpid->at(j);
                     edep_max_procID=flux_procID->at(j);
                   }

                 }else hit_preshowerN=hit_preshowerN;
		  
                 //cout<<"flux_event="<<i<<"flux_index="<<j<<"  "<<"hit_id="<<hit_id<<"hit_preshowerN="<<hit_preshowerN<<endl; 
		 ...
		 if(pid_gen!=111){ 
		  ...
		  if (flux_pid->at(j) ==22 && flux_mpid->at(j)==111 ){
		  Ek=E;
                  Ec=hit_p;
...
//                 cout<< "event= "<<i<<"flux_E_max="<<edep_6p1_max1<<endl;
		//fill every events
              ...
              /*if(hit_preshowerN>0){
               for (int j=0;j<solid_ec_ps_hitn->size();j++){
                 //if(solid_ec_ps_pid->at(j)==11 && solid_ec_ps_mpid->at(j)==22){
                  //if(i==62774){
                  //cout<<"event="<<i<<"  index="<<j<<"  solid_ec_procID="<<solid_ec_ps_procID->at(j)<<"solid_ec_ps_mpid="<<solid_ec_ps_mpid->at(j)<<"pid="<<solid_ec_ps_pid->at(j)<<"Edep="<<solid_ec_ps_totEend->at(j)<<endl;
                  // }
                 if(solid_ec_ps_pid->at(j)==11 ){
                  Eend_ec_ps_e += solid_ec_ps_totEend->at(j);
                    hec_Eend_preshower_e_proc->Fill(solid_ec_ps_procID->at(j));
                 // cout<<"electron_event="<<i<<"  index="<<j<<"  solid_ec_procID="<<solid_ec_ps_procID->at(j)<<"solid_ec_ps_mpid="<<solid_ec_ps_mpid->at(j)<<"pid="<<solid_ec_ps_pid->at(j)<<"Edep="<<solid_ec_ps_totEend->at(j)<<endl;
		...
		tree_solid_spd->GetEntry(i);
	     ...
	     // } 
	      ...
	      process_tree_solid_ec(tree_solid_ec,tree_solid_ec_ps,Eend_ec,Eend_ec_ps);
              //cout<<"event="<<i<<"Edep="<<Eend_ec<<"Eend_ec_ps="<<Eend_ec_ps<<"rate="<<rate<<endl;
              if(Eend_ec_ps>0){

                 if(edep_max_pid==11){
                  hec_Eend_preshower_e->Fill(Eend_ec_ps,rate);
                  hec_Eend_shower_e->Fill(Eend_ec,rate);
                  hec_Eend_shower_e_proc->Fill(edep_max_procID,rate);
                  hec_Eend_preshower_e_proc->Fill(edep_max_procID,rate);
                 }
                 else if(edep_max_pid==-11){
                  hec_Eend_preshower_ep->Fill(Eend_ec_ps,rate);
                  hec_Eend_shower_ep->Fill(Eend_ec,rate);
                  hec_Eend_shower_ep_proc->Fill(edep_max_procID,rate);
                  hec_Eend_preshower_ep_proc->Fill(edep_max_procID,rate);
                 }
                 else if(edep_max_pid==22){
                  hec_Eend_preshower_r->Fill(Eend_ec_ps,rate);
                  hec_Eend_shower_r->Fill(Eend_ec,rate);
                  hec_Eend_shower_r_proc->Fill(edep_max_procID,rate);
                  hec_Eend_preshower_r_proc->Fill(edep_max_procID,rate);
                 }
                 else{
                 hec_Eend_shower_o->Fill(Eend_ec,rate);
                 hec_Eend_preshower_o->Fill(Eend_ec_ps,rate);
                 hec_Eend_preshower_PID->Fill(edep_max_pid,rate);
                 // cout<<"event="<<i<<"Edep="<<Eend_ec<<"Eend_ec_ps="<<Eend_ec_ps<<"rate="<<rate<<"E_flux_max="<<edep_6p1_max1<<"edep_max_pid="<<edep_max_pid<<"edep_max_mpid="<<edep_max_mpid<<"edep_max_procID="<<edep_max_procID<<endl;
                 }
                 if(edep_max_pid==11 && edep_max_mpid==22){
                  hec_Eend_preshower_mother_e->Fill(Eend_ec_ps,rate);
                  hec_Eend_shower_mother_e->Fill(Eend_ec,rate);
                  hec_Eend_shower_mother_e_proc->Fill(edep_max_procID,rate);
                  hec_Eend_preshower_mother_e_proc->Fill(edep_max_procID,rate);
                 }
                 if(edep_max_pid==-11 && edep_max_mpid==22){
                  hec_Eend_preshower_mother_ep->Fill(Eend_ec_ps,rate);
                  hec_Eend_shower_mother_ep->Fill(Eend_ec,rate);
                  hec_Eend_preshower_mother_ep_proc->Fill(edep_max_procID,rate);
                  hec_Eend_shower_mother_ep_proc->Fill(edep_max_procID,rate);
                 }
                 if(edep_max_pid==22 && edep_max_mpid==111){
                  hec_Eend_preshower_mother_r->Fill(Eend_ec_ps,rate);
                  hec_Eend_shower_mother_r->Fill(Eend_ec,rate);
                  hec_Eend_shower_mother_r_proc->Fill(edep_max_procID,rate);
                  hec_Eend_preshower_mother_r_proc->Fill(edep_max_procID,rate);
                 }
	      hec_Eend_2D->Fill(Eend_ec,Eend_ec_ps);
	      //hec_Eend_shower->Fill(Eend_ec,rate); 
	      hec_Eend_preshower->Fill(Eend_ec_ps,rate);
              }
              if(Eend_ec>0){
	        hec_Eend_shower->Fill(Eend_ec,rate); 
              }
               if(trigger_ec==1){
              hec_Eend_2D_trigger->Fill(Eend_ec,Eend_ec_ps);
              hec_Eend_shower_trigger->Fill(Eend_ec,rate); 
              hec_Eend_preshower_trigger->Fill(Eend_ec_ps,rate);
