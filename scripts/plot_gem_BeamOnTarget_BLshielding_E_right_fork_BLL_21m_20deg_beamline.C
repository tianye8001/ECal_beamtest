...
void plot_gem_BeamOnTarget_BLshielding_E_right_fork_debug(){
	gStyle->SetOptStat(0);
	gStyle->SetPalette(1);
	TFile *f7 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_20deg_LD2_r20m/HallC_beamtest_BeamOnTarget_9.945e8_60uA_4SCs_20deg_r20m_LD2_output_gem_gammaE_pzcut_debug.root");
	//TFile *f4 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_20deg_LD2_r20m_nobeamline/HallC_beamtest_BeamOnTarget_5.889e8_60uA_4SCs_20deg_r20m_LD2_nobeamline_output_gem_gammaE_pzcut_debug.root");
	//TFile *f14 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_20deg_LD2_r20m_nobeamline/HallC_beamtest_BeamOnTarget_5.889e8_60uA_4SCs_20deg_r20m_LD2_nobeamline_output_gem_electronE_pzcut_debug.root");
	TFile *f4 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_20deg_LD2_r20m_kryptonite/HallC_beamtest_BeamOnTarget_1.285e8_60uA_4SCs_20deg_r20m_LD2_kryptonite_output_gem_gammaE_pzcut_debug.root");
	TFile *f14 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_20deg_LD2_r20m_kryptonite/HallC_beamtest_BeamOnTarget_1.285e8_60uA_4SCs_20deg_r20m_LD2_kryptonite_output_gem_electronE_pzcut_debug.root");
	TFile *f17 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_20deg_LD2_r20m/HallC_beamtest_BeamOnTarget_9.945e8_60uA_4SCs_20deg_r20m_LD2_output_gem_electronE_pzcut_debug.root");
	TFile *f6 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_20deg_LD2_r20m_shielding/HallC_beamtest_BeamOnTarget_1.9918e9_60uA_4SCs_20deg_r20m_LD2_shielding_output_gem_gammaE_pzcut_debug.root");
	TFile *f16 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_20deg_LD2_r20m_shielding/HallC_beamtest_BeamOnTarget_1.9918e9_60uA_4SCs_20deg_r20m_LD2_shielding_output_gem_electronE_pzcut_debug.root");
	//TFile *f3 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_20deg_LD2_r20m_shielding_30x30x5cm3/HallC_beamtest_BeamOnTarget_9.909e8_60uA_4SCs_20deg_r20m_LD2_shielding_30x30x5cm3_output_gem_gammaE_pzcut_debug.root");
//	TFile *f13 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_20deg_LD2_r20m_shielding_30x30x5cm3/HallC_beamtest_BeamOnTarget_9.909e8_60uA_4SCs_20deg_r20m_LD2_shielding_30x30x5cm3_output_gem_gammaE_pzcut_debug.root");
	TFile *f3 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_20deg_LD2_r20m_shielding_30x30cm2_1inch/HallC_beamtest_BeamOnTarget_4.968e8_60uA_4SCs_20deg_r20m_LD2_shielding_30x30x2.54cm3_output_gem_gammaE_pzcut_debug.root");
	TFile *f13 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_20deg_LD2_r20m_shielding_30x30cm2_1inch/HallC_beamtest_BeamOnTarget_4.968e8_60uA_4SCs_20deg_r20m_LD2_shielding_30x30x2.54cm3_output_gem_electronE_pzcut_debug.root");
	TH1F *hprocid_gem1;       
	TH1F *hpf_gem1;
	TH1F *hE_gem1;
	TH1F *hpf_gem1_1cmAl;
	...
	TH1F *hhit_Edepgem1_compton_35cm;
        ...
        hhit_theta_35cm = (TH1F*)f6->Get("gen_Theta_gem1");
        hhit_theta_35cm_electron = (TH1F*)f16->Get("gen_Theta_gem1");
        ...
        hhit_Edepgem2_electron_35cm = (TH1F*)f6->Get("hit_Egem2");
        ...
        hhit_Edepgem2_gamma_35cm = (TH1F*)f16->Get("hit_Egem2");
        ...
        hhit_theta_35cm_gem2 = (TH1F*)f6->Get("gen_Theta_gem2");
        hhit_theta_35cm_gem2_electron = (TH1F*)f16->Get("gen_Theta_gem2");
...
/*        hhit_theta_noTB->GetYaxis()->SetTitle("rate (MHz/cm2)");	
       ...
       // hhit_theta_noTB->Scale(0.00000001);
        ...
        hhit_theta_35cm->SetLineColor(4);	
        hhit_theta_35cm->Scale(0.00000001);
        hhit_theta_35cm->Draw("same HISt");	
        hhit_theta_1inpoly->SetLineColor(6);	
        hhit_theta_1inpoly->Scale(0.00000001);
        hhit_theta_1inpoly->Draw("same HISt");	
	TLegend *leg1 = new TLegend(0.45,0.7,0.8,0.9);
	leg1->AddEntry(hhit_theta_45cm,"60uA LD2 target ","l");
	leg1->AddEntry(hhit_theta_35cm,"60uA LD2 target PMT shielding ","l");
	leg1->AddEntry(hhit_theta_1inpoly,"60uA LD2 target PMT shielding+30x30x2.5cm3 poly","l");
	leg1->AddEntry(hhit_theta_25cm,"60uA LD2 target without beamline","l");
	...
	gPad->SetGridx();
      //  hhit_theta_gem2->SetLineColor(6);	
       ...
       // hhit_theta_gem2->Draw("HISt");	
        ...
        hhit_theta_35cm_gem2->SetLineColor(4);	
        hhit_theta_35cm_gem2->Scale(0.00000001);
        hhit_theta_35cm_gem2->Draw("same HISt");	
        hhit_theta_1inpoly_gem2->SetLineColor(6);	
        hhit_theta_1inpoly_gem2->Scale(0.00000001);
        hhit_theta_1inpoly_gem2->Draw("same HISt");	
	TLegend *leg01 = new TLegend(0.45,0.7,0.8,0.9);
	leg01->AddEntry(hhit_theta_45cm_gem2,"60uA LD2 target ","l");
	leg01->AddEntry(hhit_theta_35cm_gem2,"60uA LD2 target PMT shielding","l");
	leg01->AddEntry(hhit_theta_1inpoly_gem2,"60uA LD2 target PMT shielding+30x30x2.5cm3 poly","l");
	leg01->AddEntry(hhit_theta_25cm_gem2,"60uA LD2 target without beamline ","l");
	...
	gPad->SetGridx();
      ...
      //  hhit_theta_electron->Scale(0.00000001);
       ...
       // hhit_theta_electron->Draw("HISt");	
        ...
        hhit_theta_25cm_electron->Scale(0.00000001);
        hhit_theta_25cm_electron->Draw("same HIST");	
        hhit_theta_35cm_electron->SetLineColor(4);	
        hhit_theta_35cm_electron->Scale(0.00000001);
        hhit_theta_35cm_electron->Draw("same HIST");	
        hhit_theta_1inpoly_electron->SetLineColor(6);	
        hhit_theta_1inpoly_electron->Scale(0.00000001);
        hhit_theta_1inpoly_electron->Draw("same HIST");	
	TLegend *leg21 = new TLegend(0.4,0.73,0.8,0.9);
	leg21->AddEntry(hhit_theta_45cm_electron,"60uA LD2 target ","l");
	leg21->AddEntry(hhit_theta_35cm_electron,"60uA LD2 target PMT shielding ","l");
	leg21->AddEntry(hhit_theta_1inpoly_electron,"60uA LD2 target PMT shielding+30x30x2.5cm3 poly ","l");
	leg21->AddEntry(hhit_theta_25cm_electron,"60uA LD2 target without beamline","l");
 ...
 //       hhit_theta_gem2_electron->Scale(0.00000001);
  ...
  //      hhit_theta_gem2_electron->Draw("HISt");	
        ...
        hhit_theta_25cm_gem2_electron->Scale(0.00000001);
        hhit_theta_25cm_gem2_electron->Draw("same HISt");	
        hhit_theta_35cm_gem2_electron->SetLineColor(4);	
        hhit_theta_35cm_gem2_electron->Scale(0.00000001);
        hhit_theta_35cm_gem2_electron->Draw("same HISt");	
        hhit_theta_1inpoly_gem2_electron->SetLineColor(6);	
        hhit_theta_1inpoly_gem2_electron->Scale(0.00000001);
        hhit_theta_1inpoly_gem2_electron->Draw("same HISt");	
	TLegend *leg201 = new TLegend(0.4,0.73,0.8,0.9);
	leg201->AddEntry(hhit_theta_45cm_gem2_electron,"60uA LD2 target ","l");
	leg201->AddEntry(hhit_theta_35cm_gem2_electron,"60uA LD2 target PMT shielding ","l");
	leg201->AddEntry(hhit_theta_1inpoly_gem2_electron,"60uA LD2 target PMT shielding+30x30x2.5cm3 poly ","l");
	leg201->AddEntry(hhit_theta_25cm_gem2_electron,"60uA LD2 target without beamline","l");
	...
	hhit_Edepgem1_electron_35cm->SetLineColor(4);
        hhit_Edepgem1_electron_35cm->Scale(0.00000001);
	hhit_Edepgem1_electron_35cm->Draw("same HIST");
	hhit_Edepgem1_electron_1inpoly->SetLineColor(6);
        hhit_Edepgem1_electron_1inpoly->Scale(0.00000001);
	hhit_Edepgem1_electron_1inpoly->Draw("same HIST");
        double rate_Edepgem1_electron_1inpoly= hhit_Edepgem1_electron_1inpoly->Integral();
	...
	leg11->AddEntry(hhit_Edepgem1_electron_45cm,Form("60uA LD2 target ; rate=%f MHz/cm2",rate_Edepgem1_electron_45cm),"l");
	leg11->AddEntry(hhit_Edepgem1_electron_35cm,Form("60uA LD2 target PMT shielding; rate=%f MHz/cm2",rate_Edepgem1_electron_35cm),"l");
	leg11->AddEntry(hhit_Edepgem1_electron_1inpoly,Form("60uA LD2 target PMT shielding+30x30x2.5cm3 poly; rate=%f MHz/cm2",rate_Edepgem1_electron_1inpoly),"l");
	leg11->AddEntry(hhit_Edepgem1_electron_25cm,Form("60uA LD2 target without beamline; rate=%f MHz/cm2",rate_Edepgem1_electron_25cm),"l");
...
//	hhit_Edepgem2_electron->Draw("HIST");
	...
	hhit_Edepgem2_electron_35cm->SetLineColor(4);
        hhit_Edepgem2_electron_35cm->Scale(0.00000001);
	hhit_Edepgem2_electron_35cm->Draw("same HIST");
	...
	leg31->AddEntry(hhit_Edepgem2_electron_45cm,Form("60uA LD2 target; rate=%f MHz/cm2",rate_Edepgem2_electron_45cm),"l");
	leg31->AddEntry(hhit_Edepgem2_electron_35cm,Form("60uA LD2 target PMT shielding; rate=%f MHz/cm2",rate_Edepgem2_electron_35cm),"l");
	leg31->AddEntry(hhit_Edepgem2_electron_1inpoly,Form("60uA LD2 target PMT shielding+30x30x2.5cm3 poly; rate=%f MHz/cm2",rate_Edepgem2_electron_35cm),"l");
	leg31->AddEntry(hhit_Edepgem2_electron_25cm,Form("60uA LD2 target without beamline; rate=%f MHz/cm2",rate_Edepgem2_electron_25cm),"l");
...
//	hhit_Edepgem1_gamma_1cmAl->Draw("same HIST");
	...
	hhit_Edepgem1_gamma_35cm->SetLineColor(4);
        hhit_Edepgem1_gamma_35cm->Scale(0.00000001);
	hhit_Edepgem1_gamma_35cm->Draw("same HIST");
        double rate_Edepgem1_gamma_35cm= hhit_Edepgem1_gamma_35cm->Integral();
	hhit_Edepgem1_gamma_1inpoly->SetLineColor(6);
        hhit_Edepgem1_gamma_1inpoly->Scale(0.00000001);
	hhit_Edepgem1_gamma_1inpoly->Draw("same HIST");
        double rate_Edepgem1_gamma_1inpoly= hhit_Edepgem1_gamma_1inpoly->Integral();
	TLegend *leg111 = new TLegend(0.12,0.7,0.5,0.88);
	leg111->AddEntry(hhit_Edepgem1_gamma_45cm,Form("60uA LD2 target;rate %f MHz/cm2",rate_Edepgem1_gamma_45cm),"l");
	leg111->AddEntry(hhit_Edepgem1_gamma_35cm,Form("60uA LD2 target PMT shielding;rate %f MHz/cm2",rate_Edepgem1_gamma_35cm),"l");
	leg111->AddEntry(hhit_Edepgem1_gamma_1inpoly,Form("60uA LD2 target PMT shielding+30x30x2.5cm3;rate %f MHz/cm2",rate_Edepgem1_gamma_1inpoly),"l");
	leg111->AddEntry(hhit_Edepgem1_gamma_25cm,Form("60uA LD2 target without beamline; rate %f MHz/cm2",rate_Edepgem1_gamma_25cm),"l");
...
//	hhit_Edepgem2_gamma->Draw("HIST");
	...
	hhit_Edepgem2_gamma_35cm->SetLineColor(4);
        hhit_Edepgem2_gamma_35cm->Scale(0.00000001);
	hhit_Edepgem2_gamma_35cm->Draw("same HIST");
        double rate_Edepgem2_gamma_35cm= hhit_Edepgem2_gamma_35cm->Integral();
	hhit_Edepgem2_gamma_1inpoly->SetLineColor(6);
        hhit_Edepgem2_gamma_1inpoly->Scale(0.00000001);
	hhit_Edepgem2_gamma_1inpoly->Draw("same HIST");
        double rate_Edepgem2_gamma_1inpoly= hhit_Edepgem2_gamma_1inpoly->Integral();
	TLegend *leg41 = new TLegend(0.12,0.65,0.5,0.88);
	leg41->AddEntry(hhit_Edepgem2_gamma_45cm,Form("60uA LD2 target; rate=%f MHz/cm2",rate_Edepgem2_gamma_45cm),"l");
	leg41->AddEntry(hhit_Edepgem2_gamma_35cm,Form("60uA LD2 target; rate=%f MHz/cm2",rate_Edepgem2_gamma_35cm),"l");
	leg41->AddEntry(hhit_Edepgem2_gamma_1inpoly,Form("60uA LD2 target; rate=%f MHz/cm2",rate_Edepgem2_gamma_1inpoly),"l");
	leg41->AddEntry(hhit_Edepgem2_gamma_25cm,Form("60uA LD2 target without beamline; rate=%f MHz/cm2",rate_Edepgem2_gamma_25cm),"l");
	...
	gSystem->Exec("pdfunite ./c*.pdf ./HallC_Espectrum_full_scattering_20deg_gem1_shielding.pdf");
