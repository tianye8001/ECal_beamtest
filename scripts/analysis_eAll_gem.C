...
int analysis_eAll_gem(string inputfile_name,string runmode="trigger", bool Is_tellorig=false,string filetype="",bool Is_new=true){
	...
	TH1F *hgen_Theta_gem2=new TH1F("gen_Theta_gem2","flux events; #theta (deg); #phi (deg)",720,0,180);     
	...
	TH1F *hgen_Theta_gem1=new TH1F("gen_Theta_gem1","flux events;vertex #theta (deg); #phi (deg)",720,-180,180);     
