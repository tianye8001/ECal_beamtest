...
void plot_rate_Cer_newCh_7deg(){
	gStyle->SetOptStat(0);
	gStyle->SetPalette(1);
	TFile *f2 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pip_18deg_LD_21m_30degcut_poly/HallC_beamtest_bggen_LH2_pip_18deg_LD_21m_30degcut_poly_filenum69780_reduce_tree_rate_gem1_Etotalcut_40uA_Npe_add.root");
	TFile *f5 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_eAll_18deg_LD2_20m_30x30x2.5cm3_poly_beamline/HallC_beamtest_eAll_LD2_18deg_filenum9991_9.991e8_10.6GeV_shielding_30x30x2.5cm3_poly_beamline_reduce_tree_rate_gem1_Etotalcut_40uA_Q2100MeV.root");
	//TFile *f3 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_eAll_18deg_LD2_20m_30x30x2.5cm3_poly_beamline/HallC_beamtest_eAll_LD2_18deg_filenum18990_1.899e9_10.6GeV_shielding_30x30x2.5cm3_poly_beamline_reduce_tree_rate_gem1_Etotalcut_40uA_Npe.root");
	//TFile *f3 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_eAll_18deg_LD2_20m_30x30x2.5cm3_poly_beamline/HallC_beamtest_eAll_LD2_18deg_filenum8999_8.999e8_10.6GeV_shielding_30x30x2.5cm3_poly_beamline_reduce_tree_rate_gem1_Etotalcut_40uA_Npe.root");
	TFile *f3 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_eAll_18deg_LD2_20m_30x30x2.5cm3_poly_beamline/HallC_beamtest_eAll_LD2_18deg_filenum9991_9.991e8_10.6GeV_shielding_30x30x2.5cm3_poly_beamline_reduce_tree_rate_gem1_Etotalcut_40uA_Q210MeV_Npe.root");
	//TFile *f3 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_eAll_18deg_LD2_20m_30x30x2.5cm3_poly_beamline/HallC_beamtest_eAll_LD2_18deg_filenum18990_1.899e9_10.6GeV_shielding_30x30x2.5cm3_poly_beamline_reduce_tree_rate_gem1_Etotalcut_40uA_Npe.root");
	//TFile *f4 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pi0_18deg_LD_21m_30degcut_poly/HallC_beamtest_bggen_LH2_pi0_18deg_LD_21m_30degcut_poly_filenum35930_reduce_tree_rate_gem1_Etotalcut_40uA_Npe_add.root");
	TFile *f4 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_eAll_18deg_LD2_20m_30x30x2.5cm3_poly_beamline/HallC_beamtest_eAll_LD2_18deg_filenum18990_10.6GeV_shielding_30x30x2.5cm3_poly_beamline_reduce_tree_rate_40uA_Npe_test.root");
	TFile *f8 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_18deg_LD2_r20m_shielding_30x30x2.54cm3_poly/HallC_beamtest_BeamOnTarget_1.1964e9_40uA_4SCs_18deg_r20m_LD2_shielding_30x30x2.54cm3_new_reduce_tree_rate_gem1_Etotalcut_40uA_Q2100MeV.root");
	TFile *f18 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pim_18deg_LD_21m_30degcut_poly/HallC_beamtest_bggen_LH2_pim_18deg_LD_21m_30degcut_poly_filenum45760_reduce_tree_rate_gem1_Etotalcut_40uA_Npe_add.root");
	...
	TTree *tree_beam_eAll = (TTree*) f5->Get("T"); //abs(phicut) <5 deg
...
//LASPD
	...
	TH1F *preshower_beam_gamma_hist = (TH1F*)gROOT->FindObject("preshower_beam_gamma");*/
        ...
        tree_SC1_e->Draw("ShowerSum>>shower_e(1000,0,1000)","rate*(ShowerSum>423 )","goff");
	TH1F *shower_e_hist = (TH1F*)gROOT->FindObject("shower_e");
        tree_SC1_electron->Draw("ShowerSum>>shower_electron(1000,0,1000)","rate*(ShowerSum>423)","goff");
	TH1F *shower_electron_hist = (TH1F*)gROOT->FindObject("shower_electron");
        tree_SC1_gamma->Draw("ShowerSum>>shower_gamma(1000,0,1000)","rate*(ShowerSum>423)","goff");
	TH1F *shower_gamma_hist = (TH1F*)gROOT->FindObject("shower_gamma");
        tree_beam->Draw("ShowerSum>>shower_beam(1000,0,1000)","rate*(ShowerSum>423)","goff");
	TH1F *shower_beam_hist = (TH1F*)gROOT->FindObject("shower_beam");
        tree_beam_gamma->Draw("ShowerSum>>shower_beam_gamma(1000,0,1000)","rate*(ShowerSum>423)","goff");
	TH1F *shower_beam_gamma_hist = (TH1F*)gROOT->FindObject("shower_beam_gamma");
        tree_beam_eAll->Draw("ShowerSum>>shower_beam_eall(1000,0,1000)","rate*(ShowerSum>423)","goff");
	TH1F *shower_beam_eAll_hist = (TH1F*)gROOT->FindObject("shower_beam_eall");
	...
	TH1F *GEM00_beam_hist = (TH1F*)gROOT->FindObject("GEM00_beam");
        tree_pip->Draw("ShowerSum>>shower_pip(4000,0,4230)","rate*(ShowerSum>4)","goff");
	TH1F *shower_pip_hist = (TH1F*)gROOT->FindObject("shower_pip");
        tree_pim->Draw("ShowerSum>>shower_pim(4000,0,4230)","rate*(ShowerSum>4)","goff");
	TH1F *shower_pim_hist = (TH1F*)gROOT->FindObject("shower_pim");
        tree_pi0->Draw("ShowerSum>>shower_pi0(4000,0,4230)","rate*( ShowerSum>4)","goff");
	TH1F *shower_pi0_hist = (TH1F*)gROOT->FindObject("shower_pi0");
        tree_eAll->Draw("ShowerSum>>shower_eAll(4000,0,4230)","rate*(ShowerSum>4)","goff");
	TH1F *shower_eAll_hist = (TH1F*)gROOT->FindObject("shower_eAll");
        tree_beam->Draw("ShowerSum>>shower_beam(4000,0,4230)","rate*(ShowerSum>4)","goff");
	TH1F *shower_beam_hist = (TH1F*)gROOT->FindObject("shower_beam");
        tree_pip->Draw("Npesum>>Npesum_pip(423,0,100)","rate*(ShowerSum>4)","goff");
	TH1F *Npesum_pip_hist = (TH1F*)gROOT->FindObject("Npesum_pip");
        tree_pim->Draw("Npesum>>Npesum_pim(423,0,100)","rate*(ShowerSum>4)","goff");
	TH1F *Npesum_pim_hist = (TH1F*)gROOT->FindObject("Npesum_pim");
        tree_pi0->Draw("Npesum>>Npesum_pi0(423,0,100)","rate*( ShowerSum>4)","goff");
	TH1F *Npesum_pi0_hist = (TH1F*)gROOT->FindObject("Npesum_pi0");
        tree_eAll->Draw("Npesum>>Npesum_eAll(423,0,100)","rate*(ShowerSum>4)","goff");
	TH1F *Npesum_eAll_hist = (TH1F*)gROOT->FindObject("Npesum_eAll");
        tree_beam->Draw("Npesum>>Npesum_beam(423,0,100)","rate*(ShowerSum>4)","goff");
	TH1F *Npesum_beam_hist = (TH1F*)gROOT->FindObject("Npesum_beam");
  ...
  leg28->Draw("text same");*/
	...
	gPad->SetLogy();
        ...
        shower_beam_hist->GetYaxis()->SetRangeUser(1e-5,1e2);
        ...
        shower_beam_eAll_hist->SetLineColor(2);
        shower_beam_eAll_hist->Scale(0.000667);
        shower_beam_eAll_hist->Rebin(rebinfac);
        //shower_beam_eAll_hist->Draw("same HIST");
        double rate_beam_eAll_shower= shower_beam_eAll_hist->Integral()/1e0;
  ...
  //leg29->AddEntry(shower_beam_eAll_hist,Form("from eAll; total rate=%f kHz",rate_beam_eAll_shower),"l");
  ...
  leg49->AddEntry(Etotal_beam_hist,Form("from 423 MeV #gamma; #frac{all}{1e0}=%f ",rate_proton_Etotal),"l");
  leg49->AddEntry(Etotal_beam_e_hist,Form("e^{#pm} from 400 MeV #gamma; #frac{e^{#pm}}{1e0}=%f ",rate_beam_e_Etotal),"l");
  leg49->AddEntry(Etotal_e_hist,Form("e^{#pm} from 423 MeV #gamma; #frac{e^{#pm}}{1e0}=%f ",rate_e_Etotal),"l");
  leg49->AddEntry(Etotal_beam_gamma_hist,Form("#gamma from 400 MeV #gamma; #frac{#gamma}{1e0}=%f ",rate_beam_gamma_Etotal),"l");
  leg49->AddEntry(Etotal_gamma_hist,Form("#gamma from 423 MeV #gamma; #frac{#gamma}{1e0}=%f ",rate_gamma_Etotal),"l");
  ...
  leg91->Draw("text same");*/
	...
	gSystem->Exec("pdfunite ./c*.pdf ./HallC_comparison_Edep_rate_18deg_21m_40uA_TS4cut_ShowerSum.pdf");
