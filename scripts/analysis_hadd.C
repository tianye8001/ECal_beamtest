...
int analysis_hadd(string inputfile_name,string runmode="trigger", bool Is_tellorig=false,string filetype="",bool Is_new=true){
...
// 	TH1F *hhit_Pec_proton=new TH1F("hit_Pec_proton","EC;P(GeV);rate(Hz)",1100,0,11);	
	...
	TH1F *hec_Eend_shower=new TH1F("ec_Eend_shower","EC;Eend [MeV]",200,0,500);
