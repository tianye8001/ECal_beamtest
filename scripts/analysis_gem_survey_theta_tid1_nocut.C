...
int analysis_gem_survey_theta_tid1_nocut(string inputfile_name,string runmode="trigger",bool Is_new=true){
	...
	sprintf(outputfile_name, "%s_output_preshower_theta_rate_tid1_finerbin.root",the_filename);
