...
void plot_EC_newbeamline_sangle(){
gStyle->SetOptStat(0);
gStyle->SetPalette(1);
  ...
  TFile *f13 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_eAll_sangle/HallC_beamtest_eAll_sangle_8deg_filenum100_output_Nphe_Q2cut_001GeV.root");
...
TFile *f8 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pim_sangle/HallC_beamtest_bggen_LH2_pim_8deg_filenum10270_output_Nphe.root");
...
TFile *f9 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pip_sangle/HallC_beamtest_bggen_LH2_pip_sangle_filenum9520_8deg_output_Nphe.root");
...
TFile *f10 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pi0_sangle/HallC_beamtest_bggen_LH2_pi0_8deg_filenum11840_output_Nphe.root");
...
gPad->SetGridy();
  ...
  hhit_E_pip_cut_LD[m]->GetXaxis()->SetTitle("prime_tid1 total_E (GeV)");
  hhit_E_pip_cut_LD[m]->GetYaxis()->SetTitle("rate (kHz)");
  hhit_E_pip_cut_LD[m]->GetXaxis()->SetRangeUser(0,10);
  hhit_E_pip_cut_LD[m]->GetYaxis()->SetRangeUser(1e-2,2e2);
  hhit_E_pip_cut_LD[m]->Draw("HIST");
...
//  hhit_E_eAll[m]->GetXaxis()->SetRangeUser(0,1.5);
 ...
 c[3]->cd(2);
  ...
  leg122->AddEntry(hhit_E_cut_eAll[2],"eAll","l");
  leg122->AddEntry(hhit_E_pip_cut_LD[2],"bggen #pi^{+}","l");
  leg122->AddEntry(hhit_E_pim_cut_LD[2],"bggen #pi^{-}","l");
...
//  hhit_p_pi0_LD[m]->Draw("same HIST");
 ...
 for(int m=0;m<9;m++){
  ...
  hhit_E_pip_LD[m]->GetXaxis()->SetTitle("total_E (GeV)");
  hhit_E_pip_LD[m]->GetYaxis()->SetTitle("rate (kHz)");
  hhit_E_pip_LD[m]->GetXaxis()->SetRangeUser(0,10);
  hhit_E_pip_LD[m]->GetYaxis()->SetRangeUser(1e-2,2e2);
  hhit_E_pip_LD[m]->Draw("HIST");
  hhit_E_pim_LD[m]->SetLineColor(1);
  hhit_E_pim_LD[m]->Scale(0.001);
  hhit_p_pim_LD[m]->GetXaxis()->SetRangeUser(0,10);
  ...
  hhit_E_pi0[m]->SetLineColor(6);
  hhit_E_pi0[m]->Scale(0.001);
  hhit_E_pi0[m]->GetXaxis()->SetRangeUser(0,10);
//  hhit_E_pi0[m]->Draw("same HIST");
}
 c[1]->cd(2);
 leg122->Draw("text same");
...
gPad->SetLogy();
 ...
 for(int a=1;a<5;a++){
    c[a]->SaveAs(Form("c%d.pdf",a));
             ...
             gSystem->Exec("pdfunite ./c*.pdf ./HallC_vertex_R_vs_Z_newbeamline_P_and_E.pdf");
