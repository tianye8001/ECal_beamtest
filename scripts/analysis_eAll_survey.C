...
int analysis_eAll_survey(string inputfile_name,string runmode="trigger", bool Is_tellorig=false,string filetype="",bool Is_new=true){
	...
	if(Is_new=true){
		cout << "this is a moved file" << endl;
	}
	...
	sprintf(outputfile_name, "%s_output_Nphe_finetime_Q2cut_100MeV.root",the_filename);
	...
	TH1F *hhit_vz[n], *hhit_z[n],*hhit_vz_cut[n],*hhit_z_cut[n],*hhit_t_cutgamma[n],*hhit_t_gamma[n],*hhit_t_cute[n];
	TH2F *hhit_vR_vs_vz[n],*hhit_R_vs_z[n],*hhit_PhiR[n],*hhit_vR_vs_vz_cut[n],*hhit_R_vs_z_cut[n],*vertexZ_vs_p_hist[n],*vertexZ_vs_p_cut_hist[n];
	TH1F *hhit_E[n],*hhit_E_mip[n],*hhit_E_photonele[n],*hhit_E_ele[n],*hhit_Edep[n],*hhit_p[n],*hhit_Ek[n],*hhit_Ec[n],*hhit_E_cut[n],*hhit_p_cut[n], *hhit_Ek_cut[n], *hhit_pid[n], *hhit_mpid[n], *hhit_procID[n];	
	for(int i=0;i<n;i++){
		char hstname[100];
	...
	TH2F *hec_Eend_2D_trigger=new TH2F("ec_Eend_2D_trigger","EC;Eend_shower;Eend_preshower",200,0,500,200,0,100);
	...
	TH1F *hec_Eend_shower_trigger1=new TH1F("ec_Eend_shower_trigger1","EC;Eend [MeV]",200,0,200);
	TH1F *hec_Eend_preshower_trigger1=new TH1F("ec_Eend_preshower_trigger1","EC;Eend_preshower [MeV]",200,0,100);
	TH1F *hec_Eend_shower_trigger2=new TH1F("ec_Eend_shower_trigger2","EC;Eend [MeV]",200,0,200);
	TH1F *hec_Eend_preshower_trigger2=new TH1F("ec_Eend_preshower_trigger2","EC;Eend_preshower [MeV]",200,0,100);
	TH1F *hec_Eend_shower_trigger3=new TH1F("ec_Eend_shower_trigger3","EC;Eend [MeV]",200,0,200);
	...
	for(long int i=0;i<N_events;i++){	  		
		...
		if(userVar005->at(0)>0.1){ //Q2cut for small angle 
