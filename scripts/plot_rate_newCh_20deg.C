...
void plot_rate_newCh(){
	gStyle->SetOptStat(0);
	gStyle->SetPalette(1);
	TFile *f5 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pip_20deg_LD/HallC_beamtest_bggen_LD2_pip_20deg_filenum1300_reduce_tree_rate_gem_Etotalcut.root");
	...
	TFile *f4 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pim_20deg_LD/HallC_beamtest_bggen_LD2_pim_20deg_filenum1170_reduce_tree_rate_gem_Etotalcut.root");
	TFile *f6 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pi0_20deg_LD/HallC_beamtest_bggen_LD2_pi0_20deg_filenum1300_reduce_tree_rate_gem_Etotalcut.root");
	//TFile *f7 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_eAll_20deg_LD2/HallC_beamtest_eAll_LD2_20deg_filenum993_4.965e7_reduce_tree_rate_gem_Etotalcut_1GeV.root");
	TFile *f7 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_eAll_20deg_LD2/HallC_beamtest_eAll_LD2_20deg_filenum1215_1.215e8_reduce_tree_rate_Etotalcut.root");
	...
	TFile *f8 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_20deg_LD2_r20m/HallC_beamtest_BeamOnTarget_4.4155e9_8deg_80uA_5x10SC_20deg_r20m_reduce_tree_rate_preshower_Etotalcut_e.root");
	TFile *f18 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_20deg_LD2_r20m_5cmpoly_30x30/HallC_beamtest_BeamOnTarget_5e8_80uA_5x10SC_20deg_r20m_5cmpoly_reduce_tree_rate_preshower_Etotalcut_e.root");
	TFile *f9 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_20deg_LD2_r20m/HallC_beamtest_BeamOnTarget_4.4155e9_8deg_80uA_5x10SC_20deg_r20m_reduce_tree_rate_preshower_Etotalcut_gamma.root");
	TFile *f19 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_20deg_LD2_r20m_5cmpoly_30x30/HallC_beamtest_BeamOnTarget_5e8_80uA_5x10SC_20deg_r20m_5cmpoly_reduce_tree_rate_preshower_Etotalcut_gamma.root");
	TFile *f10 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_20deg_LD2_r20m/HallC_beamtest_BeamOnTarget_4.4155e9_8deg_80uA_5x10SC_20deg_r20m_reduce_tree_rate_Etotalcut.root");
	TFile *f11 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_20deg_LD2_r20m/HallC_beamtest_BeamOnTarget_4.4155e9_8deg_80uA_5x10SC_20deg_r20m_reduce_tree_rate_preshower_Etotalcut_all.root");
//	TFile *f9 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_dummy_80uA/HallC_beamtest_BeamOnTarget_1e10_dummy_80uA_newCh_reduce_tree_rate_test.root");
	...
	TTree *tree_beam_poly = (TTree*) f18->Get("T");
	TTree *tree_beam_poly_gamma = (TTree*) f19->Get("T");
	...
	TH1F *shower_beam_dum_hist = (TH1F*)gROOT->FindObject("shower_beam_dum");
        tree_beam_all->Draw("ShowerSum>>shower_beam_all(300,0,1500)","rate*( ShowerSum>0)","goff");
	...
	TH1F *shower_beam_neutron_hist = (TH1F*)gROOT->FindObject("shower_beam_neutron");
        tree_beam_poly->Draw("ShowerSum>>shower_beam_poly(300,0,1500)","rate*( ShowerSum>0)","goff");
	TH1F *shower_beam_poly_hist = (TH1F*)gROOT->FindObject("shower_beam_poly");
        tree_beam_poly_gamma->Draw("ShowerSum>>shower_beam_poly_gamma(300,0,1500)","rate*( ShowerSum>0)","goff");
	TH1F *shower_beam_poly_gamma_hist = (TH1F*)gROOT->FindObject("shower_beam_poly_gamma");
	...
	gPad->SetLogy();
        ...
        shower_beam_hist->SetTitle("10.6 GeV 60 #muA LD2 target 20 degrees ");
        ...
        shower_beam_poly_hist->SetLineColor(38);
        shower_beam_poly_hist->Scale(0.001);
  //      shower_beam_poly_hist->Draw("same HIST");
        double rate_beam_poly= shower_beam_poly_hist->Integral();
        shower_beam_poly_gamma_hist->SetLineColor(kBlue-3);
        shower_beam_poly_gamma_hist->Scale(0.001);
  //      shower_beam_poly_gamma_hist->Draw("same HIST");
        double rate_beam_poly_gamma= shower_beam_poly_gamma_hist->Integral();
...
//  leg8->AddEntry(shower_beam_poly_hist,Form("e^{#pm} at prelead from BeamOnTarget C-foil full 30x30x5 cm^{3} poly; total rate=%f kHz",rate_beam_poly),"l");
  leg8->AddEntry(shower_beam_dum_hist,Form("#gamma at prelead from BeamOnTarget C-foil full; total rate=%f kHz",rate_beam),"l");
//  leg8->AddEntry(shower_beam_poly_gamma_hist,Form("#gamma at prelead from BeamOnTarget C-foil full 30x30x5 cm^{3} poly; total rate=%f kHz",rate_beam_poly_gamma),"l");
