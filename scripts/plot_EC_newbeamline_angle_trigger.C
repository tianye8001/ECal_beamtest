...
void plot_EC_newbeamline_angle_trigger(){
gStyle->SetOptStat(0);
gStyle->SetPalette(1);
  ...
  TFile *f13 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_eAll/output/HallC_bggen_LH2_beamtest_full_eAll_filenum100_1e8_newbeamline_output_Nphe.root");
...
TFile *f7 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pip_sangle/HallC_beamtest_bggen_LH2_pip_sangle_filenum9530_35deg_output_Nphe.root");
...
//TFile *f8 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pim/output/HallC_beamtest_bggen_LH2_pim_newbeamline_filenum9220_output_Nphe.root");
TFile *f8 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pip_sangle/HallC_beamtest_bggen_LH2_pip_sangle_filenum9530_22deg_output_Nphe.root");
...
TFile *f9 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pip/HallC_beamtest_bggen_LH2_pip_newbeamline_filenum14110_output_Nphe.root");
...
//TFile *f10 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pi0/output/HallC_beamtest_bggen_LH2_newbeamline_pi0_filenum12070_output_Nphe.root");
...
TFile *f32 = new TFile("HallC_beamtest_bggen_LH2_nobeamline_pi0_filenum15660_output_positron_preshower_all_test.root");
TFile *f11 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pip_sangle/HallC_beamtest_bggen_LH2_pip_sangle_filenum9530_45deg_output_Nphe.root");
...
TH2F *EC_shower_2D_proton_trigger;
 ...
 EC_shower_pip2 = (TH1F*)f11->Get("ec_Eend_shower");
 ...
 EC_preshower_pip2 = (TH1F*)f11->Get("ec_Eend_preshower");
 ...
 EC_shower_pip2_trigger = (TH1F*)f11->Get("ec_Eend_shower_trigger");
 ...
 EC_preshower_pip2_trigger = (TH1F*)f11->Get("ec_Eend_preshower_trigger");
...
gPad->SetGridy();
gPad->SetLogy();
 EC_shower_pip_trigger->Scale(0.001);
 EC_shower_pip_trigger->Rebin(rebinfac);
 EC_shower_pip_trigger->GetYaxis()->SetRangeUser(1e-3,2e2);
 EC_shower_pip_trigger->GetXaxis()->SetRangeUser(0,100);
 EC_shower_pip_trigger->GetYaxis()->SetTitle("rate (kHz)");
 EC_shower_pip_trigger->SetLineColor(2);
 EC_shower_pip_trigger->SetTitle("shower Edep");
 EC_shower_pip_trigger->Draw("HIST");
double rate_pip= EC_shower_pip_trigger->Integral();
 EC_shower_pim_trigger->Scale(0.001);
 EC_shower_pim_trigger->Rebin(rebinfac);
 EC_shower_pim_trigger->SetLineColor(1);
 EC_shower_pim_trigger->Draw(" same HIST");
double rate_pim= EC_shower_pim_trigger->Integral();
 EC_shower_pi0_trigger->Scale(0.001);
 EC_shower_pi0_trigger->Rebin(rebinfac);
 EC_shower_pi0_trigger->SetLineColor(kGreen+3);
 EC_shower_pi0_trigger->Draw(" same HIST");
double rate_pi0= EC_shower_pi0_trigger->Integral();
 EC_shower_eAll_trigger->SetLineColor(4);
 EC_shower_eAll_trigger->Rebin(rebinfac);
 EC_shower_eAll_trigger->Draw(" same HIST");
double rate_eAll= EC_shower_eAll_trigger->Integral();
 EC_shower_eDIS->SetLineColor(6);
 EC_shower_eDIS->Rebin(rebinfac);
// EC_shower_eDIS->Draw(" same HIST");
 EC_shower_proton_trigger->Scale(0.001);
 EC_shower_proton_trigger->SetLineColor(6);
 EC_shower_proton_trigger->Rebin(rebinfac);
 EC_shower_proton_trigger->Draw(" same HIST");
double rate_proton= EC_shower_proton_trigger->Integral();
 EC_shower_pip2_trigger->Scale(0.001);
 EC_shower_pip2_trigger->Rebin(rebinfac);
 EC_shower_pip2_trigger->SetLineColor(7);
 EC_shower_pip2_trigger->Draw(" same HIST");
double rate_pip2= EC_shower_pip2_trigger->Integral();
  TLegend *leg8 = new TLegend(0.45,0.68,0.8,0.88);
  leg8->AddEntry(EC_shower_eAll_trigger,Form("eAll*1000 82.2 deg; total rate=%f Hz",rate_eAll),"l");
//  leg8->AddEntry(EC_shower_eDIS,"eDIS*1000","l");
  leg8->AddEntry(EC_shower_pim_trigger,Form("bggen #pi^{+} 22 deg; total rate=%f kHz",rate_pim),"l");
  leg8->AddEntry(EC_shower_pip_trigger,Form("bggen #pi^{+} 82.2 deg; total rate=%f kHz",rate_pip),"l");
  leg8->AddEntry(EC_shower_pip2_trigger,Form("bggen #pi^{+} 45 deg; total rate=%f kHz",rate_pip2),"l");
  leg8->AddEntry(EC_shower_pi0_trigger,Form("bggen #pi^{+} 8 deg; total rate=%f kHz",rate_pi0),"l");
  leg8->AddEntry(EC_shower_proton_trigger,Form("bggen #pi^{+} 35 deg; total rate=%f kHz",rate_proton),"l");
 ...
 c[7] = new TCanvas("c[7]","c[7]",1000,800);
  ...
  gPad->SetGridy();
  gPad->SetLogy();
 EC_preshower_pip_trigger->SetLineColor(2);
 EC_preshower_pip_trigger->Scale(0.001);
 EC_preshower_pip_trigger->GetYaxis()->SetRangeUser(1e-3,2e2);
 EC_preshower_pip_trigger->GetXaxis()->SetRangeUser(0,50);
 EC_preshower_pip_trigger->GetYaxis()->SetTitle("rate (kHz)");
 EC_preshower_pip_trigger->SetTitle("preshower Edep");
 EC_preshower_pip_trigger->Draw("HIST");
double rate_pip_pre= EC_preshower_pip_trigger->Integral();
 EC_preshower_pim_trigger->Scale(0.001);
 EC_preshower_pim_trigger->SetLineColor(1);
 EC_preshower_pim_trigger->Draw("same HIST");
double rate_pim_pre= EC_preshower_pim_trigger->Integral();
 EC_preshower_pi0_trigger->Scale(0.001);
 EC_preshower_pi0_trigger->SetLineColor(kGreen+3);
 EC_preshower_pi0_trigger->Draw("same HIST");
double rate_pi0_pre= EC_preshower_pi0_trigger->Integral();
 EC_preshower_eAll_trigger->SetLineColor(4);
// EC_preshower_eAll->Scale(1000);
 //EC_preshower_eAll->Rebin(rebinfac);
 EC_preshower_eAll_trigger->Draw(" same HIST");
double rate_eAll_pre= EC_preshower_eAll_trigger->Integral();
 EC_preshower_proton_trigger->Scale(0.001);
 EC_preshower_proton_trigger->SetLineColor(6);
 EC_preshower_proton_trigger->Rebin(rebinfac);
 EC_preshower_proton_trigger->Draw(" same HIST");
double rate_proton_pre= EC_preshower_proton_trigger->Integral();
 EC_preshower_pip2_trigger->Scale(0.001);
 EC_preshower_pip2_trigger->Rebin(rebinfac);
 EC_preshower_pip2_trigger->SetLineColor(7);
 EC_preshower_pip2_trigger->Draw(" same HIST");
double rate_pip2_pre= EC_preshower_pip2_trigger->Integral();
  TLegend *leg1 = new TLegend(0.45,0.6,0.8,0.88);
  leg1->AddEntry(EC_preshower_eAll_trigger,Form("eAll*1000 82.2 deg; total rate=%f Hz",rate_eAll_pre),"l");
  leg1->AddEntry(EC_preshower_proton_trigger,Form("bggen #pi^{+} 35 deg; total rate=%f kHz",rate_proton_pre),"l");
  leg1->AddEntry(EC_preshower_pim_trigger,Form("bggen #pi^{+} 22 deg; total rate=%f kHz",rate_pim_pre),"l");
  leg1->AddEntry(EC_preshower_pip_trigger,Form("bggen #pi^{+} 82.2 deg; total rate=%f kHz",rate_pip_pre),"l");
  leg1->AddEntry(EC_preshower_pip2_trigger,Form("bggen #pi^{+} 45 deg; total rate=%f kHz",rate_pip_pre),"l");
  leg1->AddEntry(EC_preshower_pi0_trigger,Form("bggen #pi^{+} 8 deg; total rate=%f kHz",rate_pi0_pre),"l");
...
gPad->SetGridy();
  ...
  hhit_p_pip_cut_LD[m]->GetXaxis()->SetTitle("FP_tid1 momentum (GeV)");
  hhit_p_pip_cut_LD[m]->GetYaxis()->SetTitle("rate (kHz)");
  hhit_p_pip_cut_LD[m]->GetXaxis()->SetRangeUser(0,1.5);
 ...
 c[4]->cd(2);
  ...
  leg12->AddEntry(hhit_p_cut_eAll[2],"eAll*1000","l");
...
gPad->SetGridy();
  ...
  hhit_E_pip_LD[m]->GetXaxis()->SetTitle("FP total_E (GeV)");
  hhit_E_pip_LD[m]->GetYaxis()->SetTitle("rate (kHz)");
  hhit_E_pip_LD[m]->GetXaxis()->SetRangeUser(0,1.5);
  hhit_E_pip_LD[m]->Draw("HIST");
  hhit_E_pip_LD_nob[m]->SetLineColor(7);
  hhit_E_pip_LD_nob[m]->GetXaxis()->SetRangeUser(0,1.5);
  hhit_E_pip_LD_nob[m]->Scale(0.001);
  hhit_E_pip_LD_nob[m]->Draw("same HIST");
  hhit_E_pim_LD[m]->SetLineColor(1);
  hhit_E_pim_LD[m]->Scale(0.001);
  hhit_E_pim_LD[m]->GetXaxis()->SetRangeUser(0,1.5);
  hhit_E_pim_LD[m]->Draw("same HIST");
  hhit_E_pim_LD_nob[m]->SetLineColor(8);
  hhit_E_pim_LD_nob[m]->Scale(0.001);
  hhit_E_pim_LD_nob[m]->GetXaxis()->SetRangeUser(0,1.5);
  hhit_E_pim_LD_nob[m]->Draw("same HIST");
  hhit_E_proton[m]->SetLineColor(6);
  hhit_E_proton[m]->Scale(0.001);
  hhit_E_proton[m]->GetXaxis()->SetRangeUser(0,1.5);
  hhit_E_proton[m]->Draw("same HIST");
  hhit_E_proton_nob[m]->SetLineColor(9);
  hhit_E_proton_nob[m]->Scale(0.001);
  hhit_E_proton_nob[m]->GetXaxis()->SetRangeUser(0,1.5);
  hhit_E_proton_nob[m]->Draw("same HIST");
  hhit_E_eAll[m]->SetLineColor(4);
  //hhit_E_eAll[m]->Scale(1000);
  hhit_E_eAll[m]->GetXaxis()->SetRangeUser(0,1.5);
  hhit_E_eAll[m]->Draw("same HIST");
  hhit_E_eAll_nob[m]->SetLineColor(46);
  hhit_E_eAll_nob[m]->GetXaxis()->SetRangeUser(0,1.5);
  hhit_E_eAll_nob[m]->Draw("same HIST");
  hhit_E_pi0[m]->SetLineColor(41);
  hhit_E_pi0[m]->Scale(0.001);
  hhit_E_pi0[m]->GetXaxis()->SetRangeUser(0,1.5);
  hhit_E_pi0[m]->Draw("same HIST");
  hhit_E_pi0_nob[m]->SetLineColor(kOrange+3);
  hhit_E_pi0_nob[m]->Scale(0.001);
  hhit_E_pi0_nob[m]->GetXaxis()->SetRangeUser(0,1.5);
  hhit_E_pi0_nob[m]->Draw("same HIST");
  }
 c[3]->cd(2);
  TLegend *leg122 = new TLegend(0.45,0.5,0.8,0.88);
  leg122->AddEntry(hhit_p_eAll[2],"eAll*1000","l");
  leg122->AddEntry(hhit_p_pip_LD[2],"bggen #pi^{+}","l");
  leg122->AddEntry(hhit_p_pim_LD[2],"bggen #pi^{-}","l");
  leg122->AddEntry(hhit_p_proton[2],"bggen proton","l");
  leg122->AddEntry(hhit_p_pi0[2],"bggen #pi^{0}","l");
...
gPad->SetGridy();
 gPad->SetLogy();
  ...
  hhit_p_pip_LD[m]->GetXaxis()->SetRangeUser(0,1.5);
 ...
 for(int m=0;m<9;m++){
  ...
  gPad->SetGridy();
  gPad->SetLogy();
  hhit_E_pi0_cutr[m]->SetLineColor(kOrange+3);
  hhit_E_pi0_cutr[m]->Scale(0.001);
  hhit_E_pi0_cutr[m]->GetXaxis()->SetTitle("FP total_E (GeV)");
  hhit_E_pi0_cutr[m]->GetYaxis()->SetTitle("rate (kHz)");
  hhit_E_pi0_cutr[m]->GetXaxis()->SetRangeUser(0,1.5);
  hhit_E_pi0_cutr[m]->Draw("HIST");
  hhit_E_pi0_cut_nob[m]->SetLineColor(2);
  hhit_E_pi0_cut_nob[m]->Scale(0.001);
  hhit_E_pi0_cut_nob[m]->GetXaxis()->SetRangeUser(0,1.5);
  hhit_E_pi0_cut_nob[m]->Draw("same HIST");
  hhit_E_pi0_cute[m]->SetLineColor(4);
  hhit_E_pi0_cute[m]->Scale(0.001);
  hhit_E_pi0_cute[m]->GetXaxis()->SetRangeUser(0,1.5);
  hhit_E_pi0_cute[m]->Draw("same HIST");
  hhit_E_pi0_cute_nob[m]->SetLineColor(6);
  hhit_E_pi0_cute_nob[m]->Scale(0.001);
  hhit_E_pi0_cute_nob[m]->GetXaxis()->SetRangeUser(0,1.5);
  hhit_E_pi0_cute_nob[m]->Draw("same HIST");
  hhit_E_pi0_cut[m]->SetLineColor(1);
  hhit_E_pi0_cut[m]->Scale(0.001);
  hhit_E_pi0_cut[m]->GetXaxis()->SetRangeUser(0,1.5);
  hhit_E_pi0_cut[m]->Draw("same HIST");
  hhit_E_pi0_cutr_nob[m]->SetLineColor(3);
  hhit_E_pi0_cutr_nob[m]->Scale(0.001);
  hhit_E_pi0_cutr_nob[m]->GetXaxis()->SetRangeUser(0,1.5);
  hhit_E_pi0_cutr_nob[m]->Draw("same HIST");
}
 c[1]->cd(2);
...
gPad->SetLogy();
  ...
  hit_R_vs_vz_pim_nob[m]->SetMarkerColor(2); 
