...
int fileReducer_beamtest_gem_survey_pim(int numberOfFile=1, double event_actual=1, int evgen=1){
 const int t=2;
        TFile *file[t];
...
//	TFile* outFile = new TFile(Form("%s_reduce_tree_rate_gem1_Etotalcut_40uA_Npe_debug.root",the_filename), "RECREATE");
	...
	TFile* outFile = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pim_18deg_LD_21m_30degcut_poly/HallC_beamtest_bggen_LH2_pim_18deg_LD_21m_30degcut_poly_filenum_reduce_tree_rate_40uA_Npe_test.root", "RECREATE");
