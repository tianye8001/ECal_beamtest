...
void plot_gem_BeamOnTarget_BLshielding_E_right_fork_debug(){
	...
	TFile *f2 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_vacuum_CCvacuum_20deg/HallC_beamtest_BeamOnTarget_1e10_8deg_80uA_target_vacuum_CCvacuum_right_20deg_output_gem_gammaE_pzcut.root");
//	TFile *f2 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_BLshielding_far/HallC_beamtest_BeamOnTarget_5e8_8deg_80uA_target_right_step_BLshielding2x4x190_far_output_gem_gammaE_pzcut.root");
	...
	TFile *f12 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_vacuum_CCvacuum_20deg/HallC_beamtest_BeamOnTarget_1e10_8deg_80uA_target_vacuum_CCvacuum_right_20deg_output_gem_electronE_pzcut.root");
...
//	TFile *f14 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_BLshielding_GEM4cmAl/HallC_beamtest_BeamOnTarget_3.85e8_8deg_80uA_target_right_step_BLshielding2x4x190_4cmAl_output_gem_electronE_pzcut.root");
	...
	TFile *f7 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_vacuum_CCvacuum_30deg/HallC_beamtest_BeamOnTarget_1e10_8deg_80uA_target_vacuum_CCvacuum_right_30deg_output_gem_gammaE_pzcut.root");
	...
	TFile *f17 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_vacuum_CCvacuum_20deg_11GeV/HallC_beamtest_BeamOnTarget_1e10_8deg_80uA_target_vacuum_CCvacuum_20deg_Eb11GeV_output_gem_electronE_pzcut.root");
...
//	TFile *f7 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_vacuum_CCvacuum/HallC_beamtest_BeamOnTarget_1e10_8deg_80uA_target_step_right_output_gem_gammaE_pzcut.root");
	TFile *f4 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_vacuum_CCvacuum_25deg/HallC_beamtest_BeamOnTarget_1e10_8deg_80uA_target_vacuum_CCvacuum_right_25deg_output_gem_gammaE_pzcut.root");
	...
	TFile *f5 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_vacuum_CCvacuum_15deg/HallC_beamtest_BeamOnTarget_1e10_8deg_80uA_target_vacuum_CCvacuum_right_15deg_output_gem_gammaE_pzcut.root");
	...
	TFile *f14 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_vacuum_CCvacuum_20deg_5GeV/HallC_beamtest_BeamOnTarget_1e10_8deg_80uA_target_vacuum_CCvacuum_20deg_Eb5GeV_output_gem_electronE_pzcut.root");
	...
	TFile *f15 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_vacuum_CCvacuum_15deg/HallC_beamtest_BeamOnTarget_1e10_8deg_80uA_target_vacuum_CCvacuum_right_15deg_output_gem_electronE_pzcut.root");
	...
	TFile *f40 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_vacuum_CCvacuum_5GeV/HallC_beamtest_BeamOnTarget_1e10_8deg_80uA_target_vacuum_CCvacuum_Eb5GeV_output_gem_electronE_pzcut.root");
	TFile *f41 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_vacuum_CCvacuum_11GeV/HallC_beamtest_BeamOnTarget_1e10_8deg_80uA_target_vacuum_CCvacuum_Eb11GeV_output_gem_electronE_pzcut.root");
	TH1F *hprocid_gem1;       
	TH1F *hpf_gem1;
	TH1F *hE_gem1;
	TH1F *hpf_gem1_1cmAl;
...
/*        hhit_theta_noTB->GetYaxis()->SetTitle("rate (kHz)");	
        ...
        hhit_theta_noTB->GetYaxis()->SetRangeUser(1e0,1e6);	
       ...
       // hhit_theta_noTB->Scale(0.001);
        ...
        hhit_theta_45cm->GetYaxis()->SetTitle("rate (kHz)");	
        ...
        hhit_theta_45cm->GetYaxis()->SetRangeUser(1e0,2e6);	
	...
	leg1->AddEntry(hhit_theta_45cm,"no shielding target vacuum #theta=8deg","l");
	leg1->AddEntry(hhit_theta_35cm,"no shielding target vacuum #theta=15deg","l");
...
//	leg1->AddEntry(hhit_theta_1inpoly,Form("NoSh full=target+chamber+beamline step rate=%f kHz",rate_theta_linpoly),"l");
	leg1->AddEntry(hhit_theta_1cmAl,"no shielding target vacuum #theta=20deg  ","l");
	leg1->AddEntry(hhit_theta_25cm,"no shielding target vacuum #theta=25deg","l");
	leg1->AddEntry(hhit_theta_55cm,"no shielding target vacuum #theta=30deg","l");
	...
	gPad->SetGridx();
      //  hhit_theta_gem2->SetLineColor(6);	
       // hhit_theta_gem2->Scale(0.001);
        /*hhit_theta_gem2_noTB->GetYaxis()->SetTitle("rate (kHz)");	
        ...
        hhit_theta_gem2_noTB->GetYaxis()->SetRangeUser(1e0,1e6);	
       // hhit_theta_gem2->Draw("HISt");	
        ...
        hhit_theta_45cm_gem2->GetYaxis()->SetTitle("rate (kHz)");	
        ...
        hhit_theta_45cm_gem2->GetYaxis()->SetRangeUser(1e0,2e6);	
	...
	leg01->AddEntry(hhit_theta_45cm_gem2,"no shielding target vacuum #theta=8deg","l");
	leg01->AddEntry(hhit_theta_35cm_gem2,"no shielding target vacuum #theta=15deg","l");
...
//	leg01->AddEntry(hhit_theta_gem2_noB,"no shielding target+chamber","l");
	//leg1->AddEntry(hhit_theta,"no shielding beamline survey+old simu","l");
//	leg01->AddEntry(hhit_theta_1inpoly_gem2,Form("NoSh full=target+chamber+beamline step rate=%f kHz",rate_theta_linpoly_gem2),"l");
	leg01->AddEntry(hhit_theta_1cmAl_gem2,"no shielding target vacuum #theta=20deg ","l");
	leg01->AddEntry(hhit_theta_25cm_gem2,"no shielding target vacuum #theta=25deg","l");
	leg01->AddEntry(hhit_theta_55cm_gem2,"no shielding target vacuum #theta=30deg","l");
	...
	gPad->SetGridx();
      ...
      /*  hhit_theta_noTB_electron->GetYaxis()->SetTitle("rate (kHz)");	
      ...
      //  hhit_theta_electron->Scale(0.001);
        hhit_theta_noTB_electron->Scale(0.001);
        hhit_theta_noTB_electron->GetYaxis()->SetRangeUser(1e0,1e6);	
       // hhit_theta_electron->Draw("HISt");	
        ...
        hhit_theta_45cm_electron->GetYaxis()->SetTitle("rate (kHz)");	
	...
	leg21->AddEntry(hhit_theta_45cm_electron,"no shielding target vacuum #theta=8deg","l");
	leg21->AddEntry(hhit_theta_35cm_electron,"no shielding target vacuum #theta=15deg","l");
...
//	leg21->AddEntry(hhit_theta_1inpoly,Form("NoSh full=target+chamber+beamline step rate= %f kHz",rate_theta_1inpoly_electron),"l");
	leg21->AddEntry(hhit_theta_1cmAl_electron,"no shielding target vacuum #theta=20deg","l");
	leg21->AddEntry(hhit_theta_25cm_electron,"no shielding target vacuum #theta=25deg","l");
	leg21->AddEntry(hhit_theta_55cm_electron,"no shielding target vacuum #theta=30deg","l");
 ...
 //       hhit_theta_gem2_electron->Scale(0.001);
        /*hhit_theta_gem2_noTB_electron->GetYaxis()->SetTitle("rate (kHz)");	
        ...
        hhit_theta_gem2_noTB_electron->Scale(0.001);
        hhit_theta_gem2_noTB_electron->GetYaxis()->SetRangeUser(1e0,1e6);	
  //      hhit_theta_gem2_electron->Draw("HISt");	
        ...
        hhit_theta_gem2_noB_electron->Scale(0.001);
        ...
        hhit_theta_1inpoly_gem2_electron->Scale(0.001);
        ...
        hhit_theta_45cm_gem2_electron->GetYaxis()->SetTitle("rate (kHz)");	
        ...
        hhit_theta_45cm_gem2_electron->GetYaxis()->SetRangeUser(1e0,2e6);	
        ...
        hhit_theta_55cm_gem2_electron->Scale(0.001);
	...
	leg201->AddEntry(hhit_theta_45cm_gem2_electron,"no shielding target vacuum #theta=8deg","l");
	leg201->AddEntry(hhit_theta_35cm_gem2_electron,"no shielding target vacuum #theta=15deg","l");
	leg201->AddEntry(hhit_theta_1cmAl_gem2_electron,"no shielding target vacuum #theta=20deg","l");
	leg201->AddEntry(hhit_theta_25cm_gem2_electron,"no shielding target vacuum #theta=25deg","l");
	leg201->AddEntry(hhit_theta_55cm_gem2_electron,"no shielding target vacuum #theta=30deg","l");
	...
	hhit_Edepgem1_electron_45cm->GetYaxis()->SetTitle("rate (kHz)");
	hhit_Edepgem1_electron_45cm->SetTitle("#gamma on gem1 virtual plane");
        hhit_Edepgem1_electron_45cm->Scale(0.001);
        hhit_Edepgem1_electron_45cm->GetYaxis()->SetRangeUser(1e0,1e7);	
...
//	leg11->AddEntry(hhit_Edepgem1_electron,"no shielding beamline survey+old simu","l");
	leg11->AddEntry(hhit_Edepgem1_electron_45cm,Form("no shielding target vacuum #theta=8deg rate=%f kHz",rate_Edepgem1_electron_45cm),"l");
	leg11->AddEntry(hhit_Edepgem1_electron_35cm,Form("no shielding target vacuum #theta=15deg rate=%f kHz",rate_Edepgem1_electron_35cm),"l");
...
//	leg11->AddEntry(hhit_Edepgem1_electron_1inpoly,Form("NoSh full=target+chamber+beamline step rate %f kHz",rate_Edepgem1_electron_1inpoly),"l");
	leg11->AddEntry(hhit_Edepgem1_electron_1cmAl,Form("no shielding target vacuum #theta=20deg rate=%f kHz",rate_Edepgem1_electron_1cmAl),"l");
	leg11->AddEntry(hhit_Edepgem1_electron_25cm,Form("Nosh target vacuum #theta=25deg rate=%f kHz",rate_Edepgem1_electron_25cm),"l");
	leg11->AddEntry(hhit_Edepgem1_electron_55cm,Form("Nosh target vacuum #theta=30deg rate=%f kHz",rate_Edepgem1_electron_55cm),"l");
...
//	hhit_Edepgem2_electron->Draw("HIST");
	...
	hhit_Edepgem2_electron_45cm->GetYaxis()->SetTitle("rate (kHz)");
	hhit_Edepgem2_electron_45cm->SetTitle("#gamma on gem2 virtual plane");
        hhit_Edepgem2_electron_45cm->Scale(0.001);
        hhit_Edepgem2_electron_45cm->GetYaxis()->SetRangeUser(1e0,1e7);	
...
//	leg11->AddEntry(hhit_Edepgem1_electron,"no shielding beamline survey+old simu","l");
	leg31->AddEntry(hhit_Edepgem2_electron_45cm,Form("no shielding target vacuum #theta=8deg rate=%f kHz",rate_Edepgem2_electron_45cm),"l");
	leg31->AddEntry(hhit_Edepgem2_electron_35cm,Form("Nosh target vacuum #theta=15deg rate=%f kHz",rate_Edepgem2_electron_35cm),"l");
	...
	leg31->AddEntry(hhit_Edepgem2_electron_1cmAl,Form("Nosh target vacuum #theta=20deg rate=%f kHz",rate_Edepgem2_electron_1cmAl),"l");
	leg31->AddEntry(hhit_Edepgem2_electron_25cm,Form("Nosh target vacuum #theta=25deg rate=%f kHz",rate_Edepgem2_electron_25cm),"l");
	leg31->AddEntry(hhit_Edepgem2_electron_55cm,Form("Nosh target vacuum #theta=30deg rate=%f kHz",rate_Edepgem2_electron_55cm),"l");
...
//	hhit_Edepgem1_gamma_1cmAl->Draw("same HIST");
	...
	hhit_Edepgem1_gamma_45cm->GetYaxis()->SetTitle("rate (kHz)");
	hhit_Edepgem1_gamma_45cm->SetTitle("e^{-} on gem1 virtual plane");
        hhit_Edepgem1_gamma_45cm->Scale(0.001);
        hhit_Edepgem1_gamma_45cm->GetYaxis()->SetRangeUser(1e0,1e8);	
	hhit_Edepgem1_gamma_45cm->Draw("same HIST");
        double rate_Edepgem1_gamma_45cm= hhit_Edepgem1_gamma_45cm->Integral()*0.00001;
	hhit_Edepgem1_gamma_25cm->SetLineColor(2);
        hhit_Edepgem1_gamma_25cm->Scale(0.001);
	hhit_Edepgem1_gamma_25cm->Draw("same HIST");
        double rate_Edepgem1_gamma_25cm= hhit_Edepgem1_gamma_25cm->Integral()*0.00001;
	hhit_Edepgem1_gamma_55cm->SetLineColor(4);
        hhit_Edepgem1_gamma_55cm->Scale(0.001);
	hhit_Edepgem1_gamma_55cm->Draw("same HIST");
        double rate_Edepgem1_gamma_55cm= hhit_Edepgem1_gamma_55cm->Integral()*0.00001;
	hhit_Edepgem1_gamma_35cm->SetLineColor(6);
        hhit_Edepgem1_gamma_35cm->Scale(0.001);
//	hhit_Edepgem1_gamma_35cm->Draw("same HIST");
        double rate_Edepgem1_gamma_35cm= hhit_Edepgem1_gamma_35cm->Integral()*0.00001;
	hhit_Edepgem1_gamma_1cmAl->SetLineColor(kOrange-3);
        hhit_Edepgem1_gamma_1cmAl->Scale(0.001);
	hhit_Edepgem1_gamma_1cmAl->Draw("same HIST");
        double rate_Edepgem1_gamma_1cmAl= hhit_Edepgem1_gamma_1cmAl->Integral()*0.00001;
	hhit_Edepgem1_gamma_15deg->SetLineColor(6);
        hhit_Edepgem1_gamma_15deg->Scale(0.001);
	hhit_Edepgem1_gamma_15deg->Draw("same HIST");
        double rate_Edepgem1_gamma_15deg= hhit_Edepgem1_gamma_15deg->Integral()*0.00001;
	hhit_Edepgem1_gamma_20degv->SetLineColor(7);
        hhit_Edepgem1_gamma_20degv->Scale(0.001);
	hhit_Edepgem1_gamma_20degv->Draw("same HIST");
        double rate_Edepgem1_gamma_20degv= hhit_Edepgem1_gamma_20degv->Integral()*0.00001;
...
//	leg111->AddEntry(hhit_Edepgem1_electron,"no shielding beamline survey+old simu","l");
	leg111->AddEntry(hhit_Edepgem1_gamma_45cm,Form("no shielding target vacuum #theta=8deg E_{b}=8.5 GeV rate %f MHz/cm^{2}",rate_Edepgem1_gamma_45cm),"l");
	leg111->AddEntry(hhit_Edepgem1_gamma_15deg,Form("no shielding target vacuum #theta=8deg E_{b}=5 GeV rate %f MHz/cm^{2}",rate_Edepgem1_gamma_15deg),"l");
	leg111->AddEntry(hhit_Edepgem1_gamma_20degv,Form("no shielding target vacuum #theta=8deg E_{b}=11 GeV rate %f MHz/cm^{2}",rate_Edepgem1_gamma_20degv),"l");
	//leg111->AddEntry(hhit_Edepgem1_gamma_35cm,Form("no shielding target vacuum+ CC air rate %f kHz",rate_Edepgem1_gamma_35cm),"l");
...
//	leg111->AddEntry(hhit_Edepgem1_gamma_35cm,Form("Nosh target vacuum #theta=15deg rate %f kHz",rate_Edepgem1_gamma_35cm),"l");
	leg111->AddEntry(hhit_Edepgem1_gamma_1cmAl,Form("Nosh target vacuum #theta=20deg E_{b}=8.5 GeV rate %f MHz/cm^{2}",rate_Edepgem1_gamma_1cmAl),"l");
//	leg111->AddEntry(hhit_Edepgem1_gamma_1cmAl,"2x4x190 in^{3} Pb shielding full ","l");
	leg111->AddEntry(hhit_Edepgem1_gamma_25cm,Form("Nosh target vacuum #theta=20deg E_{b}=5 GeV rate %f MHz/cm^{2}",rate_Edepgem1_gamma_25cm),"l");
	leg111->AddEntry(hhit_Edepgem1_gamma_55cm,Form("Nosh target vacuum #theta=20deg E_{b}=11 GeV rate %f MHz/cm^{2}",rate_Edepgem1_gamma_55cm),"l");
...
//	hhit_Edepgem2_gamma->Draw("HIST");
	...
	hhit_Edepgem2_gamma_45cm->GetYaxis()->SetTitle("rate (kHz)");
	hhit_Edepgem2_gamma_45cm->SetTitle("e^{-} on gem2 virtual plane");
        hhit_Edepgem2_gamma_45cm->Scale(0.001);
        hhit_Edepgem2_gamma_45cm->GetYaxis()->SetRangeUser(1e0,1e8);	
...
/*	hhit_Edepgem2_gamma_15deg->SetLineColor(6);
        hhit_Edepgem2_gamma_15deg->Scale(0.001);
	...
	hhit_Edepgem2_gamma_20degv->SetLineColor(kOrange-3);
        hhit_Edepgem2_gamma_20degv->Scale(0.001);
...
//	leg111->AddEntry(hhit_Edepgem1_electron,"no shielding beamline survey+old simu","l");
	leg41->AddEntry(hhit_Edepgem2_gamma_45cm,Form("no shielding target vacuum #theta=8deg rate=%f kHz",rate_Edepgem2_gamma_45cm),"l");
	leg41->AddEntry(hhit_Edepgem2_gamma_35cm,Form("no shielding target vacuum #theta=15deg rate=%f kHz",rate_Edepgem2_gamma_35cm),"l");
...
*/
	leg41->AddEntry(hhit_Edepgem2_gamma_1cmAl,Form("no shielding target vacuum #theta=20deg rate=%f kHz",rate_Edepgem2_gamma_1cmAl),"l");
//	leg41->AddEntry(hhit_Edepgem2_gamma_15deg,Form("Nosh target vacuum #theta=15deg rate=%f kHz",rate_Edepgem2_gamma_15deg),"l");
//	leg41->AddEntry(hhit_Edepgem2_gamma_20degv,Form("Nosh target vacuum #theta=20deg rate=%f kHz",rate_Edepgem2_gamma_20degv),"l");
	leg41->AddEntry(hhit_Edepgem2_gamma_25cm,Form("Nosh target vacuum #theta=25deg rate=%f kHz",rate_Edepgem2_gamma_25cm),"l");
	leg41->AddEntry(hhit_Edepgem2_gamma_55cm,Form("NoSh target vacuum #theta=30deg rate=%f kHz",rate_Edepgem2_gamma_55cm),"l");
	...
	gSystem->Exec("pdfunite ./c*.pdf ./HallC_Espectrum_target_only_scattering_angles.pdf");
