...
//	TFile *f10 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_20deg_3inpolynear/HallC_beamtest_BeamOnTarget_3.79e8_8deg_80uA_target_step_right_fork_20deg_3inpolynear_reduce_tree_rate_gem_Etotcut.root");
	...
	TH1F *GEM00_beam_config2r_hist = (TH1F*)gROOT->FindObject("GEM00_beam_config2r");
        ...
        tree_pip->Draw("ShowerSum>>GEM10_pip(1000,0,100)","rate*(ShowerSum>0)","goff");
	TH1F *GEM10_pip_hist = (TH1F*)gROOT->FindObject("GEM10_pip");
        tree_pim->Draw("ShowerSum>>GEM10_pim(1000,0,100)","rate*(ShowerSum>0)","goff");
	TH1F *GEM10_pim_hist = (TH1F*)gROOT->FindObject("GEM10_pim");
        tree_pi0->Draw("ShowerSum>>GEM10_pi0(1000,0,100)","rate*( ShowerSum>0)","goff");
	TH1F *GEM10_pi0_hist = (TH1F*)gROOT->FindObject("GEM10_pi0");
        tree_eAll->Draw("ShowerSum>>GEM10_eAll(1000,0,100)","rate*(ShowerSum>0)","goff");
	TH1F *GEM10_eAll_hist = (TH1F*)gROOT->FindObject("GEM10_eAll");
        tree_beam->Draw("ShowerSum>>GEM10_beam(1000,0,100)","rate*(ShowerSum>0)","goff");
	TH1F *GEM10_beam_hist = (TH1F*)gROOT->FindObject("GEM10_beam");
        tree_beam_Edep->Draw("ShowerSum>>GEM10_beam_Edep(1000,0,100)","rate*(ShowerSum>0)","goff");
	TH1F *GEM10_beam_Edep_hist = (TH1F*)gROOT->FindObject("GEM10_beam_Edep");
        tree_beam_more->Draw("ShowerSum>>GEM10_beam_more(1000,0,100)","rate*(ShowerSum>0)","goff");
	TH1F *GEM10_beam_more_hist = (TH1F*)gROOT->FindObject("GEM10_beam_more");
        tree_beam_1cm->Draw("ShowerSum>>GEM10_beam_1cm(1000,0,100)","rate*(ShowerSum>0)","goff");
	TH1F *GEM10_beam_1cm_hist = (TH1F*)gROOT->FindObject("GEM10_beam_1cm");
        tree_beam_15cm->Draw("ShowerSum>>GEM10_beam_15cm(1000,0,100)","rate*(ShowerSum>0)","goff");
	TH1F *GEM10_beam_15cm_hist = (TH1F*)gROOT->FindObject("GEM10_beam_15cm");
        tree_beam_config2->Draw("ShowerSum>>GEM10_beam_config2(1000,0,100)","rate*(ShowerSum>0)","goff");
	TH1F *GEM10_beam_config2_hist = (TH1F*)gROOT->FindObject("GEM10_beam_config2");
        tree_beam_config2r->Draw("ShowerSum>>GEM10_beam_config2r(1000,0,100)","rate*(ShowerSum>0)","goff");
  ...
  leg8->AddEntry(shower_beam_config2r_hist,Form("BeamOnTarget rate=%f MHz",rate_beam_config2r),"l");
  leg8->AddEntry(shower_beam_more_hist,Form("bggen #pi^{+} rate=%f MHz",rate_proton_more),"l");
  leg8->AddEntry(shower_beam_1cm_hist,Form(" BeamOnTarget 5deg ; total rate=%f MHz",rate_proton_1cm),"l");
  leg8->AddEntry(shower_beam_15cm_hist,Form("bggen #pi^{-}; total rate=%f MHz",rate_proton_15cm),"l");
  ...
  leg9->AddEntry(GEM00_beam_1cm_hist,Form("7feet shielding 0deg along Y-axis; total rate=%f MHz",rate_proton_gem_1cm),"l");
 ...
 // leg9->AddEntry(GEM00_beam_Edep_hist,Form("2in 10x10 cm^{2} poly GEM00 step HMS 4deg; total rate=%f MHz",rate_proton_gem_Edep),"l");
  ...
  leg9->Draw("text same");
	...
	gPad->SetLogy();
        ...
        GEM10_beam_config2r_hist->GetXaxis()->SetTitle("ShowerSum (cm)");
  ...
  leg19->AddEntry(GEM10_beam_config2r_hist,Form("BeamOnTarget; total rate=%f MHz",rate_proton_gem_config2r),"l");
  //leg19->AddEntry(GEM10_pip_hist,Form(" no shielding; total rate=%f MHz",rate_pip_gem),"l");
  leg19->AddEntry(GEM10_beam_more_hist,Form("bggen  #pi^{+} total rate=%f MHz",rate_proton_gem_more),"l");
  leg19->AddEntry(GEM10_beam_1cm_hist,Form("BeamOnTarget 5deg; total rate=%f MHz",rate_proton_gem_1cm),"l");
  leg19->AddEntry(GEM10_beam_15cm_hist,Form("bggen #pi^{-}; total rate=%f MHz",rate_proton_gem_15cm),"l");
