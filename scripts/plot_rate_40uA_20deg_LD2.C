...
void plot_rate_Cer_newCh_7deg(){
	...
	TFile *f2 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pip_20deg_LD_21m_30degcut/HallC_beamtest_bggen_LD2_pip_20deg_filenum52240_21m_shielding_30degcut_reduce_tree_rate_gem1_Etotalcut_40uA_Q2100MeV.root");
	...
	TFile *f3 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_eAll_20deg_LD2_21m/HallC_beamtest_eAll_LD2_20deg_filenum9992_9.992e8_10.6GeV_shielding_reduce_tree_rate_preshower_Etotalcut_40uA_tid1.root");
	...
	TFile *f4 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pi0_20deg_LD_21m_30degcut/HallC_beamtest_bggen_LD2_pi0_20deg_filenum25470_21m_shielding_30degcut_reduce_tree_rate_gem1_Etotalcut_40uA_Q2100MeV.root");
...
//	TFile *f38 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_20deg_LD2_r20m_shielding_30x30x5cm3/HallC_beamtest_BeamOnTarget_9.909e8_60uA_4SCs_20deg_r20m_LD2_shielding_30x30x5cm3_reduce_tree_rate_preshower_Etotalcut_gamma_40uA.root");
	...
	TFile *f18 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pim_20deg_LD_21m_30degcut/HallC_beamtest_bggen_LD2_pim_20deg_filenum26290_21m_shielding_30degcut_reduce_tree_rate_gem1_Etotalcut_40uA_Q2100MeV.root");
	...
	TFile *f14 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_20deg_LD2_r20m_shielding_30x30cm2_1inch/HallC_beamtest_BeamOnTarget_1.9885e9_60uA_4SCs_20deg_r20m_LD2_shielding_30x30x2.54cm3_reduce_tree_rate_gem1_Etotalcut_40uA.root");
	...
	//TFile *f50 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_eAll_18deg_LD2_20m/HallC_beamtest_eAll_LD2_18deg_filenum9992_9.992e8_10.6GeV_shielding_reduce_tree_rate_gem1_Etotalcut_40uA_Q2100MeV.root");
	TFile *f50 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_eAll_18deg_LD2_20m/HallC_beamtest_eAll_LD2_18deg_filenum3009_3.009e8_10.6GeV_shielding_reduce_tree_rate_gem1_Etotalcut_40uA_Q2100MeV.root");
	...
	TH1F *shower_beam_r_hist = (TH1F*)gROOT->FindObject("shower_beam_r");
        tree_beam_5cm->Draw("ShowerSum>>shower_beam_5cm(1000,0,1000)","rate*(ShowerSum>20)","goff");
	TH1F *shower_beam_5cm_hist = (TH1F*)gROOT->FindObject("shower_beam_5cm");
        tree_beam_18->Draw("ShowerSum>>shower_beam_18(1000,0,1000)","rate*(ShowerSum>20)","goff");
  ...
  leg8->AddEntry(SC0_beam_5cm_hist,Form("from 18 deg BeamOnTarget+30x30x2.5cm3 poly; total rate=%f kHz",rate_beam_5cm),"l");
  ...
  leg28->AddEntry(preshower_e_hist,Form("from 20deg eAll; total rate=%f kHz",rate_e_preshower),"l");
 ...
 leg29->AddEntry(shower_beam_r_hist,Form("e^{+} from #pi^{0}; total rate=%f kHz",rate_beam_r_shower),"l");
  ...
  leg29->AddEntry(shower_e_hist,Form("from 20deg eAll; total rate=%f kHz",rate_e_shower),"l");
...
/*	c[1] = new TCanvas("c[1]","c[1]",1000,1000);
  ...
  leg91->AddEntry(GEM10_beam_hist,Form("BeamOnTarget; total rate=%f kHz",rate_proton_gem1),"l");
