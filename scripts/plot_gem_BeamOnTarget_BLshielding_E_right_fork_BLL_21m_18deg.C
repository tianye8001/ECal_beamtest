...
void plot_gem_BeamOnTarget_BLshielding_E_right_fork_debug(){
	gStyle->SetOptStat(0);
	gStyle->SetPalette(1);
	TFile *f4 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_18deg_LD2_r20m_shielding_30x30x2.54cm3_poly/HallC_beamtest_BeamOnTarget_1.1964e9_40uA_4SCs_18deg_r20m_LD2_shielding_30x30x2.54cm3_new_output_SCAD_gammaE_pzcut.root");
	TFile *f7 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_18deg_LD2_r20m_shielding_poly/HallC_beamtest_BeamOnTarget_1.0986e9_60uA_4SCs_18deg_r20m_LD2_shielding_output_SCAD_gammaE_pzcut.root");
	TFile *f17 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_18deg_LD2_r20m_shielding_poly/HallC_beamtest_BeamOnTarget_1.0986e9_60uA_4SCs_18deg_r20m_LD2_shielding_output_SCAD_electronE_pzcut.root");
	TFile *f14 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_18deg_LD2_r20m_shielding_30x30x2.54cm3_poly/HallC_beamtest_BeamOnTarget_1.1964e9_40uA_4SCs_18deg_r20m_LD2_shielding_30x30x2.54cm3_new_output_SCAD_electronE_pzcut.root");
	TH1F *hprocid_gem1;       
	TH1F *hpf_gem1;
	TH1F *hE_gem1;
	TH1F *hpf_gem1_1cmAl;
...
/*        hhit_theta_noTB->GetYaxis()->SetTitle("rate (MHz/cm2)");	
       ...
       // hhit_theta_noTB->Scale(0.00000001);
        ...
        hhit_theta_45cm->Scale(0.0000000267);
        hhit_theta_45cm->GetYaxis()->SetRangeUser(1e-3,1e2);	
        hhit_theta_45cm->Draw("same HISt");	
        hhit_theta_25cm->SetLineColor(2);	
        hhit_theta_25cm->Scale(0.0000000267);
        hhit_theta_25cm->Draw("same HISt");	
	TLegend *leg1 = new TLegend(0.45,0.7,0.8,0.9);
	leg1->AddEntry(hhit_theta_45cm,"40uA LD2 target no shielding","l");
	leg1->AddEntry(hhit_theta_25cm,"40uA LD2 target 1 inch poly shielding","l");
	...
	gPad->SetGridx();
      //  hhit_theta_gem2->SetLineColor(6);	
       ...
       // hhit_theta_gem2->Draw("HISt");	
        ...
        hhit_theta_45cm_gem2->SetTitle("#gamma in front of SC_D");	
	...
	leg01->AddEntry(hhit_theta_45cm_gem2,"40uA LD2 target no shielding","l");
	leg01->AddEntry(hhit_theta_25cm_gem2,"40uA LD2 target 1 inch poly shielding","l");
	...
	gPad->SetGridx();
      ...
      //  hhit_theta_electron->Scale(0.00000001);
       ...
       // hhit_theta_electron->Draw("HISt");	
        ...
        hhit_theta_45cm_electron->Scale(0.0000000267);
        ...
        hhit_theta_25cm_electron->Scale(0.0000000267);
        hhit_theta_25cm_electron->Draw("same HIST");	
	TLegend *leg21 = new TLegend(0.4,0.73,0.8,0.9);
	leg21->AddEntry(hhit_theta_45cm_electron,"40uA LD2 target no shielding","l");
	leg21->AddEntry(hhit_theta_25cm_electron,"40uA LD2 target 1 inch poly shielding","l");
 ...
 //       hhit_theta_gem2_electron->Scale(0.00000001);
  ...
  //      hhit_theta_gem2_electron->Draw("HISt");	
        ...
        hhit_theta_45cm_gem2_electron->SetTitle("e^{-} in front of SC_D");	
        hhit_theta_45cm_gem2_electron->GetXaxis()->SetRangeUser(0,95);	
        hhit_theta_45cm_gem2_electron->Scale(0.00000000716);
        ...
        hhit_theta_25cm_gem2_electron->Scale(0.00000000716);
        hhit_theta_25cm_gem2_electron->Draw("same HISt");	
	TLegend *leg201 = new TLegend(0.4,0.73,0.8,0.9);
	leg201->AddEntry(hhit_theta_45cm_gem2_electron,"40uA LD2 target no shielding","l");
	leg201->AddEntry(hhit_theta_25cm_gem2_electron,"40uA LD2 target 1 inch poly shielding","l");
