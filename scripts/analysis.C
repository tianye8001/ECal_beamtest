...
const double PEthresh_hgc=0; //hgc pe threshold for each pmt
const double PMTthresh_hgc=0; //hgc pmt threshold, at least 2pmts are fired in each sector
...
sprintf(outputfile_name, "%s_output_Nphe_debug.root",the_filename);
...
// 	htime_photon[1]=new TH1F("time_photon_1","time",400,0,1000);	
	...
	const int n=10;
	string detname[n]={"sc0","sc1","ec_front","ec_back","gem1","gem2","cc_win","FASPD","LASPD","ec_middle"};
