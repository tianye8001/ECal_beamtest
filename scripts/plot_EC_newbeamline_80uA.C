...
gStyle->SetPalette(1);
  ...
  TFile *f13 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_eAll_80uA/output/HallC_beamtest_eAll_80uA_filenum99_output_Nphe_finetime_Q2cut_001GeV.root");
...
//TFile *f7 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_TACH_40uA/HallC_beamtest_BeamOnTarget_1.992e10_80uA_output_Nphe.root");
...
TFile *f8 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pim_80uA/output/HallC_beamtest_bggen_LH2_pim_80uA_filenum19880_output_Nphe_finetime.root");
...
TFile *f9 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pip_80uA/output/HallC_beamtest_bggen_LH2_pip_80uA_filenum19870_output_Nphe_finetime_electron.root");
...
gPad->SetLogy();
 ...
 EC_shower_proton->GetYaxis()->SetRangeUser(1e-3,1e9);
...
//  leg8->AddEntry(EC_shower_eDIS,"eDIS*1000","l");
 ...
 EC_preshower_proton->GetYaxis()->SetRangeUser(1e-3,1e9);
...
double rate_pip_pre= EC_preshower_pip->Integral();
 ...
 c[3]->cd(1);
  ...
  hhit_Edepspd1_proton->GetYaxis()->SetRangeUser(1e-3,1e8);
 ...
 double rate_pim_spd1= hhit_Edepspd1_pim->Integral();
  ...
  hhit_Edepspd1_pi0->GetYaxis()->SetRangeUser(1e-3,1e8);
 ...
 double rate_pip_spd1= hhit_Edepspd1_pip->Integral();
  ...
  hhit_Edepspd1_eAll->GetYaxis()->SetRangeUser(1e-3,1e8);
 ...
 double rate_eAll_spd1= hhit_Edepspd1_eAll->Integral();
  ...
  hhit_Edepspd2_proton->GetYaxis()->SetRangeUser(1e-3,1e8);
 ...
 double rate_pim_spd2= hhit_Edepspd2_pim->Integral();
  ...
  hhit_Edepspd2_pi0->GetYaxis()->SetRangeUser(1e-3,1e8);
 ...
 double rate_pip_spd2= hhit_Edepspd2_pip->Integral();
  ...
  hhit_Edepspd2_eAll->GetYaxis()->SetRangeUser(1e-3,1e8);
