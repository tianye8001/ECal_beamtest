...
void plot_rate_sangle_shielding(){
	gStyle->SetOptStat(0);
	gStyle->SetPalette(1);
	TFile *f5 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_1cmpb/HallC_beamtest_BeamOnTarget_1e11_8deg_80uA_newCH_25cmPb_reduce_tree_rate_gem_Etotcut.root");
	...
	TFile *f4 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_1cmpb/HallC_beamtest_BeamOnTarget_1e11_8deg_80uA_newCH_45cmPb_5.12times_reduce_tree_rate_gem_Etotcut.root");
	...
	TFile *f6 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_15cmPb/HallC_beamtest_BeamOnTarget_0.99e11_8deg_80uA_newCH_35cmPb_6times6_reduce_tree_rate_gem_Etotcut.root");
	...
	TFile *f7 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_15cmPb/HallC_beamtest_BeamOnTarget_1e11_8deg_80uA_newCH_35cmPb_reduce_tree_rate_gem_Etotcut.root");
	//TFile *f7 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_config2/HallC_beamtest_BeamOnTarget_1e11_8deg_80uA_newCH_config2_reduce_tree_rate_gem_Etotcut.root");
	...
	TFile *f9 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_15cmPb/HallC_beamtest_BeamOnTarget_1e11_8deg_80uA_newCH_55cmPb_5.12times_reduce_tree_rate_gem_Etotcut.root");
	TFile *f10 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_1cmpb/HallC_beamtest_BeamOnTarget_1e11_8deg_80uA_newCH_1cmPb_reduce_tree_rate_gem_Etotcut.root");
	TFile *f11 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_15cmPb/HallC_beamtest_BeamOnTarget_1e11_8deg_80uA_newCH_15cmPb_reduce_tree_rate_gem_Etotcut.root");
	...
	TH1F *GEM00_beam_hist = (TH1F*)gROOT->FindObject("GEM00_beam");
        tree_beam_more->Draw("GEM00_x>>GEM00_beam_more(256,-5.12,5.12)","rate*(GEM00_Edep>0)","goff");
	TH1F *GEM00_beam_more_hist = (TH1F*)gROOT->FindObject("GEM00_beam_more");
        tree_beam_1cm->Draw("GEM00_x>>GEM00_beam_1cm(256,-5.12,5.12)","rate*(GEM00_Edep>0)","goff");
	TH1F *GEM00_beam_1cm_hist = (TH1F*)gROOT->FindObject("GEM00_beam_1cm");
        tree_beam_15cm->Draw("GEM00_x>>GEM00_beam_15cm(256,-5.12,5.12)","rate*(GEM00_Edep>0)","goff");
	TH1F *GEM00_beam_15cm_hist = (TH1F*)gROOT->FindObject("GEM00_beam_15cm");
...
//  leg8->AddEntry(eAll_clone_hist,Form("eAll+pions; total rate=%f kHz",rate_eAll_clone),"l");
  ...
  leg9->AddEntry(GEM00_beam_hist,Form("no shielding 10x10 cm^{2}; total rate=%f kHz",rate_proton_gem),"l");
  leg9->AddEntry(GEM00_beam_1cm_hist,Form("1 cm Pb 10x10 cm^{2}; total rate=%f kHz",rate_proton_gem_1cm),"l");
  leg9->AddEntry(GEM00_beam_15cm_hist,Form("1.5 cm Pb 10x10 cm^{2}; total rate=%f kHz",rate_proton_gem_15cm),"l");
  leg9->AddEntry(GEM00_pip_hist,Form("2.5 cm Pb 10x10 cm^{2}; total rate=%f kHz",rate_pip_gem),"l");
  leg9->AddEntry(GEM00_eAll_hist,Form("3.5 cm Pb 10x10 cm^{2}; total rate=%f kHz",rate_eAll_gem),"l");
  leg9->AddEntry(GEM00_pi0_hist,Form("3.5 cm Pb 12x12 cm^{2}; total rate=%f kHz",rate_pi0_gem),"l");
  leg9->AddEntry(GEM00_pim_hist,Form("4.5 cm Pb 10.24x10.24 cm^{2}; total rate=%f kHz",rate_pim_gem),"l");
  leg9->AddEntry(GEM00_beam_more_hist,Form("5.5 cm Pb 10.24x10.24 cm^{2}; total rate=%f kHz",rate_proton_gem_more),"l");
