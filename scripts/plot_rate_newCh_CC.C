...
void plot_rate_sangle_newCh(){
	gStyle->SetOptStat(0);
	gStyle->SetPalette(1);
	//TFile *f5 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_simulation_file_82deg/HallC_beamtest_bggen_LH2_pip_80uA_filenum43750_newCh_reduce_tree_rate_gem.root");
	TFile *f5 = new TFile("/w/halla-scshelf2102/solid/tianye/HallCbeamtest/solid_gemc_Ye_modify_v2/prototype/ec_pro/HallC2022/analysis/scripts/reduce_tree_rate_gem_noCCcentercut_badmirror.root");
	...
	//TFile *f4 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_simulation_file_82deg/HallC_beamtest_bggen_LH2_pim_80uA_filenum43770_newCh_reduce_tree_rate.root");
	TFile *f4 = new TFile("/w/halla-scshelf2102/solid/tianye/HallCbeamtest/solid_gemc_Ye_modify_v2/prototype/ec_pro/HallC2022/analysis/scripts/reduce_tree_rate_gem_CCcentercut2cm.root");
	...
	TFile *f6 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_simulation_file_82deg/HallC_beamtest_bggen_LH2_pi0_80uA_filenum43770_newCh_reduce_tree_rate.root");
	//TFile *f6 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_15cmPb/HallC_beamtest_BeamOnTarget_0.99e11_8deg_80uA_newCH_35cmPb_6times6_reduce_tree_rate_gem.root");
	TFile *f7 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_simulation_file_82deg/HallC_beamtest_eAll_80uA_filenum100_newCh_reduce_tree_rate.root");
	...
	//TFile *f7 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_15cmPb/HallC_beamtest_BeamOnTarget_1e11_8deg_80uA_newCH_35cmPb_reduce_tree_rate_gem.root");
	...
	//TFile *f8 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle/HallC_beamtest_BeamOnTarget_1e11_8deg_80uA_newCH_reduce_tree_rate_gem.root");
	//TFile *f8 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_simulation_file_82deg/HallC_beamtest_BeamOnTarget_4.4715e12_80uA_newCh_reduce_tree_rate.root");
	TFile *f8 = new TFile("/w/halla-scshelf2102/solid/tianye/HallCbeamtest/solid_gemc_Ye_modify_v2/prototype/ec_pro/HallC2022/analysis/scripts/reduce_tree_rate_gem_CCcentercut.root");
	TFile *f9 = new TFile("/work/halla/solid/jixie/ecal_beamtest_hallc/ROOTFILE/beamtest_level1_3564_15.root");
	...
	TTree *tree_data = (TTree*) f9->Get("T");
	...
	TH1F *shower_beam_SC_cut_hist = (TH1F*)gROOT->FindObject("shower_SC0_SC1_beam");
        tree_pip->Draw("Npesum>>Npesum_pip(50,0,50)","rate*(ShowerSum>10)","goff");
	TH1F *Npesum_pip_hist = (TH1F*)gROOT->FindObject("Npesum_pip");
        tree_pim->Draw("Npesum>>Npesum_pim(50,0,50)","rate*(ShowerSum>10)","goff");
	TH1F *Npesum_pim_hist = (TH1F*)gROOT->FindObject("Npesum_pim");
        tree_pi0->Draw("Npesum>>Npesum_pi0(50,0,50)","rate*( ShowerSum>10)","goff");
	TH1F *Npesum_pi0_hist = (TH1F*)gROOT->FindObject("Npesum_pi0");
        tree_eAll->Draw("Npesum>>Npesum_eAll(50,0,50)","rate*(ShowerSum>10)","goff");
	TH1F *Npesum_eAll_hist = (TH1F*)gROOT->FindObject("Npesum_eAll");
        tree_beam->Draw("Npesum>>Npesum_beam(50,0,50)","rate*(ShowerSum>10)","goff");
	TH1F *Npesum_beam_hist = (TH1F*)gROOT->FindObject("Npesum_beam");
        tree_data->Draw("CerSum*0.0025>>Npesum_data(50,0,50)","TrigType==4","goff");
	TH1F *Npesum_data_hist = (TH1F*)gROOT->FindObject("Npesum_data");
        /*tree_pip->Draw("GEM00_x>>GEM00_pip(256,-5.12,5.12)","rate*(GEM00_Edep>0)","goff");
	TH1F *GEM00_pip_hist = (TH1F*)gROOT->FindObject("GEM00_pip");
        tree_pim->Draw("GEM00_x>>GEM00_pim(256,-5.12,5.12)","rate*(GEM00_Edep>0)","goff");
	TH1F *GEM00_pim_hist = (TH1F*)gROOT->FindObject("GEM00_pim");
        tree_pi0->Draw("GEM00_x>>GEM00_pi0(256,-5.12,5.12)","rate*( GEM00_Edep>0)","goff");
	TH1F *GEM00_pi0_hist = (TH1F*)gROOT->FindObject("GEM00_pi0");
        tree_eAll->Draw("GEM00_x>>GEM00_eAll(256,-5.12,5.12)","rate*(GEM00_Edep>0)","goff");
	TH1F *GEM00_eAll_hist = (TH1F*)gROOT->FindObject("GEM00_eAll");
        tree_beam->Draw("GEM00_x>>GEM00_beam(256,-5.12,5.12)","rate*(GEM00_Edep>0)","goff");
	...
	TH1F *Npesum_beam_hist = (TH1F*)gROOT->FindObject("Npesum_beam");
        tree_pip->Draw("GEM10_x>>GEM00_pip(256,-5.12,5.12)","rate*(GEM10_Edep>0 && GEM00_Edep>0)","goff");
	TH1F *GEM00_pip_hist = (TH1F*)gROOT->FindObject("GEM00_pip");
        tree_pim->Draw("GEM10_x>>GEM00_pim(256,-5.12,5.12)","rate*(GEM10_Edep>0&& GEM00_Edep>0)","goff");
	TH1F *GEM00_pim_hist = (TH1F*)gROOT->FindObject("GEM00_pim");
        tree_pi0->Draw("GEM10_x>>GEM00_pi0(256,-5.12,5.12)","rate*( GEM10_Edep>0&& GEM00_Edep>0)","goff");
	TH1F *GEM00_pi0_hist = (TH1F*)gROOT->FindObject("GEM00_pi0");
        tree_eAll->Draw("GEM10_x>>GEM00_eAll(256,-5.12,5.12)","rate*(GEM10_Edep>0&& GEM00_Edep>0)","goff");
	TH1F *GEM00_eAll_hist = (TH1F*)gROOT->FindObject("GEM00_eAll");
        tree_beam->Draw("GEM10_x>>GEM00_beam(256,-5.12,5.12)","rate*(GEM10_Edep>0&& GEM00_Edep>0)","goff");
	TH1F *GEM00_beam_hist = (TH1F*)gROOT->FindObject("GEM00_beam");*/
