...
//	TFile *f14 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_BLshielding_GEM4cmAl/HallC_beamtest_BeamOnTarget_3.85e8_8deg_80uA_target_right_step_BLshielding2x4x190_4cmAl_output_gem_electronE_pzcut.root");
	...
	TFile *f7 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_7deg_r10m_carbon/HallC_beamtest_BeamOnTarget_9.91e8_7deg_80uA_5x10SC_r10m_cfoil_10.6GeV_output_gem_gammaE_pzcut.root");
...
//	TFile *f7 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_vacuum_CCvacuum/HallC_beamtest_BeamOnTarget_1e10_8deg_80uA_target_step_right_output_gem_gammaE_pzcut.root");
	...
	TFile *f4 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_air_7deg/HallC_beamtest_BeamOnTarget_9.79e8_8deg_80uA_target_air_7deg_output_gem_gammaE_pzcut.root");
	...
	TFile *f6 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_vacuum_CCvacuum_7deg/HallC_beamtest_BeamOnTarget_1e10_8deg_80uA_target_vacuum_CCvacuum_right_7deg_output_gem_gammaE_pzcut.root");
...
//	TFile *f14 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_7deg_r10m_3He/HallC_beamtest_BeamOnTarget_5e8_7deg_80uA_5x10SC_r10m_3He_output_ec_electronE_pzcut.root");
	TFile *f14 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_air_7deg/HallC_beamtest_BeamOnTarget_9.79e8_8deg_80uA_target_air_7deg_output_gem_electronE_pzcut.root");
	//TFile *f14 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_25deg/HallC_beamtest_BeamOnTarget_5e8_8deg_80uA_target_step_right_fork_25deg_output_gem_electronE_pzcut.root");
	...
	TFile *f17 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_7deg_r10m_carbon/HallC_beamtest_BeamOnTarget_9.91e8_7deg_80uA_5x10SC_r10m_cfoil_10.6GeV_output_gem_electronE_pzcut.root");
	...
	TFile *f16 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_vacuum_CCvacuum_7deg/HallC_beamtest_BeamOnTarget_1e10_8deg_80uA_target_vacuum_CCvacuum_right_7deg_output_gem_electronE_pzcut.root");
...
//	leg11->AddEntry(hhit_Edepgem1_electron,"no shielding beamline survey+old simu","l");
	leg31->AddEntry(hhit_Edepgem2_electron_55cm,Form("0.04525 cm C-foil full 7 deg; rate=%f MHz/cm2",rate_Edepgem2_electron_55cm),"l");
	leg31->AddEntry(hhit_Edepgem2_electron_45cm,Form("0.04525 cm C-foil target+vacuum 7 deg; rate=%f MHz/cm2",rate_Edepgem2_electron_45cm),"l");
...
//	leg31->AddEntry(hhit_Edepgem2_electron_35cm,Form("7feet shielding Yaxis 5deg rate=%f MHz/cm2",rate_Edepgem2_electron_35cm),"l");
	leg31->AddEntry(hhit_Edepgem2_electron_25cm,Form("0.04525 cm C-foil target+air 7 deg; rate=%f MHz/cm2",rate_Edepgem2_electron_25cm),"l");
...
//	leg111->AddEntry(hhit_Edepgem1_electron,"no shielding beamline survey+old simu","l");
	leg111->AddEntry(hhit_Edepgem1_gamma_55cm,Form("0.04525 cm C-foil full 7 deg; rate %f MHz/cm2",rate_Edepgem1_gamma_55cm),"l");
	leg111->AddEntry(hhit_Edepgem1_gamma_45cm,Form("0.04525 cm C-foil target+vacuum 7 deg;rate %f MHz/cm2",rate_Edepgem1_gamma_45cm),"l");
...
//	leg111->AddEntry(hhit_Edepgem1_gamma_35cm,Form("10cm 3He target+beamline 7 deg 40uA E>1 MeV rate %f MHz/cm2",rate_Edepgem1_gamma_35cm),"l");
	leg111->AddEntry(hhit_Edepgem1_gamma_25cm,Form("0.04525 cm C-foil target+air 7 deg; rate %f MHz/cm2",rate_Edepgem1_gamma_25cm),"l");
...
//	leg111->AddEntry(hhit_Edepgem1_electron,"no shielding beamline survey+old simu","l");
	leg41->AddEntry(hhit_Edepgem2_gamma_55cm,Form("0.04525 cm C-foil full 7 deg; rate=%f MHz/cm2",rate_Edepgem2_gamma_55cm),"l");
	leg41->AddEntry(hhit_Edepgem2_gamma_45cm,Form("0.04525 cm C-foil target+vacuum 7 deg; rate=%f MHz/cm2",rate_Edepgem2_gamma_45cm),"l");
...
//	leg41->AddEntry(hhit_Edepgem2_gamma_35cm,Form("7feet shielding Yaxis 5 deg rate=%f MHz/cm2",rate_Edepgem2_gamma_35cm),"l");
	leg41->AddEntry(hhit_Edepgem2_gamma_25cm,Form("0.04525 cm C-foil target+air 7 deg; rate=%f MHz/cm2",rate_Edepgem2_gamma_25cm),"l");
