...
//	TFile *f14 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_BLshielding_GEM4cmAl/HallC_beamtest_BeamOnTarget_3.85e8_8deg_80uA_target_right_step_BLshielding2x4x190_4cmAl_output_gem_electronE_pzcut.root");
	...
	TFile *f17 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_vacuum_CCvacuum_30deg/HallC_beamtest_BeamOnTarget_1e10_8deg_80uA_target_vacuum_CCvacuum_right_30deg_output_gem_electronE_pzcut.root");
...
//	TFile *f7 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_vacuum_CCvacuum/HallC_beamtest_BeamOnTarget_1e10_8deg_80uA_target_step_right_output_gem_gammaE_pzcut.root");
	...
	TFile *f14 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_vacuum_CCvacuum_25deg/HallC_beamtest_BeamOnTarget_1e10_8deg_80uA_target_vacuum_CCvacuum_right_25deg_output_gem_electronE_pzcut.root");
...
//	leg111->AddEntry(hhit_Edepgem1_electron,"no shielding beamline survey+old simu","l");
	leg111->AddEntry(hhit_Edepgem1_gamma_45cm,Form("no shielding target vacuum #theta=8deg E_{b}=8.5 GeV rate %f kHz",rate_Edepgem1_gamma_45cm),"l");
	leg111->AddEntry(hhit_Edepgem1_gamma_15deg,Form("no shielding target vacuum #theta=8deg E_{b}=5 GeV rate %f kHz",rate_Edepgem1_gamma_15deg),"l");
	leg111->AddEntry(hhit_Edepgem1_gamma_20degv,Form("no shielding target vacuum #theta=8deg E_{b}=11 GeV rate %f kHz",rate_Edepgem1_gamma_20degv),"l");
