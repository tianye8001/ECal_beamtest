...
void plot_EC_newbeamline_angle(){
gStyle->SetOptStat(0);
gStyle->SetPalette(1);
...
TFile *f9 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pip/output/HallC_beamtest_bggen_LH2_pip_newbeamline_filenum14110_output_Nphe.root");
...
gPad->SetLogy();
 ...
 EC_shower_pip->GetYaxis()->SetRangeUser(1e-3,2e2);
...
double rate_proton= EC_shower_proton->Integral();
 EC_shower_pip2->Scale(0.001);
 EC_shower_pip2->Rebin(rebinfac);
 EC_shower_pip2->SetLineColor(7);
 EC_shower_pip2->Draw(" same HIST");
double rate_pip2= EC_shower_pip2->Integral();
  TLegend *leg8 = new TLegend(0.45,0.68,0.8,0.88);
  leg8->AddEntry(EC_shower_eAll,Form("eAll*1000 82.2 deg; total rate=%f Hz",rate_eAll),"l");
//  leg8->AddEntry(EC_shower_eDIS,"eDIS*1000","l");
  leg8->AddEntry(EC_shower_pim,Form("bggen #pi^{+} 22 deg; total rate=%f kHz",rate_pim),"l");
  leg8->AddEntry(EC_shower_pip,Form("bggen #pi^{+} 82.2 deg; total rate=%f kHz",rate_pip),"l");
  leg8->AddEntry(EC_shower_pip2,Form("bggen #pi^{+} 45 deg; total rate=%f kHz",rate_pip2),"l");
  leg8->AddEntry(EC_shower_pi0,Form("bggen #pi^{+} 8 deg; total rate=%f kHz",rate_pi0),"l");
  leg8->AddEntry(EC_shower_proton,Form("bggen #pi^{+} 35 deg; total rate=%f kHz",rate_proton),"l");
 ...
 EC_preshower_pip->GetYaxis()->SetRangeUser(1e-3,2e2);
...
double rate_proton_pre= EC_preshower_proton->Integral();
 EC_preshower_pip2->Scale(0.001);
 EC_preshower_pip2->Rebin(rebinfac);
 EC_preshower_pip2->SetLineColor(7);
 EC_preshower_pip2->Draw(" same HIST");
double rate_pip2_pre= EC_preshower_pip2->Integral();
  TLegend *leg1 = new TLegend(0.45,0.6,0.8,0.88);
  leg1->AddEntry(EC_preshower_eAll,Form("eAll*1000 82.2 deg; total rate=%f Hz",rate_eAll_pre),"l");
  leg1->AddEntry(EC_preshower_proton,Form("bggen #pi^{+} 35 deg; total rate=%f kHz",rate_proton_pre),"l");
  leg1->AddEntry(EC_preshower_pim,Form("bggen #pi^{+} 22 deg; total rate=%f kHz",rate_pim_pre),"l");
  leg1->AddEntry(EC_preshower_pip,Form("bggen #pi^{+} 82.2 deg; total rate=%f kHz",rate_pip_pre),"l");
  leg1->AddEntry(EC_preshower_pip2,Form("bggen #pi^{+} 45 deg; total rate=%f kHz",rate_pip_pre),"l");
  leg1->AddEntry(EC_preshower_pi0,Form("bggen #pi^{+} 8 deg; total rate=%f kHz",rate_pi0_pre),"l");
