...
void plot_rate_Cer_newCh_7deg(){
	...
	TFile *f2 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pip_20deg_LD_21m//HallC_beamtest_bggen_LD2_pip_20deg_filenum2000_21m_shielding_reduce_tree_rate_gem1_Etotalcut_Q21GeV.root");
	...
	TFile *f3 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_eAll_20deg_LD2_21m_shielding/HallC_beamtest_eAll_LD2_20deg_filenum795_7.95e6_10.6GeV_shielding_reduce_tree_rate_gem1_Etotalcut_Q2100MeV.root");
	...
	TFile *f4 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pi0_20deg_LD_21m/HallC_beamtest_bggen_LD2_pi0_20deg_filenum2000_21m_shielding_reduce_tree_rate_gem1_Etotalcut_Q21GeV.root");
	TFile *f8 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_20deg_LD2_r20m_shielding/HallC_beamtest_BeamOnTarget_1.9918e9_60uA_4SCs_20deg_r20m_LD2_shielding_reduce_tree_rate_gem1_Etotalcut.root");
	TFile *f28 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_20deg_LD2_r20m_shielding_30x30x5cm3/HallC_beamtest_BeamOnTarget_9.909e8_60uA_4SCs_20deg_r20m_LD2_shielding_30x30x5cm3_reduce_tree_rate_preshower_Etotalcut_electron.root");
	TFile *f38 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_20deg_LD2_r20m_shielding_30x30x5cm3/HallC_beamtest_BeamOnTarget_9.909e8_60uA_4SCs_20deg_r20m_LD2_shielding_30x30x5cm3_reduce_tree_rate_preshower_Etotalcut_gamma.root");
	...
	TFile *f18 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pim_20deg_LD_21m/HallC_beamtest_bggen_LD2_pim_20deg_filenum1990_21m_shielding_reduce_tree_rate_gem1_Etotalcut_Q21GeV.root");
	...
	TFile *f29 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_20deg_LD2_r20m_shielding_30x30x1cm3/HallC_beamtest_BeamOnTarget_9.951e8_60uA_4SCs_20deg_r20m_LD2_shielding_30x30x1cm3_reduce_tree_rate_gem1_Etotalcut_new.root");
        //change
	TFile *f19 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_20deg_LD2_r20m_shielding_30x30x5cm3/HallC_beamtest_BeamOnTarget_9.909e8_60uA_4SCs_20deg_r20m_LD2_shielding_30x30x5cm3_reduce_tree_rate_gem1_Etotalcut_new.root");
	TFile *f14 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_60uA_sangle_4SC_20deg_LD2_r20m_shielding_30x30cm2_1inch/HallC_beamtest_BeamOnTarget_4.861e8_60uA_4SCs_20deg_r20m_LD2_shielding_30x30cm2_1inch_reduce_tree_rate_gem1_Etotalcut_debug.root");
	...
	TH1F *SC3_beam_e_hist = (TH1F*)gROOT->FindObject("SC3_beam_e");*/
        tree_SC1_e->Draw("LASPD_Eendsum>>LASPD_e(90,0,90)","rate*(LASPD_Eendsum>1.75)","goff");
	TH1F *LASPD_e_hist = (TH1F*)gROOT->FindObject("LASPD_e");
        tree_SC1_electron->Draw("LASPD_Eendsum>>LASPD_electron(90,0,90)","rate*(LASPD_Eendsum>1.75)","goff");
	TH1F *LASPD_electron_hist = (TH1F*)gROOT->FindObject("LASPD_electron");
        tree_SC1_gamma->Draw("LASPD_Eendsum>>LASPD_gamma(90,0,90)","rate*(LASPD_Eendsum>1.75)","goff");
	TH1F *LASPD_gamma_hist = (TH1F*)gROOT->FindObject("LASPD_gamma");
        tree_beam->Draw("LASPD_Eendsum>>LASPD_beam(90,0,90)","rate*(LASPD_Eendsum>1.75)","goff");
	TH1F *LASPD_beam_hist = (TH1F*)gROOT->FindObject("LASPD_beam");
        tree_beam_gamma->Draw("LASPD_Eendsum>>LASPD_beam_gamma(90,0,90)","rate*(LASPD_Eendsum>1.75)","goff");
	TH1F *LASPD_beam_gamma_hist = (TH1F*)gROOT->FindObject("LASPD_beam_gamma");
        tree_beam_e->Draw("LASPD_Eendsum>>LASPD_beam_e(90,0,90)","rate*(LASPD_Eendsum>1.75)","goffnfac1");
	...
	TH1F *CC_beam_1in_hist = (TH1F*)gROOT->FindObject("CC_beam_1in");
        ...
        tree_SC1_e->Draw("PreShSum>>preshower_e(300,0,150)","rate*(PreShSum>1.75)","goff");
	TH1F *preshower_e_hist = (TH1F*)gROOT->FindObject("preshower_e");
        tree_SC1_electron->Draw("PreShSum>>preshower_electron(300,0,150)","rate*(PreShSum>1.75)","goff");
	TH1F *preshower_electron_hist = (TH1F*)gROOT->FindObject("preshower_electron");
        tree_SC1_gamma->Draw("PreShSum>>preshower_gamma(300,0,150)","rate*(PreShSum>1.75)","goff");
	TH1F *preshower_gamma_hist = (TH1F*)gROOT->FindObject("preshower_gamma");
        tree_beam->Draw("PreShSum>>preshower_beam(300,0,150)","rate*(PreShSum>1.75)","goff");
	TH1F *preshower_beam_hist = (TH1F*)gROOT->FindObject("preshower_beam");
        tree_beam_gamma->Draw("PreShSum>>preshower_beam_gamma(300,0,150)","rate*(PreShSum>1.75)","goff");
	TH1F *preshower_beam_gamma_hist = (TH1F*)gROOT->FindObject("preshower_beam_gamma");
        tree_beam_e->Draw("PreShSum>>preshower_beam_e(300,0,150)","rate*(PreShSum>1.75)","goff");
	TH1F *preshower_beam_e_hist = (TH1F*)gROOT->FindObject("preshower_beam_e");
       
        tree_SC1_e->Draw("ShowerSum>>shower_e(1000,0,1000)","rate*(ShowerSum>20 )","goff");
	TH1F *shower_e_hist = (TH1F*)gROOT->FindObject("shower_e");
        tree_SC1_electron->Draw("ShowerSum>>shower_electron(1000,0,1000)","rate*(ShowerSum>20)","goff");
	TH1F *shower_electron_hist = (TH1F*)gROOT->FindObject("shower_electron");
        tree_SC1_gamma->Draw("ShowerSum>>shower_gamma(1000,0,1000)","rate*(ShowerSum>20)","goff");
	TH1F *shower_gamma_hist = (TH1F*)gROOT->FindObject("shower_gamma");
        tree_beam->Draw("ShowerSum>>shower_beam(1000,0,1000)","rate*(ShowerSum>20)","goff");
	TH1F *shower_beam_hist = (TH1F*)gROOT->FindObject("shower_beam");
        tree_beam_gamma->Draw("ShowerSum>>shower_beam_gamma(1000,0,1000)","rate*(ShowerSum>20)","goff");
	TH1F *shower_beam_gamma_hist = (TH1F*)gROOT->FindObject("shower_beam_gamma");
        tree_beam_e->Draw("ShowerSum>>shower_beam_e(1000,0,1000)","rate*(ShowerSum>20)","goff");
	TH1F *shower_beam_e_hist = (TH1F*)gROOT->FindObject("shower_beam_e");
        tree_beam_old->Draw("ShowerSum>>shower_beam_old(1000,0,1000)","rate*(ShowerSum>20)","goff");
	TH1F *shower_beam_old_hist = (TH1F*)gROOT->FindObject("shower_beam_old");
        tree_beam_r->Draw("ShowerSum>>shower_beam_r(1000,0,1000)","rate*(ShowerSum>20)","goff");
  ...
  leg8->AddEntry(SC0_beam_hist,Form("from BeamOnTarget; total rate=%f kHz",rate_proton),"l");
  leg8->AddEntry(SC0_beam_e_hist,Form("from BeamOnTarget+30x30x5cm3 poly; total rate=%f kHz",rate_beam_e),"l");
  leg8->AddEntry(SC0_beam_5cm_hist,Form("from BeamOnTarget+30x30x1cm3 poly; total rate=%f kHz",rate_beam_5cm),"l");
  leg8->AddEntry(SC0_e_hist,Form("from eAll*1000; total rate=%f Hz",rate_e),"l");
  ...
  leg1->AddEntry(CC_beam_hist,Form("from BeamOnTarget; total rate=%f kHz",rate_proton_CC),"l");
  leg1->AddEntry(CC_beam_e_hist,Form("from BeamOnTarget+30x30x5cm3 poly; total rate=%f kHz",rate_beam_e_CC),"l");
  leg1->AddEntry(CC_beam_5cm_hist,Form("from BeamOnTarget+30x30x1cm3 poly; total rate=%f kHz",rate_beam_5cm_CC),"l");
  //leg1->AddEntry(CC_beam_1in_hist,Form("from BeamOnTarget+30x30x2.54cm3 poly; total rate=%f kHz",rate_beam_1in_CC),"l");
  leg1->AddEntry(CC_e_hist,Form("from eAll*1000; total rate=%f Hz",rate_e_CC),"l");
  ...
  leg9->AddEntry(SC1_beam_hist,Form("from BeamOnTarget; total rate=%f kHz",rate_proton_SC1),"l");
  leg9->AddEntry(SC1_beam_e_hist,Form("from BeamOnTarget+30x30x5cm3; total rate=%f kHz",rate_beam_e_SC1),"l");
  leg9->AddEntry(SC1_e_hist,Form("from eAll*1000; total rate=%f Hz",rate_e_SC1),"l");
  ...
  leg18->AddEntry(SC2_beam_e_hist,Form("from BeamOnTarget+30x30x5cm3 shielding; total rate=%f kHz",rate_beam_e_SC2),"l");
  leg18->AddEntry(SC2_e_hist,Form("from eAll*1000; total rate=%f Hz",rate_e_SC2),"l");
  ...
  leg18->Draw("text same");
	...
	gPad->SetLogy();
        ...
        LASPD_electron_hist->Scale(0.001);
        ...
        LASPD_beam_gamma_hist->Scale(0.001);
  ...
  leg58->AddEntry(LASPD_beam_hist,Form("from BeamOnTarget; total rate=%f kHz",rate_proton_LASPD),"l");
  leg58->AddEntry(LASPD_beam_e_hist,Form("from BeamOnTarget+30x30x5cm3 ploly; total rate=%f kHz",rate_beam_e_LASPD),"l");
  leg58->AddEntry(LASPD_e_hist,Form("from eAll*1000; total rate=%f Hz",rate_e_LASPD),"l");
  ...
  leg58->Draw("text same");
	...
	gPad->SetLogy();
        ...
        preshower_beam_hist->GetYaxis()->SetRangeUser(1e-5,5e6);
  ...
  leg28->AddEntry(preshower_beam_hist,Form("from BeamOnTarget; total rate=%f kHz",rate_proton_preshower),"l");
  leg28->AddEntry(preshower_beam_e_hist,Form("from BeamOnTarget+30x30x5cm3 ploly; total rate=%f kHz",rate_beam_e_preshower),"l");
  leg28->AddEntry(preshower_e_hist,Form("from eAll*1000; total rate=%f Hz",rate_e_preshower),"l");
  ...
  leg28->Draw("text same");
	...
	gPad->SetLogy();
        ...
        shower_beam_hist->GetYaxis()->SetRangeUser(1e-5,5e6);
        ...
        shower_beam_r_hist->Scale(0.001);
  ...
  leg29->AddEntry(shower_beam_hist,Form("from BeamOnTarget; total rate=%f kHz",rate_proton_shower),"l");
 leg29->AddEntry(shower_beam_old_hist,Form("e^{#pm} from BeamOnTarget+5cm poly; total rate=%f kHz",rate_beam_old_shower),"l");
 leg29->AddEntry(shower_beam_r_hist,Form("#gamma from BeamOnTarget+5cm poly; total rate=%f kHz",rate_beam_r_shower),"l");
  leg29->AddEntry(shower_beam_e_hist,Form("from BeamOnTarget+30x30x5cm3 poly; total rate=%f kHz",rate_beam_e_shower),"l");
  leg29->AddEntry(shower_e_hist,Form("from eAll*1000; total rate=%f Hz",rate_e_shower),"l");
  ...
  leg19->AddEntry(SC3_beam_hist,Form("from BeamOnTarget; total rate=%f kHz",rate_proton_SC3),"l");
  leg19->AddEntry(SC3_beam_e_hist,Form("from BeamOnTarget+30x30x5cm3; total rate=%f kHz",rate_beam_e_SC3),"l");
  leg19->AddEntry(SC3_e_hist,Form("from eAll*1000; total rate=%f Hz",rate_e_SC3),"l");
...
/*	c[1] = new TCanvas("c[1]","c[1]",1000,1000);
  ...
  leg90->AddEntry(GEM00_beam_hist,Form("BeamOnTarget; total rate=%f kHz",rate_proton_gem),"l");
  leg90->AddEntry(GEM00_beam_e_hist,Form("BeamOnTarget 30x30x5cm3; total rate=%f kHz",rate_beam_e_gem),"l");
  ...
  TLegend *leg90 = new TLegend(0.15,0.6,0.6,0.88);
  leg90->AddEntry(GEM10_eAll_hist,Form("eAll; total rate=%f kHz",rate_eAll_gem1),"l");
  leg90->AddEntry(GEM10_pim_hist,Form("bggen #pi^{-}; total rate=%f kHz",rate_pim_gem1),"l");
  leg90->AddEntry(GEM10_pip_hist,Form("bggen #pi^{+}; total rate=%f kHz",rate_pip_gem1),"l");
  leg90->AddEntry(GEM10_pi0_hist,Form("bggen #pi^{0}; total rate=%f kHz",rate_pi0_gem1),"l");
  leg90->AddEntry(GEM10_beam_hist,Form("BeamOnTarget; total rate=%f kHz",rate_proton_gem1),"l");
  leg90->AddEntry(GEM10_beam_e_hist,Form("BeamOnTarget 30x30x5cm3; total rate=%f kHz",rate_beam_e_gem1),"l");
  leg90->SetTextSize(0.03);
  leg90->SetBorderSize(0);
  leg90->SetFillColor(0);
  leg90->Draw("text same");
	...
	gSystem->Exec("pdfunite ./c*.pdf ./HallC_comparison_Edep_rate_20deg_21m.pdf");
