...
int analysis_hadron_survey(string inputfile_name,string runmode="trigger", bool Is_tellorig=false,string filetype="",bool Is_new=true){
	...
	const int n=12;
	string detname[n]={"sc_A","sc_D","ec_front","ec_back","GEM00","GEM10","cc_win","SC_B","LASPD","SC_C","GEM01","GEM11"};
