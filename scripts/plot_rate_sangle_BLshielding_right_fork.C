...
void plot_rate_sangle_BLshielding_right_fork(){
	...
	TFile *f4 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_BLshielding_GEM55cmPb/HallC_beamtest_BeamOnTarget_4.6e8_8deg_80uA_target_right_step_BLshielding2x4x190_55cmPb_reduce_tree_rate_gem_Etotcut.root");
...
//  leg8->AddEntry(eAll_clone_hist,Form("eAll+pions; total rate=%f kHz",rate_eAll_clone),"l");
 ...
 // leg9->AddEntry(GEM00_beam_config2_hist,Form("no shielding step SHMS 35e^{-6} cut; total rate=%f MHz",rate_proton_gem_config2),"l");
  ...
  leg9->AddEntry(GEM00_pim_hist,Form("2x4x190 in^{3} Pb shielding step HMS+3.5cm Pb; total rate=%f MHz",rate_pim_gem),"l");
