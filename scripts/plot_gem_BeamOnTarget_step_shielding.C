...
void plot_gem_BeamOnTarget_step_BLshielding(){
	gStyle->SetOptStat(0);
	gStyle->SetPalette(1);
	TFile *f1 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_BLshielding_less/HallC_beamtest_BeamOnTarget_4.505e8_8deg_80uA_target_right_step_BLshielding2x4x190_output_gem_gammaE_pzcut.root");
	TFile *f2 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_BLshielding_less/HallC_beamtest_BeamOnTarget_4.505e8_8deg_80uA_target_right_step_BLshielding2x4x190_output_gem_electronE_pzcut.root");
	TFile *f3 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_BLshielding_less/HallC_beamtest_BeamOnTarget_4.505e8_8deg_80uA_target_right_step_BLshielding2x4x190_output_gem_gammaE_pzcut_vzcut.root");
	TFile *f4 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_fork_BLshielding_less/HallC_beamtest_BeamOnTarget_4.505e8_8deg_80uA_target_right_step_BLshielding2x4x190_output_gem_electronE_pzcut_vzcut.root");
...
//	leg1->AddEntry(hhit_Egem1_other,"other","l");
	...
	gSystem->Exec("pdfunite ./c*.pdf ./HallC_BeamOnTarget_8deg_gem1_gamma_step_BLshielding.pdf");
