...
void plot_rate_newCh(){
	...
	TFile *f9 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_air_7deg/HallC_beamtest_BeamOnTarget_9.79e8_8deg_80uA_target_air_7deg_reduce_tree_rate_preshower_Etotalcut_gamma.root");
...
//	TFile *f9 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_dummy_80uA/HallC_beamtest_BeamOnTarget_1e10_dummy_80uA_newCh_reduce_tree_rate_test.root");
  ...
  leg8->AddEntry(shower_beam_neutron_hist,Form("all at prelead from BeamOnTarget C-foil target+air; total rate=%f kHz",rate_beam_neutron),"l");
