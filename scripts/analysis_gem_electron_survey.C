...
int analysis_gem_electron_survey(string inputfile_name,string runmode="trigger", bool Is_tellorig=false,string filetype="",bool Is_new=true){
	...
	sprintf(outputfile_name, "%s_output_SCAD_electronE_pzcut.root",the_filename);
