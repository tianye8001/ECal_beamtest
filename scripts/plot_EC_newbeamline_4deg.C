...
gStyle->SetOptStat(0);
gStyle->SetPalette(1);
  TFile *f13 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_eAll_4deg_Cfoil/HallC_beamtest_eAll_Cfoil_4deg_filenum100_1e6_output_Nphe_finetime_Q2cut_100MeV.root");
TFile *f7 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_5x10SC_4deg_r10m_carbon/HallC_beamtest_BeamOnTarget_4.884e8_4deg_80uA_5x10SC_r10m_cfoil_output_Nphe.root");
TFile *f8 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pim_4deg_Cfoil/HallC_beamtest_bggen_Cfoil_pim_4deg_filenum1000_output_Nphe.root");
TFile *f9 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pip_4deg_Cfoil/HallC_beamtest_bggen_Cfoil_pip_4deg_filenum1000_output_Nphe.root");
TFile *f10 = new TFile("/lustre19/expphy/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pi0_4deg_Cfoil/HallC_beamtest_bggen_Cfoil_pi0_4deg_filenum1000_output_Nphe.root");
