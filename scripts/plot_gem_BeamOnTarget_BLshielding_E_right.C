...
void plot_gem_BeamOnTarget_shielding_E(){
	...
	TFile *f3 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_step_less/HallC_beamtest_BeamOnTarget_9.925e8_8deg_80uA_newCH_right_CAD_output_gem_gammaE_underflow.root");
	TFile *f2 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_80uA_sangle_right_step_BL2x4x160/HallC_beamtest_BeamOnTarget_9.525e8_8deg_80uA_newCH_right_CAD_2x4x160_output_gem_gammaE_underflow.root");
...
/*        hhit_theta_25cm->SetLineColor(3);	
 ...
 /*       hhit_theta_55cmL->SetLineColor(kMagenta-2);	
	...
	leg1->AddEntry(hhit_theta_1cmAl,"step HMS 2 in Pb 4x160 in^{2} Coli ","l");
	leg1->AddEntry(hhit_theta_1inpoly,"step HMS no shielding","l");
/*	leg1->AddEntry(hhit_theta_25cm,"2 in Pb 7x30 in^{2} Coli","l");
	...
	leg1->AddEntry(hhit_theta_45cm,"2 in Pb 5x160 in^{2} Coli","l");
...
/*	hhit_Edepgem1_electron_25cm->SetLineColor(3);
	...
	leg11->AddEntry(hhit_Edepgem1_electron_1cmAl,"step HMS,2 in Pb 4x160 in^{2} Coli ","l");
	leg11->AddEntry(hhit_Edepgem1_electron_1inpoly,"step HMS no shielding","l");
...
//	leg11->AddEntry(hhit_Edepgem1_electron_35cmL,"2 in Pb 5x70 in^{2} Coli","l");
	leg11->AddEntry(hhit_Edepgem1_electron_45cm,"2 in Pb 5x160 in^{2} Coli","l");
