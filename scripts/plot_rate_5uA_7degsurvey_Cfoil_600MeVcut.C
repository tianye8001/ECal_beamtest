...
void plot_rate_Cer_newCh_7deg(){
	...
	TFile *f2 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pip_7degsurvey_Cfoil/HallC_beamtest_bggen_Cfoil_pip_7degsurvey_filenum2000_10.6GeV_reduce_tree_rate_gem1_Etotalcut.root");
	TFile *f3 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_eAll_7degsurvey_Cfoil/HallC_beamtest_eAll_Cfoil_7degsurvey_filenum1000_5e7_10.6GeV_reduce_tree_rate_gem1_Etotalcut.root");
	TFile *f4 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pi0_7degsurvey_Cfoil/HallC_beamtest_bggen_Cfoil_pi0_7degsurvey_filenum2000_10.6GeV_reduce_tree_rate_gem1_Etotalcut.root");
	TFile *f8 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_5uA_4SCsurvey_7deg_r20m_carbon_shielding/HallC_beamtest_BeamOnTarget_2e9_7degsurvey_5uA_4SC_r20m_cfoil_shielding_reduce_tree_rate_gem1_Etotalcut.root");
	...
	TFile *f18 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_bggen_LH2_pim_7degsurvey_Cfoil/HallC_beamtest_bggen_Cfoil_pim_7degsurvey_filenum2000_10.6GeV_reduce_tree_rate_gem1_Etotalcut.root");
	TFile *f19 = new TFile("/volatile/halla/solid/tianye/container/HallC_beamtest_beamOntarget_5uA_4SCsurvey_7deg_r20m_carbon/HallC_beamtest_BeamOnTarget_1e9_7degsurvey_5uA_4SC_r20m_cfoil_reduce_tree_rate_gem1_Etotalcut.root");
	...
	TH1F *CC_beam_e_hist = (TH1F*)gROOT->FindObject("CC_beam_e");
        ...
        tree_SC1_e->Draw("PreShSum>>preshower_e(300,0,150)","rate*(ShowerSum>600)","goff");
	TH1F *preshower_e_hist = (TH1F*)gROOT->FindObject("preshower_e");
        tree_SC1_electron->Draw("PreShSum>>preshower_electron(300,0,150)","rate*(ShowerSum>600)","goff");
	TH1F *preshower_electron_hist = (TH1F*)gROOT->FindObject("preshower_electron");
        tree_SC1_gamma->Draw("PreShSum>>preshower_gamma(300,0,150)","rate*(ShowerSum>600)","goff");
	TH1F *preshower_gamma_hist = (TH1F*)gROOT->FindObject("preshower_gamma");
        tree_beam->Draw("PreShSum>>preshower_beam(300,0,150)","rate*(ShowerSum>600)","goff");
	TH1F *preshower_beam_hist = (TH1F*)gROOT->FindObject("preshower_beam");
        tree_beam_gamma->Draw("PreShSum>>preshower_beam_gamma(300,0,150)","rate*(ShowerSum>600)","goff");
	TH1F *preshower_beam_gamma_hist = (TH1F*)gROOT->FindObject("preshower_beam_gamma");
        tree_beam_e->Draw("PreShSum>>preshower_beam_e(300,0,150)","rate*(ShowerSum>600)","goff");
	TH1F *preshower_beam_e_hist = (TH1F*)gROOT->FindObject("preshower_beam_e");
       
        tree_SC1_e->Draw("ShowerSum>>shower_e(1000,0,2000)","rate*(ShowerSum>600)","goff");
	TH1F *shower_e_hist = (TH1F*)gROOT->FindObject("shower_e");
        tree_SC1_electron->Draw("ShowerSum>>shower_electron(1000,0,2000)","rate*(ShowerSum>600)","goff");
	TH1F *shower_electron_hist = (TH1F*)gROOT->FindObject("shower_electron");
        tree_SC1_gamma->Draw("ShowerSum>>shower_gamma(1000,0,2000)","rate*(ShowerSum>600)","goff");
	TH1F *shower_gamma_hist = (TH1F*)gROOT->FindObject("shower_gamma");
        tree_beam->Draw("ShowerSum>>shower_beam(1000,0,2000)","rate*(ShowerSum>600)","goff");
	TH1F *shower_beam_hist = (TH1F*)gROOT->FindObject("shower_beam");
        tree_beam_gamma->Draw("ShowerSum>>shower_beam_gamma(1000,0,2000)","rate*(ShowerSum>600)","goff");
	TH1F *shower_beam_gamma_hist = (TH1F*)gROOT->FindObject("shower_beam_gamma");
        tree_beam_e->Draw("ShowerSum>>shower_beam_e(1000,0,2000)","rate*(ShowerSum>600)","goff");
	TH1F *shower_beam_e_hist = (TH1F*)gROOT->FindObject("shower_beam_e");

        tree_beam->Draw("ShowerSum:SC_B_Eendsum>>shower_vs_SC3(20,0,10,1000,0,2000)","rate","goff");
	TH2F *ShowerSum_vs_SC3_hist = (TH2F*)gROOT->FindObject("shower_vs_SC3");
        tree_SC1_e->Draw("ShowerSum:SC_B_Eendsum>>shower_vs_SC3_400(20,0,10,1000,0,2000)","rate","goff");
	...
	gPad->SetLogy();
        ...
        SC0_beam_gamma_hist->Scale(0.001);
  ...
  TLegend *leg8 = new TLegend(0.15,0.65,0.6,0.88);
  leg8->AddEntry(SC0_electron_hist,Form("from bggen #pi^{+}; total rate=%f kHz",rate_electron),"l");
  leg8->AddEntry(SC0_beam_hist,Form("from BeamOnTarget+shielding; total rate=%f kHz",rate_proton),"l");
  leg8->AddEntry(SC0_beam_e_hist,Form("from BeamOnTarget; total rate=%f kHz",rate_beam_e),"l");
  ...
  leg8->Draw("text same");
	...
	gPad->SetLogy();
        ...
        CC_beam_gamma_hist->Scale(0.001);
  ...
  TLegend *leg1 = new TLegend(0.2,0.65,0.6,0.89);
  leg1->AddEntry(CC_electron_hist,Form("from bggen #pi^{+}; total rate=%f kHz",rate_electron_CC),"l");
  leg1->AddEntry(CC_beam_hist,Form("from BeamOnTarget+shielding; total rate=%f kHz",rate_proton_CC),"l");
  leg1->AddEntry(CC_beam_e_hist,Form("from BeamOnTarget; total rate=%f kHz",rate_beam_e_CC),"l");
  ...
  leg1->Draw("text same");
	...
	gPad->SetLogy();
        ...
        SC1_beam_gamma_hist->Scale(0.001);
  ...
  TLegend *leg9 = new TLegend(0.2,0.65,0.6,0.88);
  leg9->AddEntry(SC1_electron_hist,Form("from bggen #pi^{+}; total rate=%f kHz",rate_electron_SC1),"l");
  leg9->AddEntry(SC1_beam_hist,Form("from BeamOnTarget+shielding; total rate=%f kHz",rate_proton_SC1),"l");
  leg9->AddEntry(SC1_beam_e_hist,Form("from BeamOnTarget; total rate=%f kHz",rate_beam_e_SC1),"l");
  ...
  leg9->Draw("text same");
	...
	gPad->SetLogy();
        ...
        SC2_beam_gamma_hist->Scale(0.001);
  ...
  TLegend *leg18 = new TLegend(0.2,0.65,0.6,0.88);
  leg18->AddEntry(SC2_electron_hist,Form("from bggen #pi^{+}; total rate=%f kHz",rate_electron_SC2),"l");
  leg18->AddEntry(SC2_beam_hist,Form("from BeamOnTarget+shielding; total rate=%f kHz",rate_proton_SC2),"l");
  leg18->AddEntry(SC2_beam_e_hist,Form("from BeamOnTarget; total rate=%f kHz",rate_beam_e_SC2),"l");
  ...
  leg18->Draw("text same");
	...
	gPad->SetLogy();
        ...
        preshower_beam_hist->GetYaxis()->SetRangeUser(1e-5,1e5);
        ...
        preshower_electron_hist->Scale(0.001);
        ...
        preshower_gamma_hist->Scale(0.001);
        ...
        preshower_beam_gamma_hist->Scale(0.001);
  ...
  TLegend *leg28 = new TLegend(0.15,0.65,0.6,0.88);
  leg28->AddEntry(preshower_electron_hist,Form("from bggen #pi^{+}; total rate=%f kHz",rate_electron_preshower),"l");
  leg28->AddEntry(preshower_beam_hist,Form("from BeamOnTarget+shielding; total rate=%f kHz",rate_proton_preshower),"l");
  leg28->AddEntry(preshower_beam_e_hist,Form("from BeamOnTarget; total rate=%f kHz",rate_beam_e_preshower),"l");
  ...
  leg28->Draw("text same");
	...
	gPad->SetLogy();
        ...
        shower_electron_hist->Scale(0.001);
        ...
        shower_beam_gamma_hist->Scale(0.001);
  ...
  TLegend *leg29 = new TLegend(0.15,0.65,0.6,0.88);
  leg29->AddEntry(shower_electron_hist,Form("from bggen #pi^{+}; total rate=%f kHz",rate_electron_shower),"l");
  leg29->AddEntry(shower_beam_hist,Form("from BeamOnTarget+shielding; total rate=%f kHz",rate_proton_shower),"l");
  leg29->AddEntry(shower_beam_e_hist,Form("from BeamOnTarget; total rate=%f kHz",rate_beam_e_shower),"l");
  ...
  leg49->Draw("text same");
	...
	gPad->SetLogy();
        ...
        SC3_beam_gamma_hist->Scale(0.001);
  ...
  TLegend *leg19 = new TLegend(0.25,0.68,0.6,0.88);
  leg19->AddEntry(SC3_electron_hist,Form("from bggen #pi^{+}; total rate=%f Hz",rate_electron_SC3),"l");
  leg19->AddEntry(SC3_beam_hist,Form("from BeamOnTarget+shielding; total rate=%f Hz",rate_proton_SC3),"l");
  leg19->AddEntry(SC3_beam_e_hist,Form("from BeamOnTarget; total rate=%f Hz",rate_beam_e_SC3),"l");
  leg19->AddEntry(SC3_e_hist,Form("from eAll; total rate=%f Hz",rate_e_SC3),"l");
  leg19->AddEntry(SC3_beam_gamma_hist,Form("from bggen #pi^{-}; total rate=%f Hz",rate_beam_gamma_SC3),"l");
  leg19->AddEntry(SC3_gamma_hist,Form("from bggen #pi^{0}; total rate=%f Hz",rate_gamma_SC3),"l");
